    ...
    <div id='outer-frame'>
      <div id='inner-frame'>
        ...
        <div id='content'>
          <h2>SADI Services</h2>
	      <ul>
            <li><a href="./getCitingArticles">getCitingArticles</a></li>
            <li><a href="./getAbstract">getAbstract</a></li>
            <li><a href="./getCitedArticles">getCitedArticles</a></li>
            <li><a href="./getDocumentInfo">getDocumentInfo</a></li>
	      </ul>
        </div> <!-- content -->
        <div id='footer'>
        </div> <!-- footer -->
