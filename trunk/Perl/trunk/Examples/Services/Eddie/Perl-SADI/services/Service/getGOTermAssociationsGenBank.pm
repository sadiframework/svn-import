#-----------------------------------------------------------------
# Service name: getGOTermAssociationsGenBank
#    An asynchronous service
# Authority:    illuminae.com
# Created:      19-Aug-2010 13:07:16 PDT
# Contact:      myaddress@organization.org
# Description:  
#               fetches genbank records annotated with a given GO term
#-----------------------------------------------------------------

package Service::getGOTermAssociationsGenBank;
...
sub process_it {
    ...
    foreach my $input (@inputs) {
        ...
        use Implementations;
        my $class = Implementations::getGOTermAssociationsX($input, $id, $LOG, 'genbank');
...
Service::getGOTermAssociationsGenBank - a SADI service
