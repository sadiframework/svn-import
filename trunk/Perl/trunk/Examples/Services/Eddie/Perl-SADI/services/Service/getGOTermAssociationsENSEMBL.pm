#-----------------------------------------------------------------
# Service name: getGOTermAssociationsENSEMBL
#    An asynchronous service
# Authority:    illuminae.com
# Created:      19-Aug-2010 13:07:16 PDT
# Contact:      myaddress@organization.org
# Description:  
#               fetches ENSEMBL records annotated with a given GO term
#-----------------------------------------------------------------

package Service::getGOTermAssociationsENSEMBL;
...
sub process_it {
    ...
    foreach my $input (@inputs) {
        ...
        use Implementations;
        my $class = Implementations::getGOTermAssociationsX($input, $id, $LOG, 'ensembl');
...
Service::getGOTermAssociationsENSEMBL - a SADI service
