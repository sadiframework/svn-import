#-----------------------------------------------------------------
# Service name: getGOTermAssociationsPrints
#    An asynchronous service
# Authority:    illuminae.com
# Created:      19-Aug-2010 13:07:18 PDT
# Contact:      myaddress@organization.org
# Description:  
#               fetches PRINTS entities annotated with a given GO term
#-----------------------------------------------------------------

package Service::getGOTermAssociationsPrints;
...
sub process_it {
    ...
    foreach my $input (@inputs) {
        ...
        use Implementations;
        my $class = Implementations::getGOTermAssociationsX($input, $id, $LOG, 'prints');
...
Service::getGOTermAssociationsPrints - a SADI service
