#-----------------------------------------------------------------
# Service name: getGOTermAssociationsInterpro
#    An asynchronous service
# Authority:    illuminae.com
# Created:      19-Aug-2010 13:07:16 PDT
# Contact:      myaddress@organization.org
# Description:  
#               fetches interpro entities annotated with a given GO term
#-----------------------------------------------------------------

package Service::getGOTermAssociationsInterpro;
...
sub process_it {
    ...
    foreach my $input (@inputs) {
        ...
        use Implementations;
        my $class = Implementations::getGOTermAssociationsX($input, $id, $LOG, 'interpro');
...
Service::getGOTermAssociationsInterpro - a SADI service
