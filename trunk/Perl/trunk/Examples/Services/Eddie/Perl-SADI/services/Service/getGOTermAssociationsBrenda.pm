#-----------------------------------------------------------------
# Service name: getGOTermAssociationsBrenda
#    An asynchronous service
# Authority:    illuminae.com
# Created:      19-Aug-2010 13:07:15 PDT
# Contact:      myaddress@organization.org
# Description:  
#               fetches BRENDA entities annotated with a given GO term
#-----------------------------------------------------------------

package Service::getGOTermAssociationsBrenda;
...
sub process_it {
    ...
    foreach my $input (@inputs) {
        ...
        use Implementations;
        my $class = Implementations::getGOTermAssociationsX($input, $id, $LOG, 'brenda');
...
Service::getGOTermAssociationsBrenda - a SADI service
