#-----------------------------------------------------------------
# Service name: getGOTermAssociationsAGILocusCode
#    An asynchronous service
# Authority:    illuminae.com
# Created:      19-Aug-2010 13:07:14 PDT
# Contact:      myaddress@organization.org
# Description:  
#               gets the AGI locus codes annotated with a given GO term
#-----------------------------------------------------------------

package Service::getGOTermAssociationsAGILocusCode;
...
sub process_it {
    ...
    foreach my $input (@inputs) {
        ...
        use Implementations;
        my $class = Implementations::getGOTermAssociationsX($input, $id, $LOG, 'agi_locuscode');
...
Service::getGOTermAssociationsAGILocusCode - a SADI service
