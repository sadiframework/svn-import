...
BEGIN {
    ...
    new SADI::Generators::GenServices->async_load(
	 service_names => ['getEcGeneComponentPartsRat']);
}


# (this to stay here with any of the options above)
use vars qw( @ISA );
@ISA = qw( net::biordf::dev::getEcGeneComponentPartsRatBase );
use strict;
...
sub process_it {
    ...
    foreach my $input (@inputs) {
        ...
        my $class = Implementations::getEcGeneComponentPartsRat($input, $accession, $LOG);
...
Service::getEcGeneComponentPartsRat - a SADI service
