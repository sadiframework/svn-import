...
@ISA = qw(
 OWL::Data::OWL::Class
 purl::oclc::org::SADI::LSRN::KEGG_DRUG_Record 
);
use strict;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->purl::oclc::org::SADI::LSRN::KEGG_DRUG_Record::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->purl::oclc::org::SADI::LSRN::KEGG_DRUG_Record::_attr_prop( $attr_name, $prop_name ) 
            if $self->purl::oclc::org::SADI::LSRN::KEGG_DRUG_Record::_accessible($attr_name);
...
sub init {
    ...
    $self->purl::oclc::org::SADI::LSRN::KEGG_DRUG_Record::init();
    $self->type('_:genid4c6424fe366b');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->purl::oclc::org::SADI::LSRN::KEGG_DRUG_Record::_get_statements();
    };
...
Blank::genid4c6424fe366b - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use Blank::genid4c6424fe366b;
  my $class = Blank::genid4c6424fe366b->new();

  # get the uri for this class
  my $uri = $class->uri;
  # add object properties 
  use purl::oclc::org::SADI::LSRN::KEGG_PATHWAY_Record;
  # add a SIO_000062 property (purl::oclc::org::SADI::LSRN::KEGG_PATHWAY_Record)
  $class->add_SIO_000062(new purl::oclc::org::SADI::LSRN::KEGG_PATHWAY_Record());
...
L<purl::oclc::org::SADI::LSRN::KEGG_DRUG_Record>
