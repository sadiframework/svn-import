#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_000330
# Generated: 12-Aug-2010 09:33:51 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_000330;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_000330');
...
semanticscience::org::resource::SIO_000330 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_000330;
  my $class = semanticscience::org::resource::SIO_000330->new();
