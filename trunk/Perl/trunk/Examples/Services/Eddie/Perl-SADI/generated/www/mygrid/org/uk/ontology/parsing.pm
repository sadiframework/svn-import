...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#parsing');
...
www::mygrid::org::uk::ontology::parsing - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::parsing;
  my $class = www::mygrid::org::uk::ontology::parsing->new();
