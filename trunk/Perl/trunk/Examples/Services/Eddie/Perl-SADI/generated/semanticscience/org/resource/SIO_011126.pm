...
# Generated: 12-Aug-2010 09:33:52 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_011126;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->Blank::genid4c641367fafb::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->Blank::genid4c641367fafb::_attr_prop( $attr_name, $prop_name ) 
            if $self->Blank::genid4c641367fafb::_accessible($attr_name);
...
sub init {
    ...
    $self->Blank::genid4c641367fafb::init();
    $self->type('http://semanticscience.org/resource/SIO_011126');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->Blank::genid4c641367fafb::_get_statements();
    };
...
semanticscience::org::resource::SIO_011126 - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = semanticscience::org::resource::SIO_011126->new();
