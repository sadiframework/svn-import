...
#-----------------------------------------------------------------
package Blank::genid4c6424f6769b;
...
Blank::genid4c6424f6769b - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = Blank::genid4c6424f6769b->new();

  # get the uri for this class
  my $uri = $class->uri;
  # add object properties 
  use semanticscience::org::resource::SIO_000118;
  # add a hasName property (semanticscience::org::resource::SIO_000118)
  $class->add_hasName(new semanticscience::org::resource::SIO_000118());
  # get the hasName object properties
  my $hasName_objects = $class->hasName;
  use semanticscience::org::resource::SIO_000135;
  # add a hasDescription property (semanticscience::org::resource::SIO_000135)
  $class->add_hasDescription(new semanticscience::org::resource::SIO_000135());
