#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_000390
# Generated: 12-Aug-2010 09:34:21 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_000390;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_000390');
...
semanticscience::org::resource::SIO_000390 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_000390;
  my $class = semanticscience::org::resource::SIO_000390->new();
