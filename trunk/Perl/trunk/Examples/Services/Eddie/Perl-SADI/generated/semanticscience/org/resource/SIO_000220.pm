#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_000220
# Generated: 12-Aug-2010 09:33:32 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_000220;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_000220');
...
semanticscience::org::resource::SIO_000220 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_000220;
  my $class = semanticscience::org::resource::SIO_000220->new();
