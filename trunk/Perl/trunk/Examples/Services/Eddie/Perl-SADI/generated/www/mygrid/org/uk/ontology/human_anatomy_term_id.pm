...
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::human_anatomy_term_id;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#human_anatomy_term_id');
...
www::mygrid::org::uk::ontology::human_anatomy_term_id - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = www::mygrid::org::uk::ontology::human_anatomy_term_id->new();
