#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_011102
# Generated: 12-Aug-2010 09:34:37 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_011102;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_011102');
...
semanticscience::org::resource::SIO_011102 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_011102;
  my $class = semanticscience::org::resource::SIO_011102->new();
