#-----------------------------------------------------------------
# purl::oclc::org::SADI::LSRN::COG_Pathway_Identifier
# Generated: 12-Aug-2010 09:35:04 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package purl::oclc::org::SADI::LSRN::COG_Pathway_Identifier;
...
sub init {
    ...
    $self->type('http://purl.oclc.org/SADI/LSRN/COG_Pathway_Identifier');
...
purl::oclc::org::SADI::LSRN::COG_Pathway_Identifier - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use purl::oclc::org::SADI::LSRN::COG_Pathway_Identifier;
  my $class = purl::oclc::org::SADI::LSRN::COG_Pathway_Identifier->new();
