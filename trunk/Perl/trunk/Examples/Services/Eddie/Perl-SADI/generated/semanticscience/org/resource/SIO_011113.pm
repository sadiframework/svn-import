#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_011113
# Generated: 12-Aug-2010 09:34:13 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_011113;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_011113');
...
semanticscience::org::resource::SIO_011113 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_011113;
  my $class = semanticscience::org::resource::SIO_011113->new();
