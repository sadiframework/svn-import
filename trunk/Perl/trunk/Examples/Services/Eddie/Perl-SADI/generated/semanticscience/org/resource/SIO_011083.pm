#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_011083
# Generated: 12-Aug-2010 09:34:44 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_011083;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_011083');
...
semanticscience::org::resource::SIO_011083 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_011083;
  my $class = semanticscience::org::resource::SIO_011083->new();
