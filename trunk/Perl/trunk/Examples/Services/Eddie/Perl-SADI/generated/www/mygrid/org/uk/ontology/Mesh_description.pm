#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::Mesh_description
# Generated: 12-Aug-2010 09:34:35 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::Mesh_description;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#Mesh_description');
...
www::mygrid::org::uk::ontology::Mesh_description - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::Mesh_description;
  my $class = www::mygrid::org::uk::ontology::Mesh_description->new();
