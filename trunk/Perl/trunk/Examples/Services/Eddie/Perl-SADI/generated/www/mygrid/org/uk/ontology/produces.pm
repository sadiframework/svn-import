...
sub init {
    ...
    $self->domain('http://www.mygrid.org.uk/ontology#bioinformatics_data_resource');    
    # set the uri for this object property
    $self->uri('http://www.mygrid.org.uk/ontology#produces');
}
...
www::mygrid::org::uk::ontology::produces - an object propery

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::produces;
  my $property = www::mygrid::org::uk::ontology::produces->new();
