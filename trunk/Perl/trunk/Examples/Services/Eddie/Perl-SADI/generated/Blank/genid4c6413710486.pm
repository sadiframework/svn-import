...
#-----------------------------------------------------------------
package Blank::genid4c6413710486;
...
Blank::genid4c6413710486 - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = Blank::genid4c6413710486->new();

  # get the uri for this class
  my $uri = $class->uri;
  # add object properties 
  use www::mygrid::org::uk::ontology::literature_repository;
  # add a produced_by property (www::mygrid::org::uk::ontology::literature_repository)
  $class->add_produced_by(new www::mygrid::org::uk::ontology::literature_repository());
  ...
  # add a has_identifier property (www::mygrid::org::uk::ontology::literature_citation_id)
  $class->add_has_identifier(new www::mygrid::org::uk::ontology::literature_citation_id());
