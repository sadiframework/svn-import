#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_000281
# Generated: 12-Aug-2010 09:34:19 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_000281;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_000281');
...
semanticscience::org::resource::SIO_000281 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_000281;
  my $class = semanticscience::org::resource::SIO_000281->new();
