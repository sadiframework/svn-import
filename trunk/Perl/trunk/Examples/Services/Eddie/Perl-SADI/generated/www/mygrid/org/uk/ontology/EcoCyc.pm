...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#EcoCyc');
...
www::mygrid::org::uk::ontology::EcoCyc - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::EcoCyc;
  my $class = www::mygrid::org::uk::ontology::EcoCyc->new();
