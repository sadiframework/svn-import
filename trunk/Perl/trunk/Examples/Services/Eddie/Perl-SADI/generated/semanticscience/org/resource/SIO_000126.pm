#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_000126
# Generated: 12-Aug-2010 09:33:59 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_000126;
...
use semanticscience::org::resource::SIO_000495;
    ...
    my %_allowed = (
        ...
        SIO_000495 => {
        	...
        	post => sub {
                ...
                my $type = @{$self->SIO_000495}[-1] if defined $self->SIO_000495;
                return unless defined $type and $type->type;
                my $range = new semanticscience::org::resource::SIO_000495->range();
                return unless $range;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_000126');
...
sub _get_statements {
    ...
    if (defined $self->SIO_000495){
	    foreach (@{$self->SIO_000495}) {
	        ...
	        $self->model->addStmt(
	          new RDF::Core::Statement(
	              $subject,
	              $subject->new('http://semanticscience.org/resource/SIO_000495'), 
...
semanticscience::org::resource::SIO_000126 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_000126;
  my $class = semanticscience::org::resource::SIO_000126->new();
  ...
  $class->add_SIO_000495(new OWL::Data::OWL::Class('#someURI'));

  # get the SIO_000495 object properties
  my $SIO_000495_objects = $class->SIO_000495;
