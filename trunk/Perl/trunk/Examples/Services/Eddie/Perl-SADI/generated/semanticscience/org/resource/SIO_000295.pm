...
# Generated: 12-Aug-2010 09:34:29 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_000295;

use OWL::Data::OWL::Class;
use semanticscience::org::resource::SIO_000079;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->semanticscience::org::resource::SIO_000079::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->semanticscience::org::resource::SIO_000079::_attr_prop( $attr_name, $prop_name ) 
            if $self->semanticscience::org::resource::SIO_000079::_accessible($attr_name);
...
sub init {
    ...
    $self->semanticscience::org::resource::SIO_000079::init();
    $self->type('http://semanticscience.org/resource/SIO_000295');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->semanticscience::org::resource::SIO_000079::_get_statements();
    };
...
semanticscience::org::resource::SIO_000295 - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = semanticscience::org::resource::SIO_000295->new();
...
L<semanticscience::org::resource::SIO_000079>
