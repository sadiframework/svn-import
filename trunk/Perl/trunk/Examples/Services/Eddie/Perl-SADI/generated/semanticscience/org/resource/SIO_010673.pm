#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_010673
# Generated: 12-Aug-2010 09:34:51 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_010673;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->semanticscience::org::resource::SIO_010298::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->semanticscience::org::resource::SIO_010298::_attr_prop( $attr_name, $prop_name ) 
            if $self->semanticscience::org::resource::SIO_010298::_accessible($attr_name);
...
sub init {
    ...
    $self->semanticscience::org::resource::SIO_010298::init();
    $self->type('http://semanticscience.org/resource/SIO_010673');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->semanticscience::org::resource::SIO_010298::_get_statements();
    };
...
semanticscience::org::resource::SIO_010673 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_010673;
  my $class = semanticscience::org::resource::SIO_010673->new();
...
L<semanticscience::org::resource::SIO_010298>
