...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#SMART');
...
www::mygrid::org::uk::ontology::SMART - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::SMART;
  my $class = www::mygrid::org::uk::ontology::SMART->new();
