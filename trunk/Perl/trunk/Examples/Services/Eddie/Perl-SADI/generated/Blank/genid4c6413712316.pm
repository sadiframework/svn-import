...
#-----------------------------------------------------------------
package Blank::genid4c6413712316;
...
Blank::genid4c6413712316 - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = Blank::genid4c6413712316->new();

  # get the uri for this class
  my $uri = $class->uri;
  # add object properties 
  use www::mygrid::org::uk::ontology::TREMBL;
  # add a produced_by property (www::mygrid::org::uk::ontology::TREMBL)
  $class->add_produced_by(new www::mygrid::org::uk::ontology::TREMBL());
