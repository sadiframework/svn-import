#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::pubmed_citation
# Generated: 12-Aug-2010 09:34:27 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::pubmed_citation;

use OWL::Data::OWL::Class;
use www::mygrid::org::uk::ontology::literature_citation;
use Blank::genid4c641371691c;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->Blank::genid4c641371691c::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->Blank::genid4c641371691c::_attr_prop( $attr_name, $prop_name ) 
            if $self->Blank::genid4c641371691c::_accessible($attr_name);
...
sub init {
    ...
    $self->Blank::genid4c641371691c::init();
    $self->type('http://www.mygrid.org.uk/ontology#pubmed_citation');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->Blank::genid4c641371691c::_get_statements();
    };
...
www::mygrid::org::uk::ontology::pubmed_citation - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::pubmed_citation;
  my $class = www::mygrid::org::uk::ontology::pubmed_citation->new();
