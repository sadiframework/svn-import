...
# Generated: 12-Aug-2010 09:35:15 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_000270;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->semanticscience::org::resource::SIO_000268::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->semanticscience::org::resource::SIO_000268::_attr_prop( $attr_name, $prop_name ) 
            if $self->semanticscience::org::resource::SIO_000268::_accessible($attr_name);
...
sub init {
    ...
    $self->semanticscience::org::resource::SIO_000268::init();
    $self->type('http://semanticscience.org/resource/SIO_000270');
    $self->add_SIO_000300(semanticscience::org::resource::SIO_000300->new('false'));
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->semanticscience::org::resource::SIO_000268::_get_statements();
    };
...
semanticscience::org::resource::SIO_000270 - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = semanticscience::org::resource::SIO_000270->new();
...
L<semanticscience::org::resource::SIO_000268>
...
=item 'SIO_000300' has value 'false', for example, (semanticscience::org::resource::SIO_000300->new('false'));
