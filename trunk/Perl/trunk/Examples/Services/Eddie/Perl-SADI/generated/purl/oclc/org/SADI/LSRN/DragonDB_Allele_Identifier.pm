#-----------------------------------------------------------------
# purl::oclc::org::SADI::LSRN::DragonDB_Allele_Identifier
# Generated: 12-Aug-2010 09:35:18 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package purl::oclc::org::SADI::LSRN::DragonDB_Allele_Identifier;
...
sub init {
    ...
    $self->type('http://purl.oclc.org/SADI/LSRN/DragonDB_Allele_Identifier');
...
purl::oclc::org::SADI::LSRN::DragonDB_Allele_Identifier - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = purl::oclc::org::SADI::LSRN::DragonDB_Allele_Identifier->new();
