#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_000466
# Generated: 12-Aug-2010 09:34:52 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_000466;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_000466');
...
semanticscience::org::resource::SIO_000466 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_000466;
  my $class = semanticscience::org::resource::SIO_000466->new();
