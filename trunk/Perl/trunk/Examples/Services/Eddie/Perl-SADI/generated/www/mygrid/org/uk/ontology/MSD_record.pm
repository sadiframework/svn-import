...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#MSD_record');
...
www::mygrid::org::uk::ontology::MSD_record - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::MSD_record;
  my $class = www::mygrid::org::uk::ontology::MSD_record->new();
