#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::EMBL_nucleotide_sequence_database
# Generated: 12-Aug-2010 09:33:57 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::EMBL_nucleotide_sequence_database;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#EMBL_nucleotide_sequence_database');
...
www::mygrid::org::uk::ontology::EMBL_nucleotide_sequence_database - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::EMBL_nucleotide_sequence_database;
  my $class = www::mygrid::org::uk::ontology::EMBL_nucleotide_sequence_database->new();
