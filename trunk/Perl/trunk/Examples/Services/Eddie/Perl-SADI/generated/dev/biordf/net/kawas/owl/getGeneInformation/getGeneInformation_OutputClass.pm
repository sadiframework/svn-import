...
#-----------------------------------------------------------------
package dev::biordf::net::kawas::owl::getGeneInformation::getGeneInformation_OutputClass;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->Blank::genid4c6425024909::_accessible($attr)
    ...
    sub _attr_prop {
        ...
        return $self->Blank::genid4c6425024909::_attr_prop( $attr_name, $prop_name ) 
            if $self->Blank::genid4c6425024909::_accessible($attr_name);
...
sub init {
    ...
    $self->Blank::genid4c6425024909::init();
    $self->purl::oclc::org::SADI::LSRN::GeneID_Record::init();
    $self->type('http://dev.biordf.net/~kawas/owl/getGeneInformation.owl#getGeneInformation_OutputClass');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->Blank::genid4c6425024909::_get_statements();
    };
    eval {
    	# add parent statements
...
dev::biordf::net::kawas::owl::getGeneInformation::getGeneInformation_OutputClass - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = dev::biordf::net::kawas::owl::getGeneInformation::getGeneInformation_OutputClass->new();
