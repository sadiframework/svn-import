#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::MEDLINE_citation
# Generated: 12-Aug-2010 09:34:33 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::MEDLINE_citation;

use OWL::Data::OWL::Class;
use www::mygrid::org::uk::ontology::literature_citation;
use Blank::genid4c641370099c;
...
@ISA = qw(
 OWL::Data::OWL::Class
 www::mygrid::org::uk::ontology::literature_citation
 Blank::genid4c641370099c 
);
use strict;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->www::mygrid::org::uk::ontology::literature_citation::_accessible($attr)
          or $self->Blank::genid4c641370099c::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->www::mygrid::org::uk::ontology::literature_citation::_attr_prop( $attr_name, $prop_name ) 
            if $self->www::mygrid::org::uk::ontology::literature_citation::_accessible($attr_name);
        return $self->Blank::genid4c641370099c::_attr_prop( $attr_name, $prop_name ) 
            if $self->Blank::genid4c641370099c::_accessible($attr_name);
...
sub init {
    ...
    $self->www::mygrid::org::uk::ontology::literature_citation::init();
    $self->Blank::genid4c641370099c::init();
    $self->type('http://www.mygrid.org.uk/ontology#MEDLINE_citation');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->www::mygrid::org::uk::ontology::literature_citation::_get_statements();
    };
    eval {
    	# add parent statements
        $self->Blank::genid4c641370099c::_get_statements();
    };
...
www::mygrid::org::uk::ontology::MEDLINE_citation - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::MEDLINE_citation;
  my $class = www::mygrid::org::uk::ontology::MEDLINE_citation->new();
...
L<www::mygrid::org::uk::ontology::literature_citation>
L<Blank::genid4c641370099c>
