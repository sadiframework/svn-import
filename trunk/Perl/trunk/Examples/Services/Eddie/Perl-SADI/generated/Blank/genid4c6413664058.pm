#-----------------------------------------------------------------
# Blank::genid4c6413664058
# Generated: 12-Aug-2010 09:34:38 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package Blank::genid4c6413664058;

use OWL::Data::OWL::Class;
use semanticscience::org::resource::SIO_010090;
use semanticscience::org::resource::SIO_010091;
...
@ISA = qw(
 OWL::Data::OWL::Class
 semanticscience::org::resource::SIO_010090
 semanticscience::org::resource::SIO_010091 
);
use strict;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->semanticscience::org::resource::SIO_010090::_accessible($attr)
          or $self->semanticscience::org::resource::SIO_010091::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->semanticscience::org::resource::SIO_010090::_attr_prop( $attr_name, $prop_name ) 
            if $self->semanticscience::org::resource::SIO_010090::_accessible($attr_name);
        return $self->semanticscience::org::resource::SIO_010091::_attr_prop( $attr_name, $prop_name ) 
            if $self->semanticscience::org::resource::SIO_010091::_accessible($attr_name);
...
sub init {
    ...
    $self->semanticscience::org::resource::SIO_010090::init();
    $self->semanticscience::org::resource::SIO_010091::init();
    $self->type('_:genid4c6413664058');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->semanticscience::org::resource::SIO_010090::_get_statements();
    };
    eval {
    	# add parent statements
        $self->semanticscience::org::resource::SIO_010091::_get_statements();
    };
...
Blank::genid4c6413664058 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use Blank::genid4c6413664058;
  my $class = Blank::genid4c6413664058->new();
...
L<semanticscience::org::resource::SIO_010090>
L<semanticscience::org::resource::SIO_010091>
