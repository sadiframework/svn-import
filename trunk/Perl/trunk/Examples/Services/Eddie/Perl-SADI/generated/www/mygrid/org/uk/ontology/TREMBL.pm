...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#TREMBL');
...
www::mygrid::org::uk::ontology::TREMBL - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::TREMBL;
  my $class = www::mygrid::org::uk::ontology::TREMBL->new();
