...
#-----------------------------------------------------------------
package Blank::genid4c6424fcec90;
...
@ISA = qw(
 OWL::Data::OWL::Class
 purl::oclc::org::SADI::LSRN::Pfam_Record 
);
use strict;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->purl::oclc::org::SADI::LSRN::Pfam_Record::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->purl::oclc::org::SADI::LSRN::Pfam_Record::_attr_prop( $attr_name, $prop_name ) 
            if $self->purl::oclc::org::SADI::LSRN::Pfam_Record::_accessible($attr_name);
...
sub init {
    ...
    $self->purl::oclc::org::SADI::LSRN::Pfam_Record::init();
    $self->type('_:genid4c6424fcec90');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->purl::oclc::org::SADI::LSRN::Pfam_Record::_get_statements();
    };
...
Blank::genid4c6424fcec90 - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = Blank::genid4c6424fcec90->new();
...
L<purl::oclc::org::SADI::LSRN::Pfam_Record>
