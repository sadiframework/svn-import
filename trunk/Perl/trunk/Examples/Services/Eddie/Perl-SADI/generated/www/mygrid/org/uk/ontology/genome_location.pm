...
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::genome_location;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#genome_location');
...
www::mygrid::org::uk::ontology::genome_location - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = www::mygrid::org::uk::ontology::genome_location->new();
