#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::Tree_of_life_record
# Generated: 12-Aug-2010 09:34:42 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::Tree_of_life_record;

use OWL::Data::OWL::Class;
use www::mygrid::org::uk::ontology::phylogenetic_record;
...
@ISA = qw(
 OWL::Data::OWL::Class
 www::mygrid::org::uk::ontology::phylogenetic_record 
);
use strict;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->www::mygrid::org::uk::ontology::phylogenetic_record::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->www::mygrid::org::uk::ontology::phylogenetic_record::_attr_prop( $attr_name, $prop_name ) 
            if $self->www::mygrid::org::uk::ontology::phylogenetic_record::_accessible($attr_name);
...
sub init {
    ...
    $self->www::mygrid::org::uk::ontology::phylogenetic_record::init();
    $self->type('http://www.mygrid.org.uk/ontology#Tree_of_life_record');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->www::mygrid::org::uk::ontology::phylogenetic_record::_get_statements();
    };
...
www::mygrid::org::uk::ontology::Tree_of_life_record - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::Tree_of_life_record;
  my $class = www::mygrid::org::uk::ontology::Tree_of_life_record->new();
...
L<www::mygrid::org::uk::ontology::phylogenetic_record>
