...
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::bioinformatics_concept;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#bioinformatics_concept');
...
www::mygrid::org::uk::ontology::bioinformatics_concept - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = www::mygrid::org::uk::ontology::bioinformatics_concept->new();
