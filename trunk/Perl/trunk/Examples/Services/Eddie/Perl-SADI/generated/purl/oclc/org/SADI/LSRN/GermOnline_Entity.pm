#-----------------------------------------------------------------
# purl::oclc::org::SADI::LSRN::GermOnline_Entity
# Generated: 12-Aug-2010 09:35:32 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package purl::oclc::org::SADI::LSRN::GermOnline_Entity;
...
sub init {
    ...
    $self->type('http://purl.oclc.org/SADI/LSRN/GermOnline_Entity');
...
purl::oclc::org::SADI::LSRN::GermOnline_Entity - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use purl::oclc::org::SADI::LSRN::GermOnline_Entity;
  my $class = purl::oclc::org::SADI::LSRN::GermOnline_Entity->new();
