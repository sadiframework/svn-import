#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::joining
# Generated: 12-Aug-2010 09:34:19 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::joining;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#joining');
...
www::mygrid::org::uk::ontology::joining - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::joining;
  my $class = www::mygrid::org::uk::ontology::joining->new();
