#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_000473
# Generated: 12-Aug-2010 09:35:05 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_000473;

use OWL::Data::OWL::Class;
use semanticscience::org::resource::SIO_000470;
...
@ISA = qw(
 OWL::Data::OWL::Class
 semanticscience::org::resource::SIO_000470 
);
use strict;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->semanticscience::org::resource::SIO_000470::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->semanticscience::org::resource::SIO_000470::_attr_prop( $attr_name, $prop_name ) 
            if $self->semanticscience::org::resource::SIO_000470::_accessible($attr_name);
...
sub init {
    ...
    $self->semanticscience::org::resource::SIO_000470::init();
    $self->type('http://semanticscience.org/resource/SIO_000473');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->semanticscience::org::resource::SIO_000470::_get_statements();
    };
...
semanticscience::org::resource::SIO_000473 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_000473;
  my $class = semanticscience::org::resource::SIO_000473->new();
  ...
  $class->add_SIO_000310(new OWL::Data::OWL::Class('#someURI'));
...
L<semanticscience::org::resource::SIO_000470>
