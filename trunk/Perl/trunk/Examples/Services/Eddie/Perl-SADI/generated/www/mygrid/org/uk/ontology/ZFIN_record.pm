...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#ZFIN_record');
...
www::mygrid::org::uk::ontology::ZFIN_record - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::ZFIN_record;
  my $class = www::mygrid::org::uk::ontology::ZFIN_record->new();
