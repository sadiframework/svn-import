#-----------------------------------------------------------------
# dev::biordf::net::kawas::owl::gene2pubmed::AnnotatedGeneID_Record
# Generated: 12-Aug-2010 09:44:35 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package dev::biordf::net::kawas::owl::gene2pubmed::AnnotatedGeneID_Record;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->Blank::genid4c6424f2b4d5::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->Blank::genid4c6424f2b4d5::_attr_prop( $attr_name, $prop_name ) 
            if $self->Blank::genid4c6424f2b4d5::_accessible($attr_name);
...
sub init {
    ...
    $self->Blank::genid4c6424f2b4d5::init();
    $self->type('http://dev.biordf.net/~kawas/owl/gene2pubmed.owl#AnnotatedGeneID_Record');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->Blank::genid4c6424f2b4d5::_get_statements();
    };
...
dev::biordf::net::kawas::owl::gene2pubmed::AnnotatedGeneID_Record - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = dev::biordf::net::kawas::owl::gene2pubmed::AnnotatedGeneID_Record->new();
