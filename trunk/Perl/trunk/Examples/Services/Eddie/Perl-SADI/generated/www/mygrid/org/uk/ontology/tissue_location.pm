#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::tissue_location
# Generated: 12-Aug-2010 09:34:56 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::tissue_location;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#tissue_location');
...
www::mygrid::org::uk::ontology::tissue_location - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::tissue_location;
  my $class = www::mygrid::org::uk::ontology::tissue_location->new();
