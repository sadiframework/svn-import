...
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::aligning;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#aligning');
...
www::mygrid::org::uk::ontology::aligning - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = www::mygrid::org::uk::ontology::aligning->new();
