#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_000462
# Generated: 12-Aug-2010 09:33:33 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_000462;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_000462');
...
semanticscience::org::resource::SIO_000462 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_000462;
  my $class = semanticscience::org::resource::SIO_000462->new();
