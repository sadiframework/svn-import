#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_011055
# Generated: 12-Aug-2010 09:35:19 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_011055;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_011055');
...
semanticscience::org::resource::SIO_011055 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_011055;
  my $class = semanticscience::org::resource::SIO_011055->new();
