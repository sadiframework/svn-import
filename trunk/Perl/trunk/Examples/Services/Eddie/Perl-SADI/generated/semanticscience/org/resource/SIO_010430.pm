#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_010430
# Generated: 12-Aug-2010 09:33:59 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_010430;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_010430');
...
semanticscience::org::resource::SIO_010430 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_010430;
  my $class = semanticscience::org::resource::SIO_010430->new();
