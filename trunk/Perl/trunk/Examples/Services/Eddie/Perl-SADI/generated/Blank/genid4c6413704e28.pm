...
#-----------------------------------------------------------------
package Blank::genid4c6413704e28;
...
Blank::genid4c6413704e28 - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = Blank::genid4c6413704e28->new();

  # get the uri for this class
  my $uri = $class->uri;
  # add object properties 
  use www::mygrid::org::uk::ontology::EMBL_nucleotide_sequence_database;
  # add a produced_by property (www::mygrid::org::uk::ontology::EMBL_nucleotide_sequence_database)
  $class->add_produced_by(new www::mygrid::org::uk::ontology::EMBL_nucleotide_sequence_database());
  ...
  # add a has_identifier property (www::mygrid::org::uk::ontology::EMBL_accession)
  $class->add_has_identifier(new www::mygrid::org::uk::ontology::EMBL_accession());
