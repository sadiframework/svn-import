#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_011046
# Generated: 12-Aug-2010 09:33:46 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_011046;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_011046');
...
semanticscience::org::resource::SIO_011046 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_011046;
  my $class = semanticscience::org::resource::SIO_011046->new();
