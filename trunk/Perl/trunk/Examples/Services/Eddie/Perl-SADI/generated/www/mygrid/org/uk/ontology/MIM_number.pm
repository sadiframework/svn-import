...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#MIM_number');
...
www::mygrid::org::uk::ontology::MIM_number - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::MIM_number;
  my $class = www::mygrid::org::uk::ontology::MIM_number->new();
