...
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::domain_motif_report;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#domain_motif_report');
...
www::mygrid::org::uk::ontology::domain_motif_report - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = www::mygrid::org::uk::ontology::domain_motif_report->new();
