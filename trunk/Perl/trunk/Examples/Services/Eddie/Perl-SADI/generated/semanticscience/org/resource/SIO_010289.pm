#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_010289
# Generated: 12-Aug-2010 09:34:25 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_010289;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_010289');
...
semanticscience::org::resource::SIO_010289 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_010289;
  my $class = semanticscience::org::resource::SIO_010289->new();
