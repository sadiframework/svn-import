...
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::protein_family_record;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#protein_family_record');
...
www::mygrid::org::uk::ontology::protein_family_record - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = www::mygrid::org::uk::ontology::protein_family_record->new();
