...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#PATIKA');
...
www::mygrid::org::uk::ontology::PATIKA - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::PATIKA;
  my $class = www::mygrid::org::uk::ontology::PATIKA->new();
