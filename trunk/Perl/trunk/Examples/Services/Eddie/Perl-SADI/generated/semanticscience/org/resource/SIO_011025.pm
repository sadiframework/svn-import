#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_011025
# Generated: 12-Aug-2010 09:33:56 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_011025;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_011025');
...
semanticscience::org::resource::SIO_011025 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_011025;
  my $class = semanticscience::org::resource::SIO_011025->new();
