#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_011031
# Generated: 12-Aug-2010 09:35:33 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_011031;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_011031');
...
semanticscience::org::resource::SIO_011031 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_011031;
  my $class = semanticscience::org::resource::SIO_011031->new();
