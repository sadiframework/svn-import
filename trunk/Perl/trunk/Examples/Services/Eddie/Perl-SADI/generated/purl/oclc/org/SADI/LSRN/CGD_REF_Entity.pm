...
sub init {
    ...
    $self->type('http://purl.oclc.org/SADI/LSRN/CGD_REF_Entity');
...
purl::oclc::org::SADI::LSRN::CGD_REF_Entity - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use purl::oclc::org::SADI::LSRN::CGD_REF_Entity;
  my $class = purl::oclc::org::SADI::LSRN::CGD_REF_Entity->new();
