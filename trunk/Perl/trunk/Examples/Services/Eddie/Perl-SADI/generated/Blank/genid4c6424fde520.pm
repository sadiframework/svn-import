...
#-----------------------------------------------------------------
package Blank::genid4c6424fde520;
...
Blank::genid4c6424fde520 - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = Blank::genid4c6424fde520->new();

  # get the uri for this class
  my $uri = $class->uri;
  # add object properties 
  use purl::oclc::org::SADI::LSRN::KEGG_ec_Record;
  # add a SIO_010078 property (purl::oclc::org::SADI::LSRN::KEGG_ec_Record)
  $class->add_SIO_010078(new purl::oclc::org::SADI::LSRN::KEGG_ec_Record());
