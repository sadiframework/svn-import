...
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::bioinformatics_file_formats;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#bioinformatics_file_formats');
...
www::mygrid::org::uk::ontology::bioinformatics_file_formats - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = www::mygrid::org::uk::ontology::bioinformatics_file_formats->new();
