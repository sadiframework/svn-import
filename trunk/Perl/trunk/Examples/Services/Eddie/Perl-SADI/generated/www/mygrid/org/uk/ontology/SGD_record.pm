...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#SGD_record');
...
www::mygrid::org::uk::ontology::SGD_record - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::SGD_record;
  my $class = www::mygrid::org::uk::ontology::SGD_record->new();
