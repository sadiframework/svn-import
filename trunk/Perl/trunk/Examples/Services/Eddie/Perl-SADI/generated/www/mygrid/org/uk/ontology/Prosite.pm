...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#Prosite');
...
www::mygrid::org::uk::ontology::Prosite - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::Prosite;
  my $class = www::mygrid::org::uk::ontology::Prosite->new();
