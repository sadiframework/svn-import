#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::EDHA_term_record
# Generated: 12-Aug-2010 09:35:02 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::EDHA_term_record;

use OWL::Data::OWL::Class;
use www::mygrid::org::uk::ontology::human_anatomy_term_record;
use Blank::genid4c641370b108;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->Blank::genid4c641370b108::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->Blank::genid4c641370b108::_attr_prop( $attr_name, $prop_name ) 
            if $self->Blank::genid4c641370b108::_accessible($attr_name);
...
sub init {
    ...
    $self->Blank::genid4c641370b108::init();
    $self->type('http://www.mygrid.org.uk/ontology#EDHA_term_record');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->Blank::genid4c641370b108::_get_statements();
    };
...
www::mygrid::org::uk::ontology::EDHA_term_record - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::EDHA_term_record;
  my $class = www::mygrid::org::uk::ontology::EDHA_term_record->new();
