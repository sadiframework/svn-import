...
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_000089;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->Blank::genid4c6413698b6d::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->Blank::genid4c6413698b6d::_attr_prop( $attr_name, $prop_name ) 
            if $self->Blank::genid4c6413698b6d::_accessible($attr_name);
...
sub init {
    ...
    $self->Blank::genid4c6413698b6d::init();
    $self->type('http://semanticscience.org/resource/SIO_000089');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->Blank::genid4c6413698b6d::_get_statements();
    };
...
semanticscience::org::resource::SIO_000089 - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = semanticscience::org::resource::SIO_000089->new();
