#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::gapped_aligning
# Generated: 12-Aug-2010 09:34:53 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::gapped_aligning;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#gapped_aligning');
...
www::mygrid::org::uk::ontology::gapped_aligning - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::gapped_aligning;
  my $class = www::mygrid::org::uk::ontology::gapped_aligning->new();
