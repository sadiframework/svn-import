...
sub init {
    ...
    $self->type('http://purl.oclc.org/SADI/LSRN/GO_Identifier');
...
purl::oclc::org::SADI::LSRN::GO_Identifier - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = purl::oclc::org::SADI::LSRN::GO_Identifier->new();
