...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#mapping');
...
www::mygrid::org::uk::ontology::mapping - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::mapping;
  my $class = www::mygrid::org::uk::ontology::mapping->new();
