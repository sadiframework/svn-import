#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::TREMBL_record
# Generated: 12-Aug-2010 09:34:30 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::TREMBL_record;

use OWL::Data::OWL::Class;
use www::mygrid::org::uk::ontology::protein_sequence_record;
use Blank::genid4c6413712316;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->Blank::genid4c6413712316::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->Blank::genid4c6413712316::_attr_prop( $attr_name, $prop_name ) 
            if $self->Blank::genid4c6413712316::_accessible($attr_name);
...
sub init {
    ...
    $self->Blank::genid4c6413712316::init();
    $self->type('http://www.mygrid.org.uk/ontology#TREMBL_record');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->Blank::genid4c6413712316::_get_statements();
    };
...
www::mygrid::org::uk::ontology::TREMBL_record - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::TREMBL_record;
  my $class = www::mygrid::org::uk::ontology::TREMBL_record->new();
