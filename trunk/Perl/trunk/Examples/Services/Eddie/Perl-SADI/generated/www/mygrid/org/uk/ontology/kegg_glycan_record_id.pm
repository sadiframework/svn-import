#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::kegg_glycan_record_id
# Generated: 12-Aug-2010 09:33:46 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::kegg_glycan_record_id;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#kegg_glycan_record_id');
...
www::mygrid::org::uk::ontology::kegg_glycan_record_id - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::kegg_glycan_record_id;
  my $class = www::mygrid::org::uk::ontology::kegg_glycan_record_id->new();
