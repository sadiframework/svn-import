#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_010362
# Generated: 12-Aug-2010 09:35:08 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_010362;

use OWL::Data::OWL::Class;
use semanticscience::org::resource::SIO_010423;
use Blank::genid4c641366144a;
...
@ISA = qw(
 OWL::Data::OWL::Class
 semanticscience::org::resource::SIO_010423
 Blank::genid4c641366144a 
);
use strict;
...
use semanticscience::org::resource::SIO_000235;
...

{
    my %_allowed = (
        ...
        SIO_000235 => {
        	...
        	post => sub {
                ...
                my $type = @{$self->SIO_000235}[-1] if defined $self->SIO_000235;
                return unless defined $type and $type->type;
                my $range = new semanticscience::org::resource::SIO_000235->range();
                return unless $range;
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->semanticscience::org::resource::SIO_010423::_accessible($attr)
          or $self->Blank::genid4c641366144a::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->semanticscience::org::resource::SIO_010423::_attr_prop( $attr_name, $prop_name ) 
            if $self->semanticscience::org::resource::SIO_010423::_accessible($attr_name);
        return $self->Blank::genid4c641366144a::_attr_prop( $attr_name, $prop_name ) 
            if $self->Blank::genid4c641366144a::_accessible($attr_name);
...
sub init {
    ...
    $self->semanticscience::org::resource::SIO_010423::init();
    $self->Blank::genid4c641366144a::init();
    $self->type('http://semanticscience.org/resource/SIO_010362');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->semanticscience::org::resource::SIO_010423::_get_statements();
    };
    eval {
    	# add parent statements
        $self->Blank::genid4c641366144a::_get_statements();
    };

    # for each attribute, if is array do:
    if (defined $self->SIO_000235){
	    foreach (@{$self->SIO_000235}) {
	        ...
	        $self->model->addStmt(
	          new RDF::Core::Statement(
	              $subject,
	              $subject->new('http://semanticscience.org/resource/SIO_000235'), 
...
semanticscience::org::resource::SIO_010362 - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = semanticscience::org::resource::SIO_010362->new();
  ...
  $class->add_SIO_000235(new OWL::Data::OWL::Class('#someURI'));

  # get the SIO_000235 object properties
  my $SIO_000235_objects = $class->SIO_000235;
...
L<semanticscience::org::resource::SIO_010423>
L<Blank::genid4c641366144a>
