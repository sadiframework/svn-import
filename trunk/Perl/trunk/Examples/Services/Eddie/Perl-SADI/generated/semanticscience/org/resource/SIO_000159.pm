#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_000159
# Generated: 12-Aug-2010 09:33:50 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_000159;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_000159');
...
semanticscience::org::resource::SIO_000159 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_000159;
  my $class = semanticscience::org::resource::SIO_000159->new();
