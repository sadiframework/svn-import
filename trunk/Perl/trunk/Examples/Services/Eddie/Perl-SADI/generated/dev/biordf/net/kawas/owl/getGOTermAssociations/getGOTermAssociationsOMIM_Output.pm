#-----------------------------------------------------------------
# dev::biordf::net::kawas::owl::getGOTermAssociations::getGOTermAssociationsOMIM_Output
# Generated: 19-Aug-2010 10:59:02 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package dev::biordf::net::kawas::owl::getGOTermAssociations::getGOTermAssociationsOMIM_Output;

use OWL::Data::OWL::Class;
use purl::oclc::org::SADI::LSRN::GO_Record;
use Blank::genid4c6d70c41eef;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->Blank::genid4c6d70c41eef::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->Blank::genid4c6d70c41eef::_attr_prop( $attr_name, $prop_name ) 
            if $self->Blank::genid4c6d70c41eef::_accessible($attr_name);
...
sub init {
    ...
    $self->Blank::genid4c6d70c41eef::init();
    $self->type('http://dev.biordf.net/~kawas/owl/getGOTermAssociations.owl#getGOTermAssociationsOMIM_Output');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->Blank::genid4c6d70c41eef::_get_statements();
    };
...
dev::biordf::net::kawas::owl::getGOTermAssociations::getGOTermAssociationsOMIM_Output - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use dev::biordf::net::kawas::owl::getGOTermAssociations::getGOTermAssociationsOMIM_Output;
  my $class = dev::biordf::net::kawas::owl::getGOTermAssociations::getGOTermAssociationsOMIM_Output->new();
