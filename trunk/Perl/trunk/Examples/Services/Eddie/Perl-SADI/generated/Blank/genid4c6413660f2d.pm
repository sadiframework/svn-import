...
@ISA = qw(
 OWL::Data::OWL::Class
 semanticscience::org::resource::SIO_010436 
);
use strict;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->semanticscience::org::resource::SIO_010436::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->semanticscience::org::resource::SIO_010436::_attr_prop( $attr_name, $prop_name ) 
            if $self->semanticscience::org::resource::SIO_010436::_accessible($attr_name);
...
sub init {
    ...
    $self->semanticscience::org::resource::SIO_010436::init();
    $self->type('_:genid4c6413660f2d');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->semanticscience::org::resource::SIO_010436::_get_statements();
    };
...
Blank::genid4c6413660f2d - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use Blank::genid4c6413660f2d;
  my $class = Blank::genid4c6413660f2d->new();

  # get the uri for this class
  my $uri = $class->uri;
  # add object properties 
  use Blank::genid4c641366c078;
  # add a SIO_000235 property (Blank::genid4c641366c078)
  $class->add_SIO_000235(new Blank::genid4c641366c078());
...
L<semanticscience::org::resource::SIO_010436>
