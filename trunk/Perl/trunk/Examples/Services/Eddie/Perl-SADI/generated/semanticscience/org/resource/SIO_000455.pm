...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->semanticscience::org::resource::SIO_000450::_accessible($attr)
          or $self->Blank::genid4c64136926e7::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->semanticscience::org::resource::SIO_000450::_attr_prop( $attr_name, $prop_name ) 
            if $self->semanticscience::org::resource::SIO_000450::_accessible($attr_name);
        return $self->Blank::genid4c64136926e7::_attr_prop( $attr_name, $prop_name ) 
            if $self->Blank::genid4c64136926e7::_accessible($attr_name);
...
sub init {
    ...
    $self->semanticscience::org::resource::SIO_000450::init();
    $self->Blank::genid4c64136926e7::init();
    $self->type('http://semanticscience.org/resource/SIO_000455');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->semanticscience::org::resource::SIO_000450::_get_statements();
    };
    eval {
    	# add parent statements
        $self->Blank::genid4c64136926e7::_get_statements();
    };
...
semanticscience::org::resource::SIO_000455 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_000455;
  my $class = semanticscience::org::resource::SIO_000455->new();
...
L<semanticscience::org::resource::SIO_000450>
L<Blank::genid4c64136926e7>
