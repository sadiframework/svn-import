#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_011099
# Generated: 12-Aug-2010 09:35:17 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_011099;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_011099');
...
semanticscience::org::resource::SIO_011099 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_011099;
  my $class = semanticscience::org::resource::SIO_011099->new();
