#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_011103
# Generated: 12-Aug-2010 09:33:44 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_011103;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_011103');
...
semanticscience::org::resource::SIO_011103 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_011103;
  my $class = semanticscience::org::resource::SIO_011103->new();
