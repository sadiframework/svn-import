#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_011115
# Generated: 12-Aug-2010 09:35:00 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_011115;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_011115');
...
semanticscience::org::resource::SIO_011115 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_011115;
  my $class = semanticscience::org::resource::SIO_011115->new();
