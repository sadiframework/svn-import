#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_010301
# Generated: 12-Aug-2010 09:34:24 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_010301;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_010301');
...
semanticscience::org::resource::SIO_010301 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_010301;
  my $class = semanticscience::org::resource::SIO_010301->new();
