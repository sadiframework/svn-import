#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_011050
# Generated: 12-Aug-2010 09:35:17 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_011050;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_011050');
...
semanticscience::org::resource::SIO_011050 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_011050;
  my $class = semanticscience::org::resource::SIO_011050->new();
