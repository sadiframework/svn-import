#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::mged_term_record
# Generated: 12-Aug-2010 09:34:37 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::mged_term_record;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#mged_term_record');
...
www::mygrid::org::uk::ontology::mged_term_record - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::mged_term_record;
  my $class = www::mygrid::org::uk::ontology::mged_term_record->new();
