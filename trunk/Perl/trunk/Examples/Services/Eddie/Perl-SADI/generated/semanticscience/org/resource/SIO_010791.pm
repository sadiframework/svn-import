#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_010791
# Generated: 12-Aug-2010 09:35:28 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_010791;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_010791');
...
semanticscience::org::resource::SIO_010791 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_010791;
  my $class = semanticscience::org::resource::SIO_010791->new();
