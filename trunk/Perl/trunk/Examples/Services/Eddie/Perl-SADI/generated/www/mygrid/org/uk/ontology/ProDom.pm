...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#ProDom');
...
www::mygrid::org::uk::ontology::ProDom - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::ProDom;
  my $class = www::mygrid::org::uk::ontology::ProDom->new();
