#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::Candida_Genome_Database_CGD
# Generated: 12-Aug-2010 09:34:53 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::Candida_Genome_Database_CGD;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#Candida_Genome_Database_CGD');
...
www::mygrid::org::uk::ontology::Candida_Genome_Database_CGD - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::Candida_Genome_Database_CGD;
  my $class = www::mygrid::org::uk::ontology::Candida_Genome_Database_CGD->new();
