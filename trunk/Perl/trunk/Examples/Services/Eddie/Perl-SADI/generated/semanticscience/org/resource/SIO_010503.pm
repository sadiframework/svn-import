#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_010503
# Generated: 12-Aug-2010 09:35:04 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_010503;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_010503');
...
semanticscience::org::resource::SIO_010503 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_010503;
  my $class = semanticscience::org::resource::SIO_010503->new();
