...
# Generated: 12-Aug-2010 09:34:03 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::protein_expression_report;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#protein_expression_report');
...
www::mygrid::org::uk::ontology::protein_expression_report - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = www::mygrid::org::uk::ontology::protein_expression_report->new();
