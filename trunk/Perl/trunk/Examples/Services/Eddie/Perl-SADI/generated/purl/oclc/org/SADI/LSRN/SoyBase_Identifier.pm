#-----------------------------------------------------------------
# purl::oclc::org::SADI::LSRN::SoyBase_Identifier
# Generated: 12-Aug-2010 09:33:30 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package purl::oclc::org::SADI::LSRN::SoyBase_Identifier;
...
sub init {
    ...
    $self->type('http://purl.oclc.org/SADI/LSRN/SoyBase_Identifier');
...
purl::oclc::org::SADI::LSRN::SoyBase_Identifier - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use purl::oclc::org::SADI::LSRN::SoyBase_Identifier;
  my $class = purl::oclc::org::SADI::LSRN::SoyBase_Identifier->new();
