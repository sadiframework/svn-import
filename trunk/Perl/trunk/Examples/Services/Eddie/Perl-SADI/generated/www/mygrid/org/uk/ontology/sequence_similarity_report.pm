...
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::sequence_similarity_report;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#sequence_similarity_report');
...
www::mygrid::org::uk::ontology::sequence_similarity_report - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = www::mygrid::org::uk::ontology::sequence_similarity_report->new();
