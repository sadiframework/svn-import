#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_010295
# Generated: 12-Aug-2010 09:35:16 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_010295;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_010295');
...
semanticscience::org::resource::SIO_010295 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_010295;
  my $class = semanticscience::org::resource::SIO_010295->new();
