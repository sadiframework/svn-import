...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#treecon');
...
www::mygrid::org::uk::ontology::treecon - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::treecon;
  my $class = www::mygrid::org::uk::ontology::treecon->new();
