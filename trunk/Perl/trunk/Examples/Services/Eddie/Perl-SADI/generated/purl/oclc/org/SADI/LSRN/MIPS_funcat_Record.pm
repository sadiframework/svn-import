#-----------------------------------------------------------------
# purl::oclc::org::SADI::LSRN::MIPS_funcat_Record
# Generated: 12-Aug-2010 09:34:26 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package purl::oclc::org::SADI::LSRN::MIPS_funcat_Record;
...
sub init {
    ...
    $self->type('http://purl.oclc.org/SADI/LSRN/MIPS_funcat_Record');
...
purl::oclc::org::SADI::LSRN::MIPS_funcat_Record - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use purl::oclc::org::SADI::LSRN::MIPS_funcat_Record;
  my $class = purl::oclc::org::SADI::LSRN::MIPS_funcat_Record->new();
