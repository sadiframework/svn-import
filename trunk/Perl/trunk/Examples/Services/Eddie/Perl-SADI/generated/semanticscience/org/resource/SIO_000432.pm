#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_000432
# Generated: 12-Aug-2010 09:35:00 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_000432;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_000432');
...
semanticscience::org::resource::SIO_000432 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_000432;
  my $class = semanticscience::org::resource::SIO_000432->new();
