#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_011086
# Generated: 12-Aug-2010 09:33:59 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_011086;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_011086');
...
semanticscience::org::resource::SIO_011086 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_011086;
  my $class = semanticscience::org::resource::SIO_011086->new();
