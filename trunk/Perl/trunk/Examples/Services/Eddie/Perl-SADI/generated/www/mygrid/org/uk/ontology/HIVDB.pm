...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#HIVDB');
...
www::mygrid::org::uk::ontology::HIVDB - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::HIVDB;
  my $class = www::mygrid::org::uk::ontology::HIVDB->new();
