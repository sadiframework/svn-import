#-----------------------------------------------------------------
# purl::oclc::org::SADI::LSRN::UM_BBD_pathwayID_Entity
# Generated: 12-Aug-2010 09:34:10 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package purl::oclc::org::SADI::LSRN::UM_BBD_pathwayID_Entity;
...
sub init {
    ...
    $self->type('http://purl.oclc.org/SADI/LSRN/UM-BBD_pathwayID_Entity');
...
purl::oclc::org::SADI::LSRN::UM_BBD_pathwayID_Entity - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use purl::oclc::org::SADI::LSRN::UM_BBD_pathwayID_Entity;
  my $class = purl::oclc::org::SADI::LSRN::UM_BBD_pathwayID_Entity->new();
