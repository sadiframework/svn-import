#-----------------------------------------------------------------
# Blank::genid4c6413699ab0
# Generated: 12-Aug-2010 09:33:43 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package Blank::genid4c6413699ab0;

use OWL::Data::OWL::Class;
use semanticscience::org::resource::SIO_000185;
...
@ISA = qw(
 OWL::Data::OWL::Class
 semanticscience::org::resource::SIO_000185 
);
use strict;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->semanticscience::org::resource::SIO_000185::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->semanticscience::org::resource::SIO_000185::_attr_prop( $attr_name, $prop_name ) 
            if $self->semanticscience::org::resource::SIO_000185::_accessible($attr_name);
...
sub init {
    ...
    $self->semanticscience::org::resource::SIO_000185::init();
    $self->type('_:genid4c6413699ab0');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->semanticscience::org::resource::SIO_000185::_get_statements();
    };
...
Blank::genid4c6413699ab0 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use Blank::genid4c6413699ab0;
  my $class = Blank::genid4c6413699ab0->new();

  # get the uri for this class
  my $uri = $class->uri;
  # add object properties 
  use semanticscience::org::resource::SIO_000083;
  # add a SIO_000310 property (semanticscience::org::resource::SIO_000083)
  $class->add_SIO_000310(new semanticscience::org::resource::SIO_000083());
...
L<semanticscience::org::resource::SIO_000185>
