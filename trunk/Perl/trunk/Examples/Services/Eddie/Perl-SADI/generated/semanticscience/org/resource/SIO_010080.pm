#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_010080
# Generated: 12-Aug-2010 09:33:25 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_010080;
...
sub init {
    ...
    $self->range('_:genid4c6413666088');    
    # set the domain for this object property
    $self->domain('http://semanticscience.org/resource/SIO_010010');    
    # set the uri for this object property
    $self->uri('http://semanticscience.org/resource/SIO_010080');
}
...
semanticscience::org::resource::SIO_010080 - an object propery

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_010080;
  my $property = semanticscience::org::resource::SIO_010080->new();
