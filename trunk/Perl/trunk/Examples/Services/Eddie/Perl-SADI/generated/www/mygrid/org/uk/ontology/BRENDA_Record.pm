#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::BRENDA_Record
# Generated: 12-Aug-2010 09:34:25 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::BRENDA_Record;

use OWL::Data::OWL::Class;
use www::mygrid::org::uk::ontology::enzyme_record;
use Blank::genid4c641370c02f;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->Blank::genid4c641370c02f::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->Blank::genid4c641370c02f::_attr_prop( $attr_name, $prop_name ) 
            if $self->Blank::genid4c641370c02f::_accessible($attr_name);
...
sub init {
    ...
    $self->Blank::genid4c641370c02f::init();
    $self->type('http://www.mygrid.org.uk/ontology#BRENDA_Record');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->Blank::genid4c641370c02f::_get_statements();
    };
...
www::mygrid::org::uk::ontology::BRENDA_Record - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::BRENDA_Record;
  my $class = www::mygrid::org::uk::ontology::BRENDA_Record->new();
