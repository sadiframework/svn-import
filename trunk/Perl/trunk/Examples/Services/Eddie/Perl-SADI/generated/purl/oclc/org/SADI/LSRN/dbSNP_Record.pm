...
#-----------------------------------------------------------------
package purl::oclc::org::SADI::LSRN::dbSNP_Record;
...
sub init {
    ...
    $self->type('http://purl.oclc.org/SADI/LSRN/dbSNP_Record');
...
purl::oclc::org::SADI::LSRN::dbSNP_Record - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = purl::oclc::org::SADI::LSRN::dbSNP_Record->new();
