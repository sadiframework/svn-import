...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#Panther');
...
www::mygrid::org::uk::ontology::Panther - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::Panther;
  my $class = www::mygrid::org::uk::ontology::Panther->new();
