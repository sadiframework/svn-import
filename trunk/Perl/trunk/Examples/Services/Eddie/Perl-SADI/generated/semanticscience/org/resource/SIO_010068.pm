#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_010068
# Generated: 12-Aug-2010 09:35:31 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_010068;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_010068');
...
semanticscience::org::resource::SIO_010068 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_010068;
  my $class = semanticscience::org::resource::SIO_010068->new();
