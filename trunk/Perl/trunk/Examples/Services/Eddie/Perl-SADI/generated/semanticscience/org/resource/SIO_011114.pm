#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_011114
# Generated: 12-Aug-2010 09:33:45 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_011114;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_011114');
...
semanticscience::org::resource::SIO_011114 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_011114;
  my $class = semanticscience::org::resource::SIO_011114->new();
