#-----------------------------------------------------------------
# purl::oclc::org::SADI::LSRN::HGNC_Symbol_Identifier
# Generated: 12-Aug-2010 09:33:58 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package purl::oclc::org::SADI::LSRN::HGNC_Symbol_Identifier;
...
sub init {
    ...
    $self->type('http://purl.oclc.org/SADI/LSRN/HGNC_Symbol_Identifier');
...
purl::oclc::org::SADI::LSRN::HGNC_Symbol_Identifier - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use purl::oclc::org::SADI::LSRN::HGNC_Symbol_Identifier;
  my $class = purl::oclc::org::SADI::LSRN::HGNC_Symbol_Identifier->new();
