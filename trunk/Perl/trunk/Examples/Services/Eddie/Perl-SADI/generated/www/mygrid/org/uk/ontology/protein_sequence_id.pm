...
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::protein_sequence_id;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#protein_sequence_id');
...
www::mygrid::org::uk::ontology::protein_sequence_id - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = www::mygrid::org::uk::ontology::protein_sequence_id->new();
