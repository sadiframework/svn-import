#-----------------------------------------------------------------
# purl::oclc::org::SADI::LSRN::GeneID_Identifier
# Generated: 12-Aug-2010 09:34:48 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package purl::oclc::org::SADI::LSRN::GeneID_Identifier;
...
sub init {
    ...
    $self->type('http://purl.oclc.org/SADI/LSRN/GeneID_Identifier');
...
purl::oclc::org::SADI::LSRN::GeneID_Identifier - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = purl::oclc::org::SADI::LSRN::GeneID_Identifier->new();
