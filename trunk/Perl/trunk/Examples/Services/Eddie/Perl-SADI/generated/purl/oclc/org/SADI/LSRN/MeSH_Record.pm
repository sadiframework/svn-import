...
sub init {
    ...
    $self->type('http://purl.oclc.org/SADI/LSRN/MeSH_Record');
...
purl::oclc::org::SADI::LSRN::MeSH_Record - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use purl::oclc::org::SADI::LSRN::MeSH_Record;
  my $class = purl::oclc::org::SADI::LSRN::MeSH_Record->new();
