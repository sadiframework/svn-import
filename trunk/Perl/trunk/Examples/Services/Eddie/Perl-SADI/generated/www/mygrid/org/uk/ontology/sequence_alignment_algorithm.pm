...
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::sequence_alignment_algorithm;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#sequence_alignment_algorithm');
...
www::mygrid::org::uk::ontology::sequence_alignment_algorithm - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = www::mygrid::org::uk::ontology::sequence_alignment_algorithm->new();
