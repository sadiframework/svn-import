#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_000261
# Generated: 12-Aug-2010 09:33:43 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_000261;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_000261');
...
semanticscience::org::resource::SIO_000261 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_000261;
  my $class = semanticscience::org::resource::SIO_000261->new();
