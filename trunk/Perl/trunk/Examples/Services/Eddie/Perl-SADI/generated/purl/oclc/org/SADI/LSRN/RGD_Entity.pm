...
sub init {
    ...
    $self->type('http://purl.oclc.org/SADI/LSRN/RGD_Entity');
...
purl::oclc::org::SADI::LSRN::RGD_Entity - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use purl::oclc::org::SADI::LSRN::RGD_Entity;
  my $class = purl::oclc::org::SADI::LSRN::RGD_Entity->new();
