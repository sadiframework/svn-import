...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#Ensembl');
...
www::mygrid::org::uk::ontology::Ensembl - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::Ensembl;
  my $class = www::mygrid::org::uk::ontology::Ensembl->new();
