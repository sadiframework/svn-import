#-----------------------------------------------------------------
# dev::biordf::net::kawas::owl::kegg2prosite::kegg2prosite_OutputClass
# Generated: 12-Aug-2010 09:44:32 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package dev::biordf::net::kawas::owl::kegg2prosite::kegg2prosite_OutputClass;

use OWL::Data::OWL::Class;
use Blank::genid4c6424efee82;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->Blank::genid4c6424efee82::_accessible($attr)
    ...
    sub _attr_prop {
        ...
        return $self->Blank::genid4c6424efee82::_attr_prop( $attr_name, $prop_name ) 
            if $self->Blank::genid4c6424efee82::_accessible($attr_name);
...
sub init {
    ...
    $self->Blank::genid4c6424efee82::init();
    $self->purl::oclc::org::SADI::LSRN::KEGG_Record::init();
    $self->type('http://dev.biordf.net/~kawas/owl/kegg2prosite.owl#kegg2prosite_OutputClass');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->Blank::genid4c6424efee82::_get_statements();
    };
    eval {
    	# add parent statements
...
dev::biordf::net::kawas::owl::kegg2prosite::kegg2prosite_OutputClass - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = dev::biordf::net::kawas::owl::kegg2prosite::kegg2prosite_OutputClass->new();
