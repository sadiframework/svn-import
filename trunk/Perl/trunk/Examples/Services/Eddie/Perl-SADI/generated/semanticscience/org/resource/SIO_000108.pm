#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_000108
# Generated: 12-Aug-2010 09:34:10 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_000108;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_000108');
...
semanticscience::org::resource::SIO_000108 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_000108;
  my $class = semanticscience::org::resource::SIO_000108->new();
