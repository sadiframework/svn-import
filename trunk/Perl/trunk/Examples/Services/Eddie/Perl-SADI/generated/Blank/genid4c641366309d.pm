...
Blank::genid4c641366309d - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use Blank::genid4c641366309d;
  my $class = Blank::genid4c641366309d->new();

  # get the uri for this class
  my $uri = $class->uri;
  # add object properties 
  use semanticscience::org::resource::SIO_010451;
  # add a SIO_000273 property (semanticscience::org::resource::SIO_010451)
  $class->add_SIO_000273(new semanticscience::org::resource::SIO_010451());
