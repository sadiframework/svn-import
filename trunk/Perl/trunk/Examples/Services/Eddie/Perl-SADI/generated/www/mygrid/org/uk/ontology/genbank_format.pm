#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::genbank_format
# Generated: 12-Aug-2010 09:34:45 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::genbank_format;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->www::mygrid::org::uk::ontology::sequence_record_format::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->www::mygrid::org::uk::ontology::sequence_record_format::_attr_prop( $attr_name, $prop_name ) 
            if $self->www::mygrid::org::uk::ontology::sequence_record_format::_accessible($attr_name);
...
sub init {
    ...
    $self->www::mygrid::org::uk::ontology::sequence_record_format::init();
    $self->type('http://www.mygrid.org.uk/ontology#genbank_format');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->www::mygrid::org::uk::ontology::sequence_record_format::_get_statements();
    };
...
www::mygrid::org::uk::ontology::genbank_format - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::genbank_format;
  my $class = www::mygrid::org::uk::ontology::genbank_format->new();
...
L<www::mygrid::org::uk::ontology::sequence_record_format>
