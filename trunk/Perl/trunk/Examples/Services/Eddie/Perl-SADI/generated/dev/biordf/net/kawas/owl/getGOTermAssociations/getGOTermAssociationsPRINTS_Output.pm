#-----------------------------------------------------------------
# dev::biordf::net::kawas::owl::getGOTermAssociations::getGOTermAssociationsPRINTS_Output
# Generated: 19-Aug-2010 10:59:01 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package dev::biordf::net::kawas::owl::getGOTermAssociations::getGOTermAssociationsPRINTS_Output;

use OWL::Data::OWL::Class;
use Blank::genid4c6d70c4cfdc;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->Blank::genid4c6d70c4cfdc::_accessible($attr)
    ...
    sub _attr_prop {
        ...
        return $self->Blank::genid4c6d70c4cfdc::_attr_prop( $attr_name, $prop_name ) 
            if $self->Blank::genid4c6d70c4cfdc::_accessible($attr_name);
...
sub init {
    ...
    $self->Blank::genid4c6d70c4cfdc::init();
    $self->purl::oclc::org::SADI::LSRN::GO_Record::init();
    $self->type('http://dev.biordf.net/~kawas/owl/getGOTermAssociations.owl#getGOTermAssociationsPRINTS_Output');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->Blank::genid4c6d70c4cfdc::_get_statements();
    };
    eval {
    	# add parent statements
...
dev::biordf::net::kawas::owl::getGOTermAssociations::getGOTermAssociationsPRINTS_Output - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use dev::biordf::net::kawas::owl::getGOTermAssociations::getGOTermAssociationsPRINTS_Output;
  my $class = dev::biordf::net::kawas::owl::getGOTermAssociations::getGOTermAssociationsPRINTS_Output->new();
