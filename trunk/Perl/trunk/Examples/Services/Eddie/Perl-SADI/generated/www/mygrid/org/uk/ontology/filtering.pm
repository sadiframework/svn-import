...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#filtering');
...
www::mygrid::org::uk::ontology::filtering - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::filtering;
  my $class = www::mygrid::org::uk::ontology::filtering->new();
