#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_000236
# Generated: 12-Aug-2010 09:33:25 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_000236;
...
sub init {
    ...
    $self->domain('http://semanticscience.org/resource/SIO_000014');    
    # set the uri for this object property
    $self->uri('http://semanticscience.org/resource/SIO_000236');
}
...
semanticscience::org::resource::SIO_000236 - an object propery

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_000236;
  my $property = semanticscience::org::resource::SIO_000236->new();
