...
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_010456;

use OWL::Data::OWL::Class;
use semanticscience::org::resource::SIO_010004;
use Blank::genid4c641366cf14;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->Blank::genid4c641366cf14::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->Blank::genid4c641366cf14::_attr_prop( $attr_name, $prop_name ) 
            if $self->Blank::genid4c641366cf14::_accessible($attr_name);
...
sub init {
    ...
    $self->Blank::genid4c641366cf14::init();
    $self->type('http://semanticscience.org/resource/SIO_010456');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->Blank::genid4c641366cf14::_get_statements();
    };
...
semanticscience::org::resource::SIO_010456 - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = semanticscience::org::resource::SIO_010456->new();
