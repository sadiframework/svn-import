...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#PDB');
...
www::mygrid::org::uk::ontology::PDB - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::PDB;
  my $class = www::mygrid::org::uk::ontology::PDB->new();
