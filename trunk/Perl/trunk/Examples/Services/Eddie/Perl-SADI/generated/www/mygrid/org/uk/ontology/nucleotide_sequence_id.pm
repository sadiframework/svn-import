...
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::nucleotide_sequence_id;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->www::mygrid::org::uk::ontology::biological_sequence_id::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->www::mygrid::org::uk::ontology::biological_sequence_id::_attr_prop( $attr_name, $prop_name ) 
            if $self->www::mygrid::org::uk::ontology::biological_sequence_id::_accessible($attr_name);
...
sub init {
    ...
    $self->www::mygrid::org::uk::ontology::biological_sequence_id::init();
    $self->type('http://www.mygrid.org.uk/ontology#nucleotide_sequence_id');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->www::mygrid::org::uk::ontology::biological_sequence_id::_get_statements();
    };
...
www::mygrid::org::uk::ontology::nucleotide_sequence_id - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = www::mygrid::org::uk::ontology::nucleotide_sequence_id->new();
...
L<www::mygrid::org::uk::ontology::biological_sequence_id>
