...
Blank::genid4c6424fef42a - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use Blank::genid4c6424fef42a;
  my $class = Blank::genid4c6424fef42a->new();

  # get the uri for this class
  my $uri = $class->uri;
  # add object properties 
  use www::mygrid::org::uk::ontology::ENZYME_Record;
  # add a SIO_010078 property (www::mygrid::org::uk::ontology::ENZYME_Record)
  $class->add_SIO_010078(new www::mygrid::org::uk::ontology::ENZYME_Record());
