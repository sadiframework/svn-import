...
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::nucleotide_sequence_record;

use OWL::Data::OWL::Class;
use www::mygrid::org::uk::ontology::sequence_record;
use Blank::genid4c6413718a11;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->Blank::genid4c6413718a11::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->Blank::genid4c6413718a11::_attr_prop( $attr_name, $prop_name ) 
            if $self->Blank::genid4c6413718a11::_accessible($attr_name);
...
sub init {
    ...
    $self->Blank::genid4c6413718a11::init();
    $self->type('http://www.mygrid.org.uk/ontology#nucleotide_sequence_record');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->Blank::genid4c6413718a11::_get_statements();
    };
...
www::mygrid::org::uk::ontology::nucleotide_sequence_record - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = www::mygrid::org::uk::ontology::nucleotide_sequence_record->new();
