...
#-----------------------------------------------------------------
package Blank::genid4c642503133e;
...
Blank::genid4c642503133e - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = Blank::genid4c642503133e->new();

  # get the uri for this class
  my $uri = $class->uri;
  # add object properties 
  use purl::oclc::org::SADI::LSRN::DragonDB_Locus_Record;
  # add a SIO_000272 property (purl::oclc::org::SADI::LSRN::DragonDB_Locus_Record)
  $class->add_SIO_000272(new purl::oclc::org::SADI::LSRN::DragonDB_Locus_Record());
