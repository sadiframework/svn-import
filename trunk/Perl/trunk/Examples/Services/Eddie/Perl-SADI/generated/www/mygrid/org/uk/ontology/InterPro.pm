...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->www::mygrid::org::uk::ontology::protein_family_database::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->www::mygrid::org::uk::ontology::protein_family_database::_attr_prop( $attr_name, $prop_name ) 
            if $self->www::mygrid::org::uk::ontology::protein_family_database::_accessible($attr_name);
...
sub init {
    ...
    $self->www::mygrid::org::uk::ontology::protein_family_database::init();
    $self->type('http://www.mygrid.org.uk/ontology#InterPro');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->www::mygrid::org::uk::ontology::protein_family_database::_get_statements();
    };
...
www::mygrid::org::uk::ontology::InterPro - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::InterPro;
  my $class = www::mygrid::org::uk::ontology::InterPro->new();
...
L<www::mygrid::org::uk::ontology::protein_family_database>
