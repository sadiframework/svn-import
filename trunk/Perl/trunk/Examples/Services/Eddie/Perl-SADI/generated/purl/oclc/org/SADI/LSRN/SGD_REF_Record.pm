...
sub init {
    ...
    $self->type('http://purl.oclc.org/SADI/LSRN/SGD_REF_Record');
...
purl::oclc::org::SADI::LSRN::SGD_REF_Record - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use purl::oclc::org::SADI::LSRN::SGD_REF_Record;
  my $class = purl::oclc::org::SADI::LSRN::SGD_REF_Record->new();
