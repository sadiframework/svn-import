#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_010424
# Generated: 12-Aug-2010 09:35:30 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_010424;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_010424');
...
semanticscience::org::resource::SIO_010424 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_010424;
  my $class = semanticscience::org::resource::SIO_010424->new();
