#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_000041
# Generated: 12-Aug-2010 09:35:12 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_000041;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_000041');
...
semanticscience::org::resource::SIO_000041 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_000041;
  my $class = semanticscience::org::resource::SIO_000041->new();
