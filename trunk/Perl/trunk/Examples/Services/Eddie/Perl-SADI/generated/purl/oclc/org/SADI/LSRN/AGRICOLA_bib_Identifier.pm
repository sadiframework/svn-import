#-----------------------------------------------------------------
# purl::oclc::org::SADI::LSRN::AGRICOLA_bib_Identifier
# Generated: 12-Aug-2010 09:35:01 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package purl::oclc::org::SADI::LSRN::AGRICOLA_bib_Identifier;
...
sub init {
    ...
    $self->type('http://purl.oclc.org/SADI/LSRN/AGRICOLA_bib_Identifier');
...
purl::oclc::org::SADI::LSRN::AGRICOLA_bib_Identifier - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use purl::oclc::org::SADI::LSRN::AGRICOLA_bib_Identifier;
  my $class = purl::oclc::org::SADI::LSRN::AGRICOLA_bib_Identifier->new();
