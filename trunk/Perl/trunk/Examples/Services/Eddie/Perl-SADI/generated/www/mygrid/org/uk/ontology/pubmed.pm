...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#pubmed');
...
www::mygrid::org::uk::ontology::pubmed - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::pubmed;
  my $class = www::mygrid::org::uk::ontology::pubmed->new();
