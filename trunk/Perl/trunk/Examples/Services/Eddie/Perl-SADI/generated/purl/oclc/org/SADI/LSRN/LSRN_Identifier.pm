...
#-----------------------------------------------------------------
package purl::oclc::org::SADI::LSRN::LSRN_Identifier;
...
sub init {
    ...
    $self->type('http://purl.oclc.org/SADI/LSRN/LSRN_Identifier');
...
purl::oclc::org::SADI::LSRN::LSRN_Identifier - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = purl::oclc::org::SADI::LSRN::LSRN_Identifier->new();
