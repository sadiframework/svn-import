#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_010499
# Generated: 12-Aug-2010 09:34:20 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_010499;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_010499');
...
semanticscience::org::resource::SIO_010499 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_010499;
  my $class = semanticscience::org::resource::SIO_010499->new();
