#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_011012
# Generated: 12-Aug-2010 09:35:21 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_011012;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_011012');
...
semanticscience::org::resource::SIO_011012 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_011012;
  my $class = semanticscience::org::resource::SIO_011012->new();
