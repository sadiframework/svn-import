#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_000166
# Generated: 12-Aug-2010 09:34:27 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_000166;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_000166');
...
semanticscience::org::resource::SIO_000166 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_000166;
  my $class = semanticscience::org::resource::SIO_000166->new();
