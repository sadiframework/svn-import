...
sub init {
    ...
    $self->type('_:genid4c6424fd33bc');
    $self->add_fromOrganism(purl::oclc::org::SADI::LSRN::taxon_Record->new('http://lsrn.org/taxon:10116'));
...
Blank::genid4c6424fd33bc - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use Blank::genid4c6424fd33bc;
  my $class = Blank::genid4c6424fd33bc->new();
...
=item 'fromOrganism' has value 'http://lsrn.org/taxon:10116', for example, (purl::oclc::org::SADI::LSRN::taxon_Record->new('http://lsrn.org/taxon:10116'));
