...
# Generated: 12-Aug-2010 09:34:41 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_010071;

use OWL::Data::OWL::Class;
use semanticscience::org::resource::SIO_010441;
use Blank::genid4c641366c455;
...
@ISA = qw(
 OWL::Data::OWL::Class
 semanticscience::org::resource::SIO_010441
 Blank::genid4c641366c455 
);
use strict;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->semanticscience::org::resource::SIO_010441::_accessible($attr)
          or $self->Blank::genid4c641366c455::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->semanticscience::org::resource::SIO_010441::_attr_prop( $attr_name, $prop_name ) 
            if $self->semanticscience::org::resource::SIO_010441::_accessible($attr_name);
        return $self->Blank::genid4c641366c455::_attr_prop( $attr_name, $prop_name ) 
            if $self->Blank::genid4c641366c455::_accessible($attr_name);
...
sub init {
    ...
    $self->semanticscience::org::resource::SIO_010441::init();
    $self->Blank::genid4c641366c455::init();
    $self->type('http://semanticscience.org/resource/SIO_010071');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->semanticscience::org::resource::SIO_010441::_get_statements();
    };
    eval {
    	# add parent statements
        $self->Blank::genid4c641366c455::_get_statements();
    };
...
semanticscience::org::resource::SIO_010071 - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = semanticscience::org::resource::SIO_010071->new();
...
L<semanticscience::org::resource::SIO_010441>
L<Blank::genid4c641366c455>
