#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_010781
# Generated: 12-Aug-2010 09:33:27 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_010781;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_010781');
...
semanticscience::org::resource::SIO_010781 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_010781;
  my $class = semanticscience::org::resource::SIO_010781->new();
