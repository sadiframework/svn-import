#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_000515
# Generated: 12-Aug-2010 09:35:32 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_000515;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_000515');
...
semanticscience::org::resource::SIO_000515 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_000515;
  my $class = semanticscience::org::resource::SIO_000515->new();
