#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_010445
# Generated: 12-Aug-2010 09:33:58 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_010445;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_010445');
...
semanticscience::org::resource::SIO_010445 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_010445;
  my $class = semanticscience::org::resource::SIO_010445->new();
