...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#PDB_id');
...
www::mygrid::org::uk::ontology::PDB_id - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::PDB_id;
  my $class = www::mygrid::org::uk::ontology::PDB_id->new();
