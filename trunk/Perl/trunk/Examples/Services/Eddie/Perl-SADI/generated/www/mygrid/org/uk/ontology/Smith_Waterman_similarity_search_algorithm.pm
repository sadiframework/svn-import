#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::Smith_Waterman_similarity_search_algorithm
# Generated: 12-Aug-2010 09:33:48 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::Smith_Waterman_similarity_search_algorithm;

use OWL::Data::OWL::Class;
use www::mygrid::org::uk::ontology::similarity_search_algorithm;
...
@ISA = qw(
 OWL::Data::OWL::Class
 www::mygrid::org::uk::ontology::similarity_search_algorithm 
);
use strict;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->www::mygrid::org::uk::ontology::similarity_search_algorithm::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->www::mygrid::org::uk::ontology::similarity_search_algorithm::_attr_prop( $attr_name, $prop_name ) 
            if $self->www::mygrid::org::uk::ontology::similarity_search_algorithm::_accessible($attr_name);
...
sub init {
    ...
    $self->www::mygrid::org::uk::ontology::similarity_search_algorithm::init();
    $self->type('http://www.mygrid.org.uk/ontology#Smith-Waterman_similarity_search_algorithm');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->www::mygrid::org::uk::ontology::similarity_search_algorithm::_get_statements();
    };
...
www::mygrid::org::uk::ontology::Smith_Waterman_similarity_search_algorithm - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::Smith_Waterman_similarity_search_algorithm;
  my $class = www::mygrid::org::uk::ontology::Smith_Waterman_similarity_search_algorithm->new();
...
L<www::mygrid::org::uk::ontology::similarity_search_algorithm>
