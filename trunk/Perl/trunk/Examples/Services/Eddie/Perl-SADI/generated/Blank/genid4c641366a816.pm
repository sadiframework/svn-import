...
use semanticscience::org::resource::SIO_000334;
    ...
    my %_allowed = (
        ...
        SIO_000334 => {
        	...
        	post => sub {
                ...
                my $type = @{$self->SIO_000334}[-1] if defined $self->SIO_000334;
                return unless defined $type and $type->type;
                my $range = new semanticscience::org::resource::SIO_000334->range();
                return unless $range;
...
sub _get_statements {
    ...
    if (defined $self->SIO_000334){
	    foreach (@{$self->SIO_000334}) {
	        ...
	        $self->model->addStmt(
	          new RDF::Core::Statement(
	              $subject,
	              $subject->new('http://semanticscience.org/resource/SIO_000334'), 
...
Blank::genid4c641366a816 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use Blank::genid4c641366a816;
  my $class = Blank::genid4c641366a816->new();

  # get the uri for this class
  my $uri = $class->uri;
  # add object properties 
  use semanticscience::org::resource::SIO_010044;
  # add a SIO_000334 property (semanticscience::org::resource::SIO_010044)
  $class->add_SIO_000334(new semanticscience::org::resource::SIO_010044());
  # get the SIO_000334 object properties
  my $SIO_000334_objects = $class->SIO_000334;
