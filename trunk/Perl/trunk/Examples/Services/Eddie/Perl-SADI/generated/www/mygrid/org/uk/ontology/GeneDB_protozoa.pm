#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::GeneDB_protozoa
# Generated: 12-Aug-2010 09:34:55 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::GeneDB_protozoa;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->www::mygrid::org::uk::ontology::Sanger_GeneDB::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->www::mygrid::org::uk::ontology::Sanger_GeneDB::_attr_prop( $attr_name, $prop_name ) 
            if $self->www::mygrid::org::uk::ontology::Sanger_GeneDB::_accessible($attr_name);
...
sub init {
    ...
    $self->www::mygrid::org::uk::ontology::Sanger_GeneDB::init();
    $self->type('http://www.mygrid.org.uk/ontology#GeneDB_protozoa');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->www::mygrid::org::uk::ontology::Sanger_GeneDB::_get_statements();
    };
...
www::mygrid::org::uk::ontology::GeneDB_protozoa - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::GeneDB_protozoa;
  my $class = www::mygrid::org::uk::ontology::GeneDB_protozoa->new();
...
L<www::mygrid::org::uk::ontology::Sanger_GeneDB>
