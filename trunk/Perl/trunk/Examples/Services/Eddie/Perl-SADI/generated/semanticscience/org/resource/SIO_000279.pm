#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_000279
# Generated: 12-Aug-2010 09:33:55 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_000279;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_000279');
...
semanticscience::org::resource::SIO_000279 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_000279;
  my $class = semanticscience::org::resource::SIO_000279->new();
