#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::mged_ontology
# Generated: 12-Aug-2010 09:34:59 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::mged_ontology;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#mged_ontology');
...
www::mygrid::org::uk::ontology::mged_ontology - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::mged_ontology;
  my $class = www::mygrid::org::uk::ontology::mged_ontology->new();
