...
sub init {
    ...
    $self->type('http://purl.oclc.org/SADI/LSRN/IPI_Entity');
...
purl::oclc::org::SADI::LSRN::IPI_Entity - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use purl::oclc::org::SADI::LSRN::IPI_Entity;
  my $class = purl::oclc::org::SADI::LSRN::IPI_Entity->new();
