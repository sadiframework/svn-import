#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_010448
# Generated: 12-Aug-2010 09:34:32 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_010448;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_010448');
...
semanticscience::org::resource::SIO_010448 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_010448;
  my $class = semanticscience::org::resource::SIO_010448->new();
