...
#-----------------------------------------------------------------
package Blank::genid4c641370147a;
...
Blank::genid4c641370147a - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = Blank::genid4c641370147a->new();

  # get the uri for this class
  my $uri = $class->uri;
  # add object properties 
  use www::mygrid::org::uk::ontology::DDBJ;
  # add a produced_by property (www::mygrid::org::uk::ontology::DDBJ)
  $class->add_produced_by(new www::mygrid::org::uk::ontology::DDBJ());
  ...
  # add a has_identifier property (www::mygrid::org::uk::ontology::DDBJ_accession)
  $class->add_has_identifier(new www::mygrid::org::uk::ontology::DDBJ_accession());
