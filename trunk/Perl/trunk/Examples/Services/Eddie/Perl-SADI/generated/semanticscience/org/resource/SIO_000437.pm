#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_000437
# Generated: 12-Aug-2010 09:34:15 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_000437;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->Blank::genid4c6413699a98::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->Blank::genid4c6413699a98::_attr_prop( $attr_name, $prop_name ) 
            if $self->Blank::genid4c6413699a98::_accessible($attr_name);
...
sub init {
    ...
    $self->Blank::genid4c6413699a98::init();
    $self->type('http://semanticscience.org/resource/SIO_000437');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->Blank::genid4c6413699a98::_get_statements();
    };
...
semanticscience::org::resource::SIO_000437 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_000437;
  my $class = semanticscience::org::resource::SIO_000437->new();
