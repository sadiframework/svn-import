#-----------------------------------------------------------------
# purl::oclc::org::SADI::LSRN::DragonDB_Locus_Entity
# Generated: 12-Aug-2010 09:35:11 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package purl::oclc::org::SADI::LSRN::DragonDB_Locus_Entity;
...
sub init {
    ...
    $self->type('http://purl.oclc.org/SADI/LSRN/DragonDB_Locus_Entity');
...
purl::oclc::org::SADI::LSRN::DragonDB_Locus_Entity - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use purl::oclc::org::SADI::LSRN::DragonDB_Locus_Entity;
  my $class = purl::oclc::org::SADI::LSRN::DragonDB_Locus_Entity->new();
