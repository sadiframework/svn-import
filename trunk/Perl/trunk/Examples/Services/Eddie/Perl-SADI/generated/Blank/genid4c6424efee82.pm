...
#-----------------------------------------------------------------
package Blank::genid4c6424efee82;
...
@ISA = qw(
 OWL::Data::OWL::Class
 purl::oclc::org::SADI::LSRN::Prosite_Record 
);
use strict;
...

{
    my %_allowed = (
        ...
        hasMotif => {
        	...
        	post => sub {
                ...
                my $type = @{$self->hasMotif}[-1] if defined $self->hasMotif;
                return unless defined $type and $type->type;
                my $range = new sadiframework::org::ontologies::properties::hasMotif->range();
                return unless $range;
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->purl::oclc::org::SADI::LSRN::Prosite_Record::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->purl::oclc::org::SADI::LSRN::Prosite_Record::_attr_prop( $attr_name, $prop_name ) 
            if $self->purl::oclc::org::SADI::LSRN::Prosite_Record::_accessible($attr_name);
...
sub init {
    ...
    $self->purl::oclc::org::SADI::LSRN::Prosite_Record::init();
    $self->type('_:genid4c6424efee82');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->purl::oclc::org::SADI::LSRN::Prosite_Record::_get_statements();
    };

    # for each attribute, if is array do:
    if (defined $self->hasMotif){
	    foreach (@{$self->hasMotif}) {
	        ...
	        $self->model->addStmt(
	          new RDF::Core::Statement(
	              $subject,
	              $subject->new('http://sadiframework.org/ontologies/properties.owl#hasMotif'), 
...
Blank::genid4c6424efee82 - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = Blank::genid4c6424efee82->new();

  # get the uri for this class
  my $uri = $class->uri;
  # add object properties 
  use semanticscience::org::resource::SIO_000131;
  # add a hasMotif property (semanticscience::org::resource::SIO_000131)
  $class->add_hasMotif(new semanticscience::org::resource::SIO_000131());
  # get the hasMotif object properties
  my $hasMotif_objects = $class->hasMotif;
...
L<purl::oclc::org::SADI::LSRN::Prosite_Record>
