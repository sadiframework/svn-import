#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_010014
# Generated: 12-Aug-2010 09:35:09 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_010014;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->semanticscience::org::resource::SIO_011119::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->semanticscience::org::resource::SIO_011119::_attr_prop( $attr_name, $prop_name ) 
            if $self->semanticscience::org::resource::SIO_011119::_accessible($attr_name);
...
sub init {
    ...
    $self->semanticscience::org::resource::SIO_011119::init();
    $self->type('http://semanticscience.org/resource/SIO_010014');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->semanticscience::org::resource::SIO_011119::_get_statements();
    };
...
semanticscience::org::resource::SIO_010014 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_010014;
  my $class = semanticscience::org::resource::SIO_010014->new();
...
L<semanticscience::org::resource::SIO_011119>
