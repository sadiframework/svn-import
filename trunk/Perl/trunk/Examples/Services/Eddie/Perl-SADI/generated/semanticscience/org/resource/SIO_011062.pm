#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_011062
# Generated: 12-Aug-2010 09:35:25 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_011062;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_011062');
...
semanticscience::org::resource::SIO_011062 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_011062;
  my $class = semanticscience::org::resource::SIO_011062->new();
