#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::protein_structure_database
# Generated: 12-Aug-2010 09:34:35 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::protein_structure_database;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#protein_structure_database');
...
www::mygrid::org::uk::ontology::protein_structure_database - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::protein_structure_database;
  my $class = www::mygrid::org::uk::ontology::protein_structure_database->new();
