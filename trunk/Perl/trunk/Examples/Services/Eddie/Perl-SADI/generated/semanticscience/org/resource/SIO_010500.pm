#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_010500
# Generated: 12-Aug-2010 09:34:29 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_010500;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_010500');
...
semanticscience::org::resource::SIO_010500 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_010500;
  my $class = semanticscience::org::resource::SIO_010500->new();
