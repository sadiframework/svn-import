...
sub init {
    ...
    $self->type('http://purl.oclc.org/SADI/LSRN/MetaCyc_Entity');
...
purl::oclc::org::SADI::LSRN::MetaCyc_Entity - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use purl::oclc::org::SADI::LSRN::MetaCyc_Entity;
  my $class = purl::oclc::org::SADI::LSRN::MetaCyc_Entity->new();
