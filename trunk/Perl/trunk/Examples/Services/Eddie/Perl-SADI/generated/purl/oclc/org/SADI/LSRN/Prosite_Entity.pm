...
sub init {
    ...
    $self->type('http://purl.oclc.org/SADI/LSRN/Prosite_Entity');
...
purl::oclc::org::SADI::LSRN::Prosite_Entity - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use purl::oclc::org::SADI::LSRN::Prosite_Entity;
  my $class = purl::oclc::org::SADI::LSRN::Prosite_Entity->new();
