...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->Blank::genid4c6413704e28::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->Blank::genid4c6413704e28::_attr_prop( $attr_name, $prop_name ) 
            if $self->Blank::genid4c6413704e28::_accessible($attr_name);
...
sub init {
    ...
    $self->Blank::genid4c6413704e28::init();
    $self->type('http://www.mygrid.org.uk/ontology#EMBL_record');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->Blank::genid4c6413704e28::_get_statements();
    };
...
www::mygrid::org::uk::ontology::EMBL_record - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::EMBL_record;
  my $class = www::mygrid::org::uk::ontology::EMBL_record->new();
