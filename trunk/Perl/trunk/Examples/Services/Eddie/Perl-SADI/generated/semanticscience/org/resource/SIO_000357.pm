#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_000357
# Generated: 12-Aug-2010 09:33:43 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_000357;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_000357');
...
semanticscience::org::resource::SIO_000357 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_000357;
  my $class = semanticscience::org::resource::SIO_000357->new();
