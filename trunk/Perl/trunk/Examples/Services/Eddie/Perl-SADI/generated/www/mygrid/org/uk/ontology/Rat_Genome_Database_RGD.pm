#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::Rat_Genome_Database_RGD
# Generated: 12-Aug-2010 09:34:28 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::Rat_Genome_Database_RGD;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#Rat_Genome_Database_RGD');
...
www::mygrid::org::uk::ontology::Rat_Genome_Database_RGD - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::Rat_Genome_Database_RGD;
  my $class = www::mygrid::org::uk::ontology::Rat_Genome_Database_RGD->new();
