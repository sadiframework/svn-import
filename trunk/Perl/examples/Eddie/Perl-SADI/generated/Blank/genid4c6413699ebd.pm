...
use semanticscience::org::resource::SIO_000496;
    ...
    my %_allowed = (
        ...
        SIO_000496 => {
        	...
        	post => sub {
                ...
                my $type = @{$self->SIO_000496}[-1] if defined $self->SIO_000496;
                return unless defined $type and $type->type;
                my $range = new semanticscience::org::resource::SIO_000496->range();
                return unless $range;
...
sub _get_statements {
    ...
    if (defined $self->SIO_000496){
	    foreach (@{$self->SIO_000496}) {
	        ...
	        $self->model->addStmt(
	          new RDF::Core::Statement(
	              $subject,
	              $subject->new('http://semanticscience.org/resource/SIO_000496'), 
...
Blank::genid4c6413699ebd - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use Blank::genid4c6413699ebd;
  my $class = Blank::genid4c6413699ebd->new();

  # get the uri for this class
  my $uri = $class->uri;
  # add object properties 
  use semanticscience::org::resource::SIO_000275;
  # add a SIO_000496 property (semanticscience::org::resource::SIO_000275)
  $class->add_SIO_000496(new semanticscience::org::resource::SIO_000275());
  # get the SIO_000496 object properties
  my $SIO_000496_objects = $class->SIO_000496;
