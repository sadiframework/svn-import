#-----------------------------------------------------------------
# Blank::genid4c6424fb12cd
# Generated: 12-Aug-2010 09:44:44 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package Blank::genid4c6424fb12cd;

use OWL::Data::OWL::Class;
use purl::oclc::org::SADI::LSRN::KEGG_COMPOUND_Record;
...
use semanticscience::org::resource::SIO_000253;
...

{
    my %_allowed = (
        ...
        SIO_000253 => {
        	...
        	post => sub {
                ...
                my $type = @{$self->SIO_000253}[-1] if defined $self->SIO_000253;
                return unless defined $type and $type->type;
                my $range = new semanticscience::org::resource::SIO_000253->range();
                return unless $range;
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->purl::oclc::org::SADI::LSRN::KEGG_COMPOUND_Record::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->purl::oclc::org::SADI::LSRN::KEGG_COMPOUND_Record::_attr_prop( $attr_name, $prop_name ) 
            if $self->purl::oclc::org::SADI::LSRN::KEGG_COMPOUND_Record::_accessible($attr_name);
...
sub init {
    ...
    $self->purl::oclc::org::SADI::LSRN::KEGG_COMPOUND_Record::init();
    $self->type('_:genid4c6424fb12cd');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->purl::oclc::org::SADI::LSRN::KEGG_COMPOUND_Record::_get_statements();
    };

    # for each attribute, if is array do:
    if (defined $self->SIO_000253){
	    foreach (@{$self->SIO_000253}) {
	        ...
	        $self->model->addStmt(
	          new RDF::Core::Statement(
	              $subject,
	              $subject->new('http://semanticscience.org/resource/SIO_000253'), 
...
Blank::genid4c6424fb12cd - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use Blank::genid4c6424fb12cd;
  my $class = Blank::genid4c6424fb12cd->new();

  # get the uri for this class
  my $uri = $class->uri;
  # add object properties 
  use purl::oclc::org::SADI::LSRN::CHEBI_Record;
  # add a SIO_000253 property (purl::oclc::org::SADI::LSRN::CHEBI_Record)
  $class->add_SIO_000253(new purl::oclc::org::SADI::LSRN::CHEBI_Record());
  # get the SIO_000253 object properties
  my $SIO_000253_objects = $class->SIO_000253;
...
L<purl::oclc::org::SADI::LSRN::KEGG_COMPOUND_Record>
