...
#-----------------------------------------------------------------
package Blank::genid4c64137002a3;
...
Blank::genid4c64137002a3 - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = Blank::genid4c64137002a3->new();

  # get the uri for this class
  my $uri = $class->uri;
  # add object properties 
  use www::mygrid::org::uk::ontology::Entrez_genbank_protein_accession;
  # add a has_identifier property (www::mygrid::org::uk::ontology::Entrez_genbank_protein_accession)
  $class->add_has_identifier(new www::mygrid::org::uk::ontology::Entrez_genbank_protein_accession());
  ...
  # add a produced_by property (www::mygrid::org::uk::ontology::Entrez_GenBank_protein)
  $class->add_produced_by(new www::mygrid::org::uk::ontology::Entrez_GenBank_protein());
