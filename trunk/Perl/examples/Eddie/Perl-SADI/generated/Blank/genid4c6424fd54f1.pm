...
@ISA = qw(
 OWL::Data::OWL::Class
 purl::oclc::org::SADI::LSRN::ENZYME_Record 
);
use strict;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->purl::oclc::org::SADI::LSRN::ENZYME_Record::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->purl::oclc::org::SADI::LSRN::ENZYME_Record::_attr_prop( $attr_name, $prop_name ) 
            if $self->purl::oclc::org::SADI::LSRN::ENZYME_Record::_accessible($attr_name);
...
sub init {
    ...
    $self->purl::oclc::org::SADI::LSRN::ENZYME_Record::init();
    $self->type('_:genid4c6424fd54f1');
    $self->add_fromOrganism(purl::oclc::org::SADI::LSRN::taxon_Record->new('http://lsrn.org/taxon:10090'));
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->purl::oclc::org::SADI::LSRN::ENZYME_Record::_get_statements();
    };
...
Blank::genid4c6424fd54f1 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use Blank::genid4c6424fd54f1;
  my $class = Blank::genid4c6424fd54f1->new();
...
L<purl::oclc::org::SADI::LSRN::ENZYME_Record>
...
=item 'fromOrganism' has value 'http://lsrn.org/taxon:10090', for example, (purl::oclc::org::SADI::LSRN::taxon_Record->new('http://lsrn.org/taxon:10090'));
