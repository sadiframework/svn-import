...
@ISA = qw(
 OWL::Data::OWL::Class
 semanticscience::org::resource::SIO_010340 
);
use strict;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->semanticscience::org::resource::SIO_010340::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->semanticscience::org::resource::SIO_010340::_attr_prop( $attr_name, $prop_name ) 
            if $self->semanticscience::org::resource::SIO_010340::_accessible($attr_name);
...
sub init {
    ...
    $self->semanticscience::org::resource::SIO_010340::init();
    $self->type('_:genid4c641366b9b7');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->semanticscience::org::resource::SIO_010340::_get_statements();
    };
...
Blank::genid4c641366b9b7 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use Blank::genid4c641366b9b7;
  my $class = Blank::genid4c641366b9b7->new();

  # get the uri for this class
  my $uri = $class->uri;
  # add object properties 
  use semanticscience::org::resource::SIO_010345;
  # add a SIO_000356 property (semanticscience::org::resource::SIO_010345)
  $class->add_SIO_000356(new semanticscience::org::resource::SIO_010345());
...
L<semanticscience::org::resource::SIO_010340>
