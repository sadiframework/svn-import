#-----------------------------------------------------------------
# Blank::genid4c6424fd3424
# Generated: 12-Aug-2010 09:44:48 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package Blank::genid4c6424fd3424;
...
@ISA = qw(
 OWL::Data::OWL::Class
 purl::oclc::org::SADI::LSRN::KEGG_ec_Record 
);
use strict;
...
use sadiframework::org::ontologies::properties::fromOrganism;
...

{
    my %_allowed = (
        ...
        fromOrganism => {
        	...
        	post => sub {
        		my ($self) = shift;
        		return unless $self->strict;
                my $type = @{$self->fromOrganism}[-1] if defined $self->fromOrganism;
                return unless defined $type and $type->type;
                my $range = new sadiframework::org::ontologies::properties::fromOrganism->range();
                return unless $range;
                $range = $self->uri2package($range);
                eval {
                	$range = $range->new();
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->purl::oclc::org::SADI::LSRN::KEGG_ec_Record::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->purl::oclc::org::SADI::LSRN::KEGG_ec_Record::_attr_prop( $attr_name, $prop_name ) 
            if $self->purl::oclc::org::SADI::LSRN::KEGG_ec_Record::_accessible($attr_name);
...
sub init {
    ...
    $self->purl::oclc::org::SADI::LSRN::KEGG_ec_Record::init();
    $self->type('_:genid4c6424fd3424');
    $self->add_fromOrganism(purl::oclc::org::SADI::LSRN::taxon_Record->new('http://lsrn.org/taxon:9606'));
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->purl::oclc::org::SADI::LSRN::KEGG_ec_Record::_get_statements();
    };
    ...
    # for each attribute, if is array do:
    if (defined $self->fromOrganism){
	    foreach (@{$self->fromOrganism}) {
	        # add all statements from $_
	        my $enumerator = $_->_get_statements if defined $_->_get_statements;
	        next unless defined $enumerator;
            my $statement = $enumerator->getFirst;
	        ...
	        $self->model->addStmt(
	          new RDF::Core::Statement(
	              $subject,
	              $subject->new('http://sadiframework.org/ontologies/properties.owl#fromOrganism'), 
	              (defined $_->subject ? $_->subject : RDF::Core::Resource->new($_->value))
	          )
	        );
	        $add_type_statement = 1;
...
Blank::genid4c6424fd3424 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use Blank::genid4c6424fd3424;
  my $class = Blank::genid4c6424fd3424->new();

  # get the uri for this class
  my $uri = $class->uri;
  # add object properties 
  use purl::oclc::org::SADI::LSRN::KEGG_Record;
  # add a SIO_000369 property (purl::oclc::org::SADI::LSRN::KEGG_Record)
  $class->add_SIO_000369(new purl::oclc::org::SADI::LSRN::KEGG_Record());
  ...
  $class->add_fromOrganism(new OWL::Data::OWL::Class('#someURI'));

  # get the fromOrganism object properties
  my $fromOrganism_objects = $class->fromOrganism;
...
L<purl::oclc::org::SADI::LSRN::KEGG_ec_Record>
...
=item 'fromOrganism' has value 'http://lsrn.org/taxon:9606', for example, (purl::oclc::org::SADI::LSRN::taxon_Record->new('http://lsrn.org/taxon:9606'));
