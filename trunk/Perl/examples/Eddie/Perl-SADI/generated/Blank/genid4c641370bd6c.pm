...
#-----------------------------------------------------------------
package Blank::genid4c641370bd6c;
...
Blank::genid4c641370bd6c - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = Blank::genid4c641370bd6c->new();

  # get the uri for this class
  my $uri = $class->uri;
  # add object properties 
  use www::mygrid::org::uk::ontology::OMIM;
  # add a produced_by property (www::mygrid::org::uk::ontology::OMIM)
  $class->add_produced_by(new www::mygrid::org::uk::ontology::OMIM());
  # get the produced_by object properties
  my $produced_by_objects = $class->produced_by;
  use www::mygrid::org::uk::ontology::MIM_number;
  # add a has_identifier property (www::mygrid::org::uk::ontology::MIM_number)
  $class->add_has_identifier(new www::mygrid::org::uk::ontology::MIM_number());
