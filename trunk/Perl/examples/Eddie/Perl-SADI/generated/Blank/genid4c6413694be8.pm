#-----------------------------------------------------------------
# Blank::genid4c6413694be8
# Generated: 12-Aug-2010 09:33:45 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package Blank::genid4c6413694be8;

use OWL::Data::OWL::Class;
use semanticscience::org::resource::SIO_000459;
use semanticscience::org::resource::SIO_000460;
...
@ISA = qw(
 OWL::Data::OWL::Class
 semanticscience::org::resource::SIO_000459
 semanticscience::org::resource::SIO_000460 
);
use strict;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->semanticscience::org::resource::SIO_000459::_accessible($attr)
          or $self->semanticscience::org::resource::SIO_000460::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->semanticscience::org::resource::SIO_000459::_attr_prop( $attr_name, $prop_name ) 
            if $self->semanticscience::org::resource::SIO_000459::_accessible($attr_name);
        return $self->semanticscience::org::resource::SIO_000460::_attr_prop( $attr_name, $prop_name ) 
            if $self->semanticscience::org::resource::SIO_000460::_accessible($attr_name);
...
sub init {
    ...
    $self->semanticscience::org::resource::SIO_000459::init();
    $self->semanticscience::org::resource::SIO_000460::init();
    $self->type('_:genid4c6413694be8');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->semanticscience::org::resource::SIO_000459::_get_statements();
    };
    eval {
    	# add parent statements
        $self->semanticscience::org::resource::SIO_000460::_get_statements();
    };
...
Blank::genid4c6413694be8 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use Blank::genid4c6413694be8;
  my $class = Blank::genid4c6413694be8->new();
...
L<semanticscience::org::resource::SIO_000459>
L<semanticscience::org::resource::SIO_000460>
