#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_000379
# Generated: 12-Aug-2010 09:33:47 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_000379;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_000379');
...
semanticscience::org::resource::SIO_000379 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_000379;
  my $class = semanticscience::org::resource::SIO_000379->new();
