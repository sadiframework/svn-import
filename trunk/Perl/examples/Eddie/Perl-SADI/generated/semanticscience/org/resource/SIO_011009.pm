#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_011009
# Generated: 12-Aug-2010 09:34:43 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_011009;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_011009');
...
semanticscience::org::resource::SIO_011009 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_011009;
  my $class = semanticscience::org::resource::SIO_011009->new();
