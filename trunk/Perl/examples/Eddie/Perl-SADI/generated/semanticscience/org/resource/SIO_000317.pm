#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_000317
# Generated: 12-Aug-2010 09:34:31 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_000317;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_000317');
...
semanticscience::org::resource::SIO_000317 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_000317;
  my $class = semanticscience::org::resource::SIO_000317->new();
