#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_011088
# Generated: 12-Aug-2010 09:34:06 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_011088;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_011088');
...
semanticscience::org::resource::SIO_011088 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_011088;
  my $class = semanticscience::org::resource::SIO_011088->new();
