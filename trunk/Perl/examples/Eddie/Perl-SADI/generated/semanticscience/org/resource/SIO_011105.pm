#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_011105
# Generated: 12-Aug-2010 09:35:23 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_011105;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_011105');
...
semanticscience::org::resource::SIO_011105 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_011105;
  my $class = semanticscience::org::resource::SIO_011105->new();
