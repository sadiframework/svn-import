#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_011053
# Generated: 12-Aug-2010 09:34:59 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_011053;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_011053');
...
semanticscience::org::resource::SIO_011053 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_011053;
  my $class = semanticscience::org::resource::SIO_011053->new();
