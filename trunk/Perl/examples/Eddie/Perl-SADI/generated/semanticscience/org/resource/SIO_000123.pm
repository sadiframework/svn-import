#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_000123
# Generated: 12-Aug-2010 09:34:48 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_000123;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->Blank::genid4c6413699ebd::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->Blank::genid4c6413699ebd::_attr_prop( $attr_name, $prop_name ) 
            if $self->Blank::genid4c6413699ebd::_accessible($attr_name);
...
sub init {
    ...
    $self->Blank::genid4c6413699ebd::init();
    $self->type('http://semanticscience.org/resource/SIO_000123');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->Blank::genid4c6413699ebd::_get_statements();
    };
...
semanticscience::org::resource::SIO_000123 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_000123;
  my $class = semanticscience::org::resource::SIO_000123->new();
