#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_000082
# Generated: 12-Aug-2010 09:34:16 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_000082;

use OWL::Data::OWL::Class;
use semanticscience::org::resource::SIO_000081;
...
@ISA = qw(
 OWL::Data::OWL::Class
 semanticscience::org::resource::SIO_000081 
);
use strict;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->semanticscience::org::resource::SIO_000081::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->semanticscience::org::resource::SIO_000081::_attr_prop( $attr_name, $prop_name ) 
            if $self->semanticscience::org::resource::SIO_000081::_accessible($attr_name);
...
sub init {
    ...
    $self->semanticscience::org::resource::SIO_000081::init();
    $self->type('http://semanticscience.org/resource/SIO_000082');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->semanticscience::org::resource::SIO_000081::_get_statements();
    };
...
semanticscience::org::resource::SIO_000082 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_000082;
  my $class = semanticscience::org::resource::SIO_000082->new();
...
L<semanticscience::org::resource::SIO_000081>
