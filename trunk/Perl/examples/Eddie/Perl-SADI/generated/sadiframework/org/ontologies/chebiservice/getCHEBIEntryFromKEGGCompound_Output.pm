...
#-----------------------------------------------------------------
package sadiframework::org::ontologies::chebiservice::getCHEBIEntryFromKEGGCompound_Output;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->Blank::genid4c6424fb12cd::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->Blank::genid4c6424fb12cd::_attr_prop( $attr_name, $prop_name ) 
            if $self->Blank::genid4c6424fb12cd::_accessible($attr_name);
...
sub init {
    ...
    $self->Blank::genid4c6424fb12cd::init();
    $self->type('http://sadiframework.org/ontologies/chebiservice.owl#getCHEBIEntryFromKEGGCompound_Output');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->Blank::genid4c6424fb12cd::_get_statements();
    };
...
sadiframework::org::ontologies::chebiservice::getCHEBIEntryFromKEGGCompound_Output - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = sadiframework::org::ontologies::chebiservice::getCHEBIEntryFromKEGGCompound_Output->new();
