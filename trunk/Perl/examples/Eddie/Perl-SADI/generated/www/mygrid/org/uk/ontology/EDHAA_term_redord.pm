#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::EDHAA_term_redord
# Generated: 12-Aug-2010 09:34:36 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::EDHAA_term_redord;

use OWL::Data::OWL::Class;
use www::mygrid::org::uk::ontology::human_anatomy_term_record;
use Blank::genid4c641370ce31;
...
@ISA = qw(
 OWL::Data::OWL::Class
 www::mygrid::org::uk::ontology::human_anatomy_term_record
 Blank::genid4c641370ce31 
);
use strict;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->www::mygrid::org::uk::ontology::human_anatomy_term_record::_accessible($attr)
          or $self->Blank::genid4c641370ce31::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->www::mygrid::org::uk::ontology::human_anatomy_term_record::_attr_prop( $attr_name, $prop_name ) 
            if $self->www::mygrid::org::uk::ontology::human_anatomy_term_record::_accessible($attr_name);
        return $self->Blank::genid4c641370ce31::_attr_prop( $attr_name, $prop_name ) 
            if $self->Blank::genid4c641370ce31::_accessible($attr_name);
...
sub init {
    ...
    $self->www::mygrid::org::uk::ontology::human_anatomy_term_record::init();
    $self->Blank::genid4c641370ce31::init();
    $self->type('http://www.mygrid.org.uk/ontology#EDHAA_term_redord');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->www::mygrid::org::uk::ontology::human_anatomy_term_record::_get_statements();
    };
    eval {
    	# add parent statements
        $self->Blank::genid4c641370ce31::_get_statements();
    };
...
www::mygrid::org::uk::ontology::EDHAA_term_redord - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::EDHAA_term_redord;
  my $class = www::mygrid::org::uk::ontology::EDHAA_term_redord->new();
...
L<www::mygrid::org::uk::ontology::human_anatomy_term_record>
L<Blank::genid4c641370ce31>
