#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::UniProt_record
# Generated: 12-Aug-2010 09:34:10 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::UniProt_record;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->Blank::genid4c6413719f65::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->Blank::genid4c6413719f65::_attr_prop( $attr_name, $prop_name ) 
            if $self->Blank::genid4c6413719f65::_accessible($attr_name);
...
sub init {
    ...
    $self->Blank::genid4c6413719f65::init();
    $self->type('http://www.mygrid.org.uk/ontology#UniProt_record');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->Blank::genid4c6413719f65::_get_statements();
    };
...
www::mygrid::org::uk::ontology::UniProt_record - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::UniProt_record;
  my $class = www::mygrid::org::uk::ontology::UniProt_record->new();
