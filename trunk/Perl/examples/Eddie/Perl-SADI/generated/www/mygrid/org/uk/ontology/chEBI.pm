#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::chEBI
# Generated: 12-Aug-2010 09:33:44 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::chEBI;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->www::mygrid::org::uk::ontology::proteomics_database::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->www::mygrid::org::uk::ontology::proteomics_database::_attr_prop( $attr_name, $prop_name ) 
            if $self->www::mygrid::org::uk::ontology::proteomics_database::_accessible($attr_name);
...
sub init {
    ...
    $self->www::mygrid::org::uk::ontology::proteomics_database::init();
    $self->type('http://www.mygrid.org.uk/ontology#chEBI');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->www::mygrid::org::uk::ontology::proteomics_database::_get_statements();
    };
...
www::mygrid::org::uk::ontology::chEBI - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::chEBI;
  my $class = www::mygrid::org::uk::ontology::chEBI->new();
...
L<www::mygrid::org::uk::ontology::proteomics_database>
