#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::biological_sequence_id
# Generated: 12-Aug-2010 09:33:29 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::biological_sequence_id;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#biological_sequence_id');
...
www::mygrid::org::uk::ontology::biological_sequence_id - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = www::mygrid::org::uk::ontology::biological_sequence_id->new();
