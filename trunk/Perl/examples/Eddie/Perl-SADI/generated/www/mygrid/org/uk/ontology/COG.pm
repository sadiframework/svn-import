...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#COG');
...
www::mygrid::org::uk::ontology::COG - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::COG;
  my $class = www::mygrid::org::uk::ontology::COG->new();
