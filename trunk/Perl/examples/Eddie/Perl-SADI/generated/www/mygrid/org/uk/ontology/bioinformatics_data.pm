...
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::bioinformatics_data;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#bioinformatics_data');
...
www::mygrid::org::uk::ontology::bioinformatics_data - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = www::mygrid::org::uk::ontology::bioinformatics_data->new();
