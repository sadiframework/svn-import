...
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::protein_structure_record;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#protein_structure_record');
...
www::mygrid::org::uk::ontology::protein_structure_record - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = www::mygrid::org::uk::ontology::protein_structure_record->new();
