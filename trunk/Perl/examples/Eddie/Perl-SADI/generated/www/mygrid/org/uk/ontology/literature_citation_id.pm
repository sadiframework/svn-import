#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::literature_citation_id
# Generated: 12-Aug-2010 09:34:30 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::literature_citation_id;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#literature_citation_id');
...
www::mygrid::org::uk::ontology::literature_citation_id - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::literature_citation_id;
  my $class = www::mygrid::org::uk::ontology::literature_citation_id->new();
