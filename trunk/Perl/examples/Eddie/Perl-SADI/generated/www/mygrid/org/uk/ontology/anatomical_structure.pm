#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::anatomical_structure
# Generated: 12-Aug-2010 09:35:16 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::anatomical_structure;

use OWL::Data::OWL::Class;
use www::mygrid::org::uk::ontology::biological_structure;
...
@ISA = qw(
 OWL::Data::OWL::Class
 www::mygrid::org::uk::ontology::biological_structure 
);
use strict;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->www::mygrid::org::uk::ontology::biological_structure::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->www::mygrid::org::uk::ontology::biological_structure::_attr_prop( $attr_name, $prop_name ) 
            if $self->www::mygrid::org::uk::ontology::biological_structure::_accessible($attr_name);
...
sub init {
    ...
    $self->www::mygrid::org::uk::ontology::biological_structure::init();
    $self->type('http://www.mygrid.org.uk/ontology#anatomical_structure');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->www::mygrid::org::uk::ontology::biological_structure::_get_statements();
    };
...
www::mygrid::org::uk::ontology::anatomical_structure - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::anatomical_structure;
  my $class = www::mygrid::org::uk::ontology::anatomical_structure->new();
...
L<www::mygrid::org::uk::ontology::biological_structure>
