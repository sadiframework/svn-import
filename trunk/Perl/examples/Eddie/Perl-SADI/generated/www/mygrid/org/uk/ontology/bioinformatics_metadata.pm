...
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::bioinformatics_metadata;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#bioinformatics_metadata');
...
www::mygrid::org::uk::ontology::bioinformatics_metadata - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = www::mygrid::org::uk::ontology::bioinformatics_metadata->new();
