...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#PIRSF');
...
www::mygrid::org::uk::ontology::PIRSF - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::PIRSF;
  my $class = www::mygrid::org::uk::ontology::PIRSF->new();
