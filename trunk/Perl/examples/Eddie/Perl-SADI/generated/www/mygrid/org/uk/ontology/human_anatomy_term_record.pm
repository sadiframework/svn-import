...
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::human_anatomy_term_record;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#human_anatomy_term_record');
...
www::mygrid::org::uk::ontology::human_anatomy_term_record - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = www::mygrid::org::uk::ontology::human_anatomy_term_record->new();
