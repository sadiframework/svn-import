...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#tree_fam');
...
www::mygrid::org::uk::ontology::tree_fam - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::tree_fam;
  my $class = www::mygrid::org::uk::ontology::tree_fam->new();
