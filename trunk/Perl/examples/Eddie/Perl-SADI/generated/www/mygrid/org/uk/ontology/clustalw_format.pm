#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::clustalw_format
# Generated: 12-Aug-2010 09:34:40 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::clustalw_format;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#clustalw_format');
...
www::mygrid::org::uk::ontology::clustalw_format - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::clustalw_format;
  my $class = www::mygrid::org::uk::ontology::clustalw_format->new();
