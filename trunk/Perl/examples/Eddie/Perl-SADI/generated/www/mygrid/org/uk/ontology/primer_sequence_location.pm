#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::primer_sequence_location
# Generated: 12-Aug-2010 09:34:17 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::primer_sequence_location;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#primer_sequence_location');
...
www::mygrid::org::uk::ontology::primer_sequence_location - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::primer_sequence_location;
  my $class = www::mygrid::org::uk::ontology::primer_sequence_location->new();
