...
sub init {
    ...
    $self->uri('http://www.mygrid.org.uk/ontology#has_part');
}
...
www::mygrid::org::uk::ontology::has_part - an object propery

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::has_part;
  my $property = www::mygrid::org::uk::ontology::has_part->new();
