#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::protein_structure
# Generated: 12-Aug-2010 09:33:51 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::protein_structure;

use OWL::Data::OWL::Class;
use www::mygrid::org::uk::ontology::molecular_structure;
...
@ISA = qw(
 OWL::Data::OWL::Class
 www::mygrid::org::uk::ontology::molecular_structure 
);
use strict;
...

{
    my %_allowed = (
        ...
        is_part_of => {
        	...
        	post => sub {
                ...
                my $type = @{$self->is_part_of}[-1] if defined $self->is_part_of;
                return unless defined $type and $type->type;
                my $range = new www::mygrid::org::uk::ontology::is_part_of->range();
                return unless $range;
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->www::mygrid::org::uk::ontology::molecular_structure::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->www::mygrid::org::uk::ontology::molecular_structure::_attr_prop( $attr_name, $prop_name ) 
            if $self->www::mygrid::org::uk::ontology::molecular_structure::_accessible($attr_name);
...
sub init {
    ...
    $self->www::mygrid::org::uk::ontology::molecular_structure::init();
    $self->type('http://www.mygrid.org.uk/ontology#protein_structure');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->www::mygrid::org::uk::ontology::molecular_structure::_get_statements();
    };

    # for each attribute, if is array do:
    if (defined $self->is_part_of){
	    foreach (@{$self->is_part_of}) {
	        ...
	        $self->model->addStmt(
	          new RDF::Core::Statement(
	              $subject,
	              $subject->new('http://www.mygrid.org.uk/ontology#is_part_of'), 
...
www::mygrid::org::uk::ontology::protein_structure - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::protein_structure;
  my $class = www::mygrid::org::uk::ontology::protein_structure->new();
  ...
  $class->add_is_part_of(new OWL::Data::OWL::Class('#someURI'));

  # get the is_part_of object properties
  my $is_part_of_objects = $class->is_part_of;
...
L<www::mygrid::org::uk::ontology::molecular_structure>
