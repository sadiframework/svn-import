...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->www::mygrid::org::uk::ontology::pathway_resource::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->www::mygrid::org::uk::ontology::pathway_resource::_attr_prop( $attr_name, $prop_name ) 
            if $self->www::mygrid::org::uk::ontology::pathway_resource::_accessible($attr_name);
...
sub init {
    ...
    $self->www::mygrid::org::uk::ontology::pathway_resource::init();
    $self->type('http://www.mygrid.org.uk/ontology#Reactome');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->www::mygrid::org::uk::ontology::pathway_resource::_get_statements();
    };
...
www::mygrid::org::uk::ontology::Reactome - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::Reactome;
  my $class = www::mygrid::org::uk::ontology::Reactome->new();
...
L<www::mygrid::org::uk::ontology::pathway_resource>
