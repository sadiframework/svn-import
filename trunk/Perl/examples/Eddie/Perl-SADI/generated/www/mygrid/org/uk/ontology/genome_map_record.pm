...
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::genome_map_record;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#genome_map_record');
...
www::mygrid::org::uk::ontology::genome_map_record - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = www::mygrid::org::uk::ontology::genome_map_record->new();
