#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::ArrayExpress
# Generated: 12-Aug-2010 09:35:07 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::ArrayExpress;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->www::mygrid::org::uk::ontology::microarray_database::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->www::mygrid::org::uk::ontology::microarray_database::_attr_prop( $attr_name, $prop_name ) 
            if $self->www::mygrid::org::uk::ontology::microarray_database::_accessible($attr_name);
...
sub init {
    ...
    $self->www::mygrid::org::uk::ontology::microarray_database::init();
    $self->type('http://www.mygrid.org.uk/ontology#ArrayExpress');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->www::mygrid::org::uk::ontology::microarray_database::_get_statements();
    };
...
www::mygrid::org::uk::ontology::ArrayExpress - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::ArrayExpress;
  my $class = www::mygrid::org::uk::ontology::ArrayExpress->new();
...
L<www::mygrid::org::uk::ontology::microarray_database>
