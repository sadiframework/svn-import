#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::Panther_report
# Generated: 12-Aug-2010 09:34:30 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::Panther_report;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#Panther_report');
...
www::mygrid::org::uk::ontology::Panther_report - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::Panther_report;
  my $class = www::mygrid::org::uk::ontology::Panther_report->new();
