#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::nucleotide_sequence
# Generated: 12-Aug-2010 09:34:13 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::nucleotide_sequence;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->www::mygrid::org::uk::ontology::biological_sequence::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->www::mygrid::org::uk::ontology::biological_sequence::_attr_prop( $attr_name, $prop_name ) 
            if $self->www::mygrid::org::uk::ontology::biological_sequence::_accessible($attr_name);
...
sub init {
    ...
    $self->www::mygrid::org::uk::ontology::biological_sequence::init();
    $self->type('http://www.mygrid.org.uk/ontology#nucleotide_sequence');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->www::mygrid::org::uk::ontology::biological_sequence::_get_statements();
    };
...
www::mygrid::org::uk::ontology::nucleotide_sequence - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::nucleotide_sequence;
  my $class = www::mygrid::org::uk::ontology::nucleotide_sequence->new();
...
L<www::mygrid::org::uk::ontology::biological_sequence>
