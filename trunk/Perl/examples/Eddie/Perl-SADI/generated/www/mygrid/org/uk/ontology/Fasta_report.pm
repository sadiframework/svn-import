#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::Fasta_report
# Generated: 12-Aug-2010 09:34:21 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::Fasta_report;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#Fasta_report');
...
www::mygrid::org::uk::ontology::Fasta_report - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::Fasta_report;
  my $class = www::mygrid::org::uk::ontology::Fasta_report->new();
