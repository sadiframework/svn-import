...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#OMIM');
...
www::mygrid::org::uk::ontology::OMIM - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::OMIM;
  my $class = www::mygrid::org::uk::ontology::OMIM->new();
