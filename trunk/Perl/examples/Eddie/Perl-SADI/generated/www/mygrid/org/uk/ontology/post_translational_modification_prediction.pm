#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::post_translational_modification_prediction
# Generated: 12-Aug-2010 09:34:15 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::post_translational_modification_prediction;

use OWL::Data::OWL::Class;
use www::mygrid::org::uk::ontology::bioinformatics_algorithm;
...
@ISA = qw(
 OWL::Data::OWL::Class
 www::mygrid::org::uk::ontology::bioinformatics_algorithm 
);
use strict;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->www::mygrid::org::uk::ontology::bioinformatics_algorithm::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->www::mygrid::org::uk::ontology::bioinformatics_algorithm::_attr_prop( $attr_name, $prop_name ) 
            if $self->www::mygrid::org::uk::ontology::bioinformatics_algorithm::_accessible($attr_name);
...
sub init {
    ...
    $self->www::mygrid::org::uk::ontology::bioinformatics_algorithm::init();
    $self->type('http://www.mygrid.org.uk/ontology#post-translational_modification_prediction');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->www::mygrid::org::uk::ontology::bioinformatics_algorithm::_get_statements();
    };
...
www::mygrid::org::uk::ontology::post_translational_modification_prediction - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::post_translational_modification_prediction;
  my $class = www::mygrid::org::uk::ontology::post_translational_modification_prediction->new();
...
L<www::mygrid::org::uk::ontology::bioinformatics_algorithm>
