...
sub init {
    ...
    $self->type('http://purl.oclc.org/SADI/LSRN/PRINTS_Record');
...
purl::oclc::org::SADI::LSRN::PRINTS_Record - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use purl::oclc::org::SADI::LSRN::PRINTS_Record;
  my $class = purl::oclc::org::SADI::LSRN::PRINTS_Record->new();
