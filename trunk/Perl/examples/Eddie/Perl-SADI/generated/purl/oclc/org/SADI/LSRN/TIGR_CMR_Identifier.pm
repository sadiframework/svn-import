#-----------------------------------------------------------------
# purl::oclc::org::SADI::LSRN::TIGR_CMR_Identifier
# Generated: 12-Aug-2010 09:34:13 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package purl::oclc::org::SADI::LSRN::TIGR_CMR_Identifier;
...
sub init {
    ...
    $self->type('http://purl.oclc.org/SADI/LSRN/TIGR_CMR_Identifier');
...
purl::oclc::org::SADI::LSRN::TIGR_CMR_Identifier - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use purl::oclc::org::SADI::LSRN::TIGR_CMR_Identifier;
  my $class = purl::oclc::org::SADI::LSRN::TIGR_CMR_Identifier->new();
