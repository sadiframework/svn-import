...
#-----------------------------------------------------------------
package purl::oclc::org::SADI::LSRN::LSRN_Entity;
...
sub init {
    ...
    $self->type('http://purl.oclc.org/SADI/LSRN/LSRN_Entity');
...
purl::oclc::org::SADI::LSRN::LSRN_Entity - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = purl::oclc::org::SADI::LSRN::LSRN_Entity->new();
