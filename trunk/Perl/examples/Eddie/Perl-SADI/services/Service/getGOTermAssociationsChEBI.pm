#-----------------------------------------------------------------
# Service name: getGOTermAssociationsChEBI
#    An asynchronous service
# Authority:    illuminae.com
# Created:      19-Aug-2010 13:07:15 PDT
# Contact:      myaddress@organization.org
# Description:  
#               fetches ChEBI entities annotated with a given GO term
#-----------------------------------------------------------------

package Service::getGOTermAssociationsChEBI;
...
sub process_it {
    ...
    foreach my $input (@inputs) {
        ...
        use Implementations;
        my $class = Implementations::getGOTermAssociationsX($input, $id, $LOG, 'chebi');
...
Service::getGOTermAssociationsChEBI - a SADI service
