  ...
  <body>
    <div id='outer-frame'>
      <div id='inner-frame'>
        ...
        <div id='nav'>
          <ul>
            <li class="page_item current_page_item"><a href=".">Register</a></li>
            <li class="page_item current_page_item"><a href="services.jsp">Services</a></li>
            <li class="page_item"><a href="sparql.jsp">SPARQL</a></li>
          </ul>
        </div>
        <div id='content'>
      ...
      <div id='registration-form'>
        <form method='POST' action='.'>
          ...
          <input id='url-input' type='text' name='url'<c:if test='${error != null}'>value='${registered.serviceURI}</c:if>'>
