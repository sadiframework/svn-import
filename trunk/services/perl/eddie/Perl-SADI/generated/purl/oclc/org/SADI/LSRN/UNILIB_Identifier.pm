#-----------------------------------------------------------------
# purl::oclc::org::SADI::LSRN::UNILIB_Identifier
# Generated: 12-Aug-2010 09:34:29 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package purl::oclc::org::SADI::LSRN::UNILIB_Identifier;
...
sub init {
    ...
    $self->type('http://purl.oclc.org/SADI/LSRN/UNILIB_Identifier');
...
purl::oclc::org::SADI::LSRN::UNILIB_Identifier - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use purl::oclc::org::SADI::LSRN::UNILIB_Identifier;
  my $class = purl::oclc::org::SADI::LSRN::UNILIB_Identifier->new();
