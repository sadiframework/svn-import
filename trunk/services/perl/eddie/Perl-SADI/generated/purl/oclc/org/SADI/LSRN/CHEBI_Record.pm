...
sub init {
    ...
    $self->type('http://purl.oclc.org/SADI/LSRN/CHEBI_Record');
...
purl::oclc::org::SADI::LSRN::CHEBI_Record - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = purl::oclc::org::SADI::LSRN::CHEBI_Record->new();
