#-----------------------------------------------------------------
# purl::oclc::org::SADI::LSRN::MEDLINE_Identifier
# Generated: 12-Aug-2010 09:34:19 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package purl::oclc::org::SADI::LSRN::MEDLINE_Identifier;
...
sub init {
    ...
    $self->type('http://purl.oclc.org/SADI/LSRN/MEDLINE_Identifier');
...
purl::oclc::org::SADI::LSRN::MEDLINE_Identifier - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use purl::oclc::org::SADI::LSRN::MEDLINE_Identifier;
  my $class = purl::oclc::org::SADI::LSRN::MEDLINE_Identifier->new();
