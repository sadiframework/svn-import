...
sub init {
    ...
    $self->type('http://purl.oclc.org/SADI/LSRN/NextDB_Entity');
...
purl::oclc::org::SADI::LSRN::NextDB_Entity - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use purl::oclc::org::SADI::LSRN::NextDB_Entity;
  my $class = purl::oclc::org::SADI::LSRN::NextDB_Entity->new();
