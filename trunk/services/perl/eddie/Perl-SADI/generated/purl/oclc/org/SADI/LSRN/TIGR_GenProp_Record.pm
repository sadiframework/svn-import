#-----------------------------------------------------------------
# purl::oclc::org::SADI::LSRN::TIGR_GenProp_Record
# Generated: 12-Aug-2010 09:35:09 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package purl::oclc::org::SADI::LSRN::TIGR_GenProp_Record;
...
sub init {
    ...
    $self->type('http://purl.oclc.org/SADI/LSRN/TIGR_GenProp_Record');
...
purl::oclc::org::SADI::LSRN::TIGR_GenProp_Record - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use purl::oclc::org::SADI::LSRN::TIGR_GenProp_Record;
  my $class = purl::oclc::org::SADI::LSRN::TIGR_GenProp_Record->new();
