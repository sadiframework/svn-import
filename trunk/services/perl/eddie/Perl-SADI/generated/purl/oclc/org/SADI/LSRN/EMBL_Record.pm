...
sub init {
    ...
    $self->type('http://purl.oclc.org/SADI/LSRN/EMBL_Record');
...
purl::oclc::org::SADI::LSRN::EMBL_Record - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use purl::oclc::org::SADI::LSRN::EMBL_Record;
  my $class = purl::oclc::org::SADI::LSRN::EMBL_Record->new();
