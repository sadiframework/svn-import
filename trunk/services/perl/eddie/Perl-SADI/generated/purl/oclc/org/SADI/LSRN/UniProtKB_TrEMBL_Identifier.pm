#-----------------------------------------------------------------
# purl::oclc::org::SADI::LSRN::UniProtKB_TrEMBL_Identifier
# Generated: 12-Aug-2010 09:35:24 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package purl::oclc::org::SADI::LSRN::UniProtKB_TrEMBL_Identifier;
...
sub init {
    ...
    $self->type('http://purl.oclc.org/SADI/LSRN/UniProtKB_TrEMBL_Identifier');
...
purl::oclc::org::SADI::LSRN::UniProtKB_TrEMBL_Identifier - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use purl::oclc::org::SADI::LSRN::UniProtKB_TrEMBL_Identifier;
  my $class = purl::oclc::org::SADI::LSRN::UniProtKB_TrEMBL_Identifier->new();
