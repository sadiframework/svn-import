#-----------------------------------------------------------------
# purl::oclc::org::SADI::LSRN::GR_REF_Identifier
# Generated: 12-Aug-2010 09:34:37 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package purl::oclc::org::SADI::LSRN::GR_REF_Identifier;
...
sub init {
    ...
    $self->type('http://purl.oclc.org/SADI/LSRN/GR_REF_Identifier');
...
purl::oclc::org::SADI::LSRN::GR_REF_Identifier - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use purl::oclc::org::SADI::LSRN::GR_REF_Identifier;
  my $class = purl::oclc::org::SADI::LSRN::GR_REF_Identifier->new();
