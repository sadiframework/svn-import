...
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::nucleotide_sequence_feature_report;

use OWL::Data::OWL::Class;
use www::mygrid::org::uk::ontology::sequence_feature_report;
...
@ISA = qw(
 OWL::Data::OWL::Class
 www::mygrid::org::uk::ontology::sequence_feature_report 
);
use strict;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->www::mygrid::org::uk::ontology::sequence_feature_report::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->www::mygrid::org::uk::ontology::sequence_feature_report::_attr_prop( $attr_name, $prop_name ) 
            if $self->www::mygrid::org::uk::ontology::sequence_feature_report::_accessible($attr_name);
...
sub init {
    ...
    $self->www::mygrid::org::uk::ontology::sequence_feature_report::init();
    $self->type('http://www.mygrid.org.uk/ontology#nucleotide_sequence_feature_report');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->www::mygrid::org::uk::ontology::sequence_feature_report::_get_statements();
    };
...
www::mygrid::org::uk::ontology::nucleotide_sequence_feature_report - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = www::mygrid::org::uk::ontology::nucleotide_sequence_feature_report->new();
...
L<www::mygrid::org::uk::ontology::sequence_feature_report>
