#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::Maize_genetics_and_genomics_database_MaizeGDB
# Generated: 12-Aug-2010 09:34:44 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::Maize_genetics_and_genomics_database_MaizeGDB;

use OWL::Data::OWL::Class;
use www::mygrid::org::uk::ontology::model_organism_genome_database;
...
@ISA = qw(
 OWL::Data::OWL::Class
 www::mygrid::org::uk::ontology::model_organism_genome_database 
);
use strict;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->www::mygrid::org::uk::ontology::model_organism_genome_database::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->www::mygrid::org::uk::ontology::model_organism_genome_database::_attr_prop( $attr_name, $prop_name ) 
            if $self->www::mygrid::org::uk::ontology::model_organism_genome_database::_accessible($attr_name);
...
sub init {
    ...
    $self->www::mygrid::org::uk::ontology::model_organism_genome_database::init();
    $self->type('http://www.mygrid.org.uk/ontology#Maize_genetics_and_genomics_database_MaizeGDB');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->www::mygrid::org::uk::ontology::model_organism_genome_database::_get_statements();
    };
...
www::mygrid::org::uk::ontology::Maize_genetics_and_genomics_database_MaizeGDB - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::Maize_genetics_and_genomics_database_MaizeGDB;
  my $class = www::mygrid::org::uk::ontology::Maize_genetics_and_genomics_database_MaizeGDB->new();
...
L<www::mygrid::org::uk::ontology::model_organism_genome_database>
