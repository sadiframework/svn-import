#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::manipulating
# Generated: 12-Aug-2010 09:33:36 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::manipulating;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#manipulating');
...
www::mygrid::org::uk::ontology::manipulating - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::manipulating;
  my $class = www::mygrid::org::uk::ontology::manipulating->new();
