#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::prosite_report
# Generated: 12-Aug-2010 09:33:38 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::prosite_report;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#prosite_report');
...
www::mygrid::org::uk::ontology::prosite_report - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::prosite_report;
  my $class = www::mygrid::org::uk::ontology::prosite_report->new();
