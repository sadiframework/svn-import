...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#Gene3D_code');
...
www::mygrid::org::uk::ontology::Gene3D_code - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::Gene3D_code;
  my $class = www::mygrid::org::uk::ontology::Gene3D_code->new();
