...
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::protein_interaction_id;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#protein_interaction_id');
...
www::mygrid::org::uk::ontology::protein_interaction_id - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = www::mygrid::org::uk::ontology::protein_interaction_id->new();
