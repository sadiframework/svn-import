#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::expressed_sequence_tag
# Generated: 12-Aug-2010 09:34:15 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::expressed_sequence_tag;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#expressed_sequence_tag');
...
www::mygrid::org::uk::ontology::expressed_sequence_tag - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::expressed_sequence_tag;
  my $class = www::mygrid::org::uk::ontology::expressed_sequence_tag->new();
