...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#DragonDB');
...
www::mygrid::org::uk::ontology::DragonDB - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::DragonDB;
  my $class = www::mygrid::org::uk::ontology::DragonDB->new();
