#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::InterPro_match_report
# Generated: 12-Aug-2010 09:33:26 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::InterPro_match_report;

use OWL::Data::OWL::Class;
use www::mygrid::org::uk::ontology::domain_motif_report;
...
@ISA = qw(
 OWL::Data::OWL::Class
 www::mygrid::org::uk::ontology::domain_motif_report 
);
use strict;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->www::mygrid::org::uk::ontology::domain_motif_report::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->www::mygrid::org::uk::ontology::domain_motif_report::_attr_prop( $attr_name, $prop_name ) 
            if $self->www::mygrid::org::uk::ontology::domain_motif_report::_accessible($attr_name);
...
sub init {
    ...
    $self->www::mygrid::org::uk::ontology::domain_motif_report::init();
    $self->type('http://www.mygrid.org.uk/ontology#InterPro_match_report');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->www::mygrid::org::uk::ontology::domain_motif_report::_get_statements();
    };
...
www::mygrid::org::uk::ontology::InterPro_match_report - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::InterPro_match_report;
  my $class = www::mygrid::org::uk::ontology::InterPro_match_report->new();
...
L<www::mygrid::org::uk::ontology::domain_motif_report>
