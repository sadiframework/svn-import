#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::SWISS_PROT_accession
# Generated: 12-Aug-2010 09:34:39 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::SWISS_PROT_accession;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#SWISS-PROT_accession');
...
www::mygrid::org::uk::ontology::SWISS_PROT_accession - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::SWISS_PROT_accession;
  my $class = www::mygrid::org::uk::ontology::SWISS_PROT_accession->new();
