...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#SCOP');
...
www::mygrid::org::uk::ontology::SCOP - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::SCOP;
  my $class = www::mygrid::org::uk::ontology::SCOP->new();
