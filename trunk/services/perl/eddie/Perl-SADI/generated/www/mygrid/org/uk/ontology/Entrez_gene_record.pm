#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::Entrez_gene_record
# Generated: 12-Aug-2010 09:35:30 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::Entrez_gene_record;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#Entrez_gene_record');
...
www::mygrid::org::uk::ontology::Entrez_gene_record - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::Entrez_gene_record;
  my $class = www::mygrid::org::uk::ontology::Entrez_gene_record->new();
