#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::alignment_quality_graph
# Generated: 12-Aug-2010 09:33:32 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::alignment_quality_graph;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#alignment_quality_graph');
...
www::mygrid::org::uk::ontology::alignment_quality_graph - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::alignment_quality_graph;
  my $class = www::mygrid::org::uk::ontology::alignment_quality_graph->new();
