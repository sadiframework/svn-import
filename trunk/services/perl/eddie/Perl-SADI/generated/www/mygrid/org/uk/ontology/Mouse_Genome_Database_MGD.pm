#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::Mouse_Genome_Database_MGD
# Generated: 12-Aug-2010 09:33:38 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::Mouse_Genome_Database_MGD;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#Mouse_Genome_Database_MGD');
...
www::mygrid::org::uk::ontology::Mouse_Genome_Database_MGD - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::Mouse_Genome_Database_MGD;
  my $class = www::mygrid::org::uk::ontology::Mouse_Genome_Database_MGD->new();
