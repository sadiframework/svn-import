#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::kegg_drug_database
# Generated: 12-Aug-2010 09:34:31 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::kegg_drug_database;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#kegg_drug_database');
...
www::mygrid::org::uk::ontology::kegg_drug_database - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::kegg_drug_database;
  my $class = www::mygrid::org::uk::ontology::kegg_drug_database->new();
