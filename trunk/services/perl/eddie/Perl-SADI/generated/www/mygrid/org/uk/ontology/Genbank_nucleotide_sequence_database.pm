#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::Genbank_nucleotide_sequence_database
# Generated: 12-Aug-2010 09:34:18 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::Genbank_nucleotide_sequence_database;

use OWL::Data::OWL::Class;
use www::mygrid::org::uk::ontology::nucleotide_sequence_database;
...
@ISA = qw(
 OWL::Data::OWL::Class
 www::mygrid::org::uk::ontology::nucleotide_sequence_database 
);
use strict;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->www::mygrid::org::uk::ontology::nucleotide_sequence_database::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->www::mygrid::org::uk::ontology::nucleotide_sequence_database::_attr_prop( $attr_name, $prop_name ) 
            if $self->www::mygrid::org::uk::ontology::nucleotide_sequence_database::_accessible($attr_name);
...
sub init {
    ...
    $self->www::mygrid::org::uk::ontology::nucleotide_sequence_database::init();
    $self->type('http://www.mygrid.org.uk/ontology#Genbank_nucleotide_sequence_database');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->www::mygrid::org::uk::ontology::nucleotide_sequence_database::_get_statements();
    };
...
www::mygrid::org::uk::ontology::Genbank_nucleotide_sequence_database - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::Genbank_nucleotide_sequence_database;
  my $class = www::mygrid::org::uk::ontology::Genbank_nucleotide_sequence_database->new();
...
L<www::mygrid::org::uk::ontology::nucleotide_sequence_database>
