#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::Sanger_GeneDB
# Generated: 12-Aug-2010 09:34:51 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::Sanger_GeneDB;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#Sanger_GeneDB');
...
www::mygrid::org::uk::ontology::Sanger_GeneDB - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::Sanger_GeneDB;
  my $class = www::mygrid::org::uk::ontology::Sanger_GeneDB->new();
