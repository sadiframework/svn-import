#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::protein_composition
# Generated: 12-Aug-2010 09:35:24 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::protein_composition;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#protein_composition');
...
www::mygrid::org::uk::ontology::protein_composition - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::protein_composition;
  my $class = www::mygrid::org::uk::ontology::protein_composition->new();
