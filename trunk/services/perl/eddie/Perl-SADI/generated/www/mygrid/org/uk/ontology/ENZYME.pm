...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#ENZYME');
...
www::mygrid::org::uk::ontology::ENZYME - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = www::mygrid::org::uk::ontology::ENZYME->new();
