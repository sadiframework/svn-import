#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::topology_prediction
# Generated: 12-Aug-2010 09:34:16 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::topology_prediction;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#topology_prediction');
...
www::mygrid::org::uk::ontology::topology_prediction - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::topology_prediction;
  my $class = www::mygrid::org::uk::ontology::topology_prediction->new();
