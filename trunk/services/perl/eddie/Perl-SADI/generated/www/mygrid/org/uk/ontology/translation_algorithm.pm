#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::translation_algorithm
# Generated: 12-Aug-2010 09:35:09 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::translation_algorithm;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#translation_algorithm');
...
www::mygrid::org::uk::ontology::translation_algorithm - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::translation_algorithm;
  my $class = www::mygrid::org::uk::ontology::translation_algorithm->new();
