...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#PIR');
...
www::mygrid::org::uk::ontology::PIR - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::PIR;
  my $class = www::mygrid::org::uk::ontology::PIR->new();
