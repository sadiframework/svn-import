#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::biological_text_analysis
# Generated: 12-Aug-2010 09:34:59 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::biological_text_analysis;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#biological_text_analysis');
...
www::mygrid::org::uk::ontology::biological_text_analysis - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::biological_text_analysis;
  my $class = www::mygrid::org::uk::ontology::biological_text_analysis->new();
