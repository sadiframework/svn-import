#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::Prints_accession
# Generated: 12-Aug-2010 09:33:26 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::Prints_accession;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#Prints_accession');
...
www::mygrid::org::uk::ontology::Prints_accession - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::Prints_accession;
  my $class = www::mygrid::org::uk::ontology::Prints_accession->new();
