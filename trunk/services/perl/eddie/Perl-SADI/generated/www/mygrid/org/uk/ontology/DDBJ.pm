...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#DDBJ');
...
www::mygrid::org::uk::ontology::DDBJ - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::DDBJ;
  my $class = www::mygrid::org::uk::ontology::DDBJ->new();
