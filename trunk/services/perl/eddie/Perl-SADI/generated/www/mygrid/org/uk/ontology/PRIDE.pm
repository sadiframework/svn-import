...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#PRIDE');
...
www::mygrid::org::uk::ontology::PRIDE - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::PRIDE;
  my $class = www::mygrid::org::uk::ontology::PRIDE->new();
