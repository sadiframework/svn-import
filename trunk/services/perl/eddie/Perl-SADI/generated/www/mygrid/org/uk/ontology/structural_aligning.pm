#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::structural_aligning
# Generated: 12-Aug-2010 09:34:07 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::structural_aligning;

use OWL::Data::OWL::Class;
use www::mygrid::org::uk::ontology::aligning;
...
@ISA = qw(
 OWL::Data::OWL::Class
 www::mygrid::org::uk::ontology::aligning 
);
use strict;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->www::mygrid::org::uk::ontology::aligning::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->www::mygrid::org::uk::ontology::aligning::_attr_prop( $attr_name, $prop_name ) 
            if $self->www::mygrid::org::uk::ontology::aligning::_accessible($attr_name);
...
sub init {
    ...
    $self->www::mygrid::org::uk::ontology::aligning::init();
    $self->type('http://www.mygrid.org.uk/ontology#structural_aligning');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->www::mygrid::org::uk::ontology::aligning::_get_statements();
    };
...
www::mygrid::org::uk::ontology::structural_aligning - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::structural_aligning;
  my $class = www::mygrid::org::uk::ontology::structural_aligning->new();
...
L<www::mygrid::org::uk::ontology::aligning>
