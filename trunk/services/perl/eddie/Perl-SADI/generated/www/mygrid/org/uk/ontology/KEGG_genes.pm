...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#KEGG_genes');
...
www::mygrid::org::uk::ontology::KEGG_genes - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::KEGG_genes;
  my $class = www::mygrid::org::uk::ontology::KEGG_genes->new();
