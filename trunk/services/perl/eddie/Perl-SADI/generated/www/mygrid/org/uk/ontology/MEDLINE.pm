...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->www::mygrid::org::uk::ontology::literature_repository::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->www::mygrid::org::uk::ontology::literature_repository::_attr_prop( $attr_name, $prop_name ) 
            if $self->www::mygrid::org::uk::ontology::literature_repository::_accessible($attr_name);
...
sub init {
    ...
    $self->www::mygrid::org::uk::ontology::literature_repository::init();
    $self->type('http://www.mygrid.org.uk/ontology#MEDLINE');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->www::mygrid::org::uk::ontology::literature_repository::_get_statements();
    };
...
www::mygrid::org::uk::ontology::MEDLINE - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::MEDLINE;
  my $class = www::mygrid::org::uk::ontology::MEDLINE->new();
...
L<www::mygrid::org::uk::ontology::literature_repository>
