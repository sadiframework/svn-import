#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::Entrez_genbank_protein_accession
# Generated: 12-Aug-2010 09:33:43 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::Entrez_genbank_protein_accession;

use OWL::Data::OWL::Class;
use www::mygrid::org::uk::ontology::protein_sequence_id;
...
@ISA = qw(
 OWL::Data::OWL::Class
 www::mygrid::org::uk::ontology::protein_sequence_id 
);
use strict;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->www::mygrid::org::uk::ontology::protein_sequence_id::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->www::mygrid::org::uk::ontology::protein_sequence_id::_attr_prop( $attr_name, $prop_name ) 
            if $self->www::mygrid::org::uk::ontology::protein_sequence_id::_accessible($attr_name);
...
sub init {
    ...
    $self->www::mygrid::org::uk::ontology::protein_sequence_id::init();
    $self->type('http://www.mygrid.org.uk/ontology#Entrez_genbank_protein_accession');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->www::mygrid::org::uk::ontology::protein_sequence_id::_get_statements();
    };
...
www::mygrid::org::uk::ontology::Entrez_genbank_protein_accession - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::Entrez_genbank_protein_accession;
  my $class = www::mygrid::org::uk::ontology::Entrez_genbank_protein_accession->new();
...
L<www::mygrid::org::uk::ontology::protein_sequence_id>
