...
#-----------------------------------------------------------------
package Blank::genid4c641370f8af;
...
Blank::genid4c641370f8af - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = Blank::genid4c641370f8af->new();

  # get the uri for this class
  my $uri = $class->uri;
  # add object properties 
  use www::mygrid::org::uk::ontology::RefSeq_record_id;
  # add a has_identifier property (www::mygrid::org::uk::ontology::RefSeq_record_id)
  $class->add_has_identifier(new www::mygrid::org::uk::ontology::RefSeq_record_id());
  ...
  # add a produced_by property (www::mygrid::org::uk::ontology::RefSeq)
  $class->add_produced_by(new www::mygrid::org::uk::ontology::RefSeq());
