#-----------------------------------------------------------------
# Blank::genid4c641369bfb7
# Generated: 12-Aug-2010 09:34:23 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package Blank::genid4c641369bfb7;

use OWL::Data::OWL::Class;
use semanticscience::org::resource::SIO_000260;
...
@ISA = qw(
 OWL::Data::OWL::Class
 semanticscience::org::resource::SIO_000260
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->semanticscience::org::resource::SIO_000260::_accessible($attr)
          or $self->semanticscience::org::resource::SIO_000271::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->semanticscience::org::resource::SIO_000260::_attr_prop( $attr_name, $prop_name ) 
            if $self->semanticscience::org::resource::SIO_000260::_accessible($attr_name);
        return $self->semanticscience::org::resource::SIO_000271::_attr_prop( $attr_name, $prop_name ) 
            if $self->semanticscience::org::resource::SIO_000271::_accessible($attr_name);
...
sub init {
    ...
    $self->semanticscience::org::resource::SIO_000260::init();
    $self->semanticscience::org::resource::SIO_000271::init();
    $self->type('_:genid4c641369bfb7');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->semanticscience::org::resource::SIO_000260::_get_statements();
    };
    eval {
    	# add parent statements
        $self->semanticscience::org::resource::SIO_000271::_get_statements();
    };
...
Blank::genid4c641369bfb7 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use Blank::genid4c641369bfb7;
  my $class = Blank::genid4c641369bfb7->new();
...
L<semanticscience::org::resource::SIO_000260>
L<semanticscience::org::resource::SIO_000271>
