...
Blank::genid4c641366dfac - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use Blank::genid4c641366dfac;
  my $class = Blank::genid4c641366dfac->new();

  # get the uri for this class
  my $uri = $class->uri;
  # add object properties 
  use semanticscience::org::resource::SIO_000006;
  # add a SIO_000292 property (semanticscience::org::resource::SIO_000006)
  $class->add_SIO_000292(new semanticscience::org::resource::SIO_000006());
