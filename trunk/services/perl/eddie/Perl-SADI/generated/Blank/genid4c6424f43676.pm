...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->Blank::genid4c6424f4e30b::_accessible($attr)
    ...
    sub _attr_prop {
        ...
        return $self->Blank::genid4c6424f4e30b::_attr_prop( $attr_name, $prop_name ) 
            if $self->Blank::genid4c6424f4e30b::_accessible($attr_name);
...
sub init {
    ...
    $self->Blank::genid4c6424f4e30b::init();
    $self->purl::oclc::org::SADI::LSRN::GeneID_Record::init();
    $self->type('_:genid4c6424f43676');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->Blank::genid4c6424f4e30b::_get_statements();
    };
    eval {
    	# add parent statements
...
Blank::genid4c6424f43676 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use Blank::genid4c6424f43676;
  my $class = Blank::genid4c6424f43676->new();
