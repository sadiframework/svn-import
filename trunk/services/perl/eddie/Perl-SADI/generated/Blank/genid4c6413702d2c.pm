...
#-----------------------------------------------------------------
package Blank::genid4c6413702d2c;
...
Blank::genid4c6413702d2c - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = Blank::genid4c6413702d2c->new();

  # get the uri for this class
  my $uri = $class->uri;
  # add object properties 
  use www::mygrid::org::uk::ontology::SWISS_PROT_accession;
  # add a has_identifier property (www::mygrid::org::uk::ontology::SWISS_PROT_accession)
  $class->add_has_identifier(new www::mygrid::org::uk::ontology::SWISS_PROT_accession());
  ...
  # add a produced_by property (www::mygrid::org::uk::ontology::SWISS_PROT)
  $class->add_produced_by(new www::mygrid::org::uk::ontology::SWISS_PROT());
