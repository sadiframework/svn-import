...
@ISA = qw(
 OWL::Data::OWL::Class
 semanticscience::org::resource::SIO_000275 
);
use strict;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->semanticscience::org::resource::SIO_000275::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->semanticscience::org::resource::SIO_000275::_attr_prop( $attr_name, $prop_name ) 
            if $self->semanticscience::org::resource::SIO_000275::_accessible($attr_name);
...
sub init {
    ...
    $self->semanticscience::org::resource::SIO_000275::init();
    $self->type('_:genid4c6413695a43');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->semanticscience::org::resource::SIO_000275::_get_statements();
    };
...
Blank::genid4c6413695a43 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use Blank::genid4c6413695a43;
  my $class = Blank::genid4c6413695a43->new();

  # get the uri for this class
  my $uri = $class->uri;
  # add object properties 
  use semanticscience::org::resource::SIO_000275;
  # add a SIO_000272 property (semanticscience::org::resource::SIO_000275)
  $class->add_SIO_000272(new semanticscience::org::resource::SIO_000275());
...
L<semanticscience::org::resource::SIO_000275>
