...
#-----------------------------------------------------------------
package Blank::genid4c641370b526;
...
Blank::genid4c641370b526 - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = Blank::genid4c641370b526->new();

  # get the uri for this class
  my $uri = $class->uri;
  # add object properties 
  use www::mygrid::org::uk::ontology::EMAPA;
  # add a produced_by property (www::mygrid::org::uk::ontology::EMAPA)
  $class->add_produced_by(new www::mygrid::org::uk::ontology::EMAPA());
  ...
  # add a has_identifier property (www::mygrid::org::uk::ontology::EMAPA_term_id)
  $class->add_has_identifier(new www::mygrid::org::uk::ontology::EMAPA_term_id());
