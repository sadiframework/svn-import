#-----------------------------------------------------------------
# Blank::genid4c6413698990
# Generated: 12-Aug-2010 09:34:32 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package Blank::genid4c6413698990;

use OWL::Data::OWL::Class;
use semanticscience::org::resource::SIO_000014;
...
@ISA = qw(
 OWL::Data::OWL::Class
 semanticscience::org::resource::SIO_000014 
);
use strict;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->semanticscience::org::resource::SIO_000014::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->semanticscience::org::resource::SIO_000014::_attr_prop( $attr_name, $prop_name ) 
            if $self->semanticscience::org::resource::SIO_000014::_accessible($attr_name);
...
sub init {
    ...
    $self->semanticscience::org::resource::SIO_000014::init();
    $self->type('_:genid4c6413698990');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->semanticscience::org::resource::SIO_000014::_get_statements();
    };
...
Blank::genid4c6413698990 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use Blank::genid4c6413698990;
  my $class = Blank::genid4c6413698990->new();

  # get the uri for this class
  my $uri = $class->uri;
  # add object properties 
  use semanticscience::org::resource::SIO_000361;
  # add a SIO_000362 property (semanticscience::org::resource::SIO_000361)
  $class->add_SIO_000362(new semanticscience::org::resource::SIO_000361());
...
L<semanticscience::org::resource::SIO_000014>
