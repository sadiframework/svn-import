...
#-----------------------------------------------------------------
package Blank::genid4c641366d9aa;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->Blank::genid4c641366c948::_accessible($attr)
    ...
    sub _attr_prop {
        ...
        return $self->Blank::genid4c641366c948::_attr_prop( $attr_name, $prop_name ) 
            if $self->Blank::genid4c641366c948::_accessible($attr_name);
...
sub init {
    ...
    $self->Blank::genid4c641366c948::init();
    $self->semanticscience::org::resource::SIO_011125::init();
    $self->type('_:genid4c641366d9aa');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->Blank::genid4c641366c948::_get_statements();
    };
    eval {
    	# add parent statements
...
Blank::genid4c641366d9aa - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = Blank::genid4c641366d9aa->new();
