...
#-----------------------------------------------------------------
package Blank::genid4c6413703edf;
...
Blank::genid4c6413703edf - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = Blank::genid4c6413703edf->new();

  # get the uri for this class
  my $uri = $class->uri;
  # add object properties 
  use www::mygrid::org::uk::ontology::HGNC;
  # add a produced_by property (www::mygrid::org::uk::ontology::HGNC)
  $class->add_produced_by(new www::mygrid::org::uk::ontology::HGNC());
  # get the produced_by object properties
  my $produced_by_objects = $class->produced_by;
  use www::mygrid::org::uk::ontology::HGNC_symbol;
  # add a has_identifier property (www::mygrid::org::uk::ontology::HGNC_symbol)
  $class->add_has_identifier(new www::mygrid::org::uk::ontology::HGNC_symbol());
