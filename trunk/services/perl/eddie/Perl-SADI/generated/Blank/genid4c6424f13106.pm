#-----------------------------------------------------------------
# Blank::genid4c6424f13106
# Generated: 12-Aug-2010 09:44:34 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package Blank::genid4c6424f13106;
...
@ISA = qw(
 OWL::Data::OWL::Class
 purl::oclc::org::SADI::LSRN::UniProt_Record 
);
use strict;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->purl::oclc::org::SADI::LSRN::UniProt_Record::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->purl::oclc::org::SADI::LSRN::UniProt_Record::_attr_prop( $attr_name, $prop_name ) 
            if $self->purl::oclc::org::SADI::LSRN::UniProt_Record::_accessible($attr_name);
...
sub init {
    ...
    $self->purl::oclc::org::SADI::LSRN::UniProt_Record::init();
    $self->type('_:genid4c6424f13106');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->purl::oclc::org::SADI::LSRN::UniProt_Record::_get_statements();
    };
...
Blank::genid4c6424f13106 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use Blank::genid4c6424f13106;
  my $class = Blank::genid4c6424f13106->new();

  # get the uri for this class
  my $uri = $class->uri;
  # add object properties 
  use purl::oclc::org::SADI::LSRN::dbSNP_Record;
  # add a SIO_000272 property (purl::oclc::org::SADI::LSRN::dbSNP_Record)
  $class->add_SIO_000272(new purl::oclc::org::SADI::LSRN::dbSNP_Record());
...
L<purl::oclc::org::SADI::LSRN::UniProt_Record>
