...
@ISA = qw(
 OWL::Data::OWL::Class
 semanticscience::org::resource::SIO_010462
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->semanticscience::org::resource::SIO_010462::_accessible($attr)
    ...
    sub _attr_prop {
        ...
        return $self->semanticscience::org::resource::SIO_010462::_attr_prop( $attr_name, $prop_name ) 
            if $self->semanticscience::org::resource::SIO_010462::_accessible($attr_name);
...
sub init {
    ...
    $self->semanticscience::org::resource::SIO_010462::init();
    $self->semanticscience::org::resource::SIO_010463::init();
    $self->type('_:genid4c641367fafb');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->semanticscience::org::resource::SIO_010462::_get_statements();
    };
    eval {
    	# add parent statements
...
Blank::genid4c641367fafb - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use Blank::genid4c641367fafb;
  my $class = Blank::genid4c641367fafb->new();
...
L<semanticscience::org::resource::SIO_010462>
