#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_011020
# Generated: 12-Aug-2010 09:35:10 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_011020;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_011020');
...
semanticscience::org::resource::SIO_011020 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_011020;
  my $class = semanticscience::org::resource::SIO_011020->new();
