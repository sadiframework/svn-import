...
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_000083;

use OWL::Data::OWL::Class;
use semanticscience::org::resource::SIO_000080;
...
@ISA = qw(
 OWL::Data::OWL::Class
 semanticscience::org::resource::SIO_000080 
);
use strict;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->semanticscience::org::resource::SIO_000080::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->semanticscience::org::resource::SIO_000080::_attr_prop( $attr_name, $prop_name ) 
            if $self->semanticscience::org::resource::SIO_000080::_accessible($attr_name);
...
sub init {
    ...
    $self->semanticscience::org::resource::SIO_000080::init();
    $self->type('http://semanticscience.org/resource/SIO_000083');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->semanticscience::org::resource::SIO_000080::_get_statements();
    };
...
semanticscience::org::resource::SIO_000083 - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = semanticscience::org::resource::SIO_000083->new();
...
L<semanticscience::org::resource::SIO_000080>
