#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_011097
# Generated: 12-Aug-2010 09:35:04 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_011097;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_011097');
...
semanticscience::org::resource::SIO_011097 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_011097;
  my $class = semanticscience::org::resource::SIO_011097->new();
