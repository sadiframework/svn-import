#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_010064
# Generated: 12-Aug-2010 09:34:04 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_010064;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_010064');
...
semanticscience::org::resource::SIO_010064 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_010064;
  my $class = semanticscience::org::resource::SIO_010064->new();
