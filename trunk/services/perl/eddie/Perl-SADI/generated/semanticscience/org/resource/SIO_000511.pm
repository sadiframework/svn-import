...
# Generated: 12-Aug-2010 09:34:58 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_000511;

use OWL::Data::OWL::Class;
use semanticscience::org::resource::SIO_000510;
...
@ISA = qw(
 OWL::Data::OWL::Class
 semanticscience::org::resource::SIO_000510
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->semanticscience::org::resource::SIO_000510::_accessible($attr)
          or $self->Blank::genid4c6413697ada::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->semanticscience::org::resource::SIO_000510::_attr_prop( $attr_name, $prop_name ) 
            if $self->semanticscience::org::resource::SIO_000510::_accessible($attr_name);
        return $self->Blank::genid4c6413697ada::_attr_prop( $attr_name, $prop_name ) 
            if $self->Blank::genid4c6413697ada::_accessible($attr_name);
...
sub init {
    ...
    $self->semanticscience::org::resource::SIO_000510::init();
    $self->Blank::genid4c6413697ada::init();
    $self->type('http://semanticscience.org/resource/SIO_000511');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->semanticscience::org::resource::SIO_000510::_get_statements();
    };
    eval {
    	# add parent statements
        $self->Blank::genid4c6413697ada::_get_statements();
    };
...
semanticscience::org::resource::SIO_000511 - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = semanticscience::org::resource::SIO_000511->new();
...
L<semanticscience::org::resource::SIO_000510>
L<Blank::genid4c6413697ada>
