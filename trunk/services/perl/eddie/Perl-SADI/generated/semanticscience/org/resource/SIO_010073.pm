#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_010073
# Generated: 12-Aug-2010 09:35:30 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_010073;

use OWL::Data::OWL::Class;
use semanticscience::org::resource::SIO_010444;
use Blank::genid4c641366d7c6;
...
@ISA = qw(
 OWL::Data::OWL::Class
 semanticscience::org::resource::SIO_010444
 Blank::genid4c641366d7c6 
);
use strict;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->semanticscience::org::resource::SIO_010444::_accessible($attr)
          or $self->Blank::genid4c641366d7c6::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->semanticscience::org::resource::SIO_010444::_attr_prop( $attr_name, $prop_name ) 
            if $self->semanticscience::org::resource::SIO_010444::_accessible($attr_name);
        return $self->Blank::genid4c641366d7c6::_attr_prop( $attr_name, $prop_name ) 
            if $self->Blank::genid4c641366d7c6::_accessible($attr_name);
...
sub init {
    ...
    $self->semanticscience::org::resource::SIO_010444::init();
    $self->Blank::genid4c641366d7c6::init();
    $self->type('http://semanticscience.org/resource/SIO_010073');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->semanticscience::org::resource::SIO_010444::_get_statements();
    };
    eval {
    	# add parent statements
        $self->Blank::genid4c641366d7c6::_get_statements();
    };
...
semanticscience::org::resource::SIO_010073 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_010073;
  my $class = semanticscience::org::resource::SIO_010073->new();
...
L<semanticscience::org::resource::SIO_010444>
L<Blank::genid4c641366d7c6>
