...
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_000256;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_000256');
...
semanticscience::org::resource::SIO_000256 - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = semanticscience::org::resource::SIO_000256->new();
