#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_011019
# Generated: 12-Aug-2010 09:34:38 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_011019;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_011019');
...
semanticscience::org::resource::SIO_011019 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_011019;
  my $class = semanticscience::org::resource::SIO_011019->new();
