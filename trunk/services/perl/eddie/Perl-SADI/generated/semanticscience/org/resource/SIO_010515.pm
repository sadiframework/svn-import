#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_010515
# Generated: 12-Aug-2010 09:33:39 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_010515;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_010515');
...
semanticscience::org::resource::SIO_010515 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_010515;
  my $class = semanticscience::org::resource::SIO_010515->new();
