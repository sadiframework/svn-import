#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_000044
# Generated: 12-Aug-2010 09:33:43 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_000044;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_000044');
...
semanticscience::org::resource::SIO_000044 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_000044;
  my $class = semanticscience::org::resource::SIO_000044->new();
