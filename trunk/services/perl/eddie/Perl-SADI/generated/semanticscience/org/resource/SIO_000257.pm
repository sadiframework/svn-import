...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->Blank::genid4c641369fbea::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->Blank::genid4c641369fbea::_attr_prop( $attr_name, $prop_name ) 
            if $self->Blank::genid4c641369fbea::_accessible($attr_name);
...
sub init {
    ...
    $self->Blank::genid4c641369fbea::init();
    $self->type('http://semanticscience.org/resource/SIO_000257');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->Blank::genid4c641369fbea::_get_statements();
    };
...
semanticscience::org::resource::SIO_000257 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_000257;
  my $class = semanticscience::org::resource::SIO_000257->new();
