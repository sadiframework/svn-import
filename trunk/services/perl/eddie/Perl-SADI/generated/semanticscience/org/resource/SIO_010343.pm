#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_010343
# Generated: 12-Aug-2010 09:33:30 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_010343;

use OWL::Data::OWL::Class;
use Blank::genid4c6413663f0e;
use semanticscience::org::resource::SIO_010344;
use Blank::genid4c641366fb96;
...
@ISA = qw(
 OWL::Data::OWL::Class
 Blank::genid4c6413663f0e
 semanticscience::org::resource::SIO_010344
 Blank::genid4c641366fb96 
);
use strict;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->Blank::genid4c6413663f0e::_accessible($attr)
          or $self->semanticscience::org::resource::SIO_010344::_accessible($attr)
          or $self->Blank::genid4c641366fb96::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->Blank::genid4c6413663f0e::_attr_prop( $attr_name, $prop_name ) 
            if $self->Blank::genid4c6413663f0e::_accessible($attr_name);
        return $self->semanticscience::org::resource::SIO_010344::_attr_prop( $attr_name, $prop_name ) 
            if $self->semanticscience::org::resource::SIO_010344::_accessible($attr_name);
        return $self->Blank::genid4c641366fb96::_attr_prop( $attr_name, $prop_name ) 
            if $self->Blank::genid4c641366fb96::_accessible($attr_name);
...
sub init {
    ...
    $self->Blank::genid4c6413663f0e::init();
    $self->semanticscience::org::resource::SIO_010344::init();
    $self->Blank::genid4c641366fb96::init();
    $self->type('http://semanticscience.org/resource/SIO_010343');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->Blank::genid4c6413663f0e::_get_statements();
    };
    eval {
    	# add parent statements
        $self->semanticscience::org::resource::SIO_010344::_get_statements();
    };
    eval {
    	# add parent statements
        $self->Blank::genid4c641366fb96::_get_statements();
    };
...
semanticscience::org::resource::SIO_010343 - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = semanticscience::org::resource::SIO_010343->new();
...
L<Blank::genid4c6413663f0e>
L<semanticscience::org::resource::SIO_010344>
L<Blank::genid4c641366fb96>
