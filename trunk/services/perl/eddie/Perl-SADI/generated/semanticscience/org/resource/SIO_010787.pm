#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_010787
# Generated: 12-Aug-2010 09:34:16 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_010787;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_010787');
...
semanticscience::org::resource::SIO_010787 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_010787;
  my $class = semanticscience::org::resource::SIO_010787->new();
