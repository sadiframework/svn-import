#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_010367
# Generated: 12-Aug-2010 09:35:06 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_010367;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_010367');
...
semanticscience::org::resource::SIO_010367 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_010367;
  my $class = semanticscience::org::resource::SIO_010367->new();
