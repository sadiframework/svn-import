#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_010092
# Generated: 12-Aug-2010 09:34:33 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_010092;
...
use semanticscience::org::resource::SIO_000225;
...

{
    my %_allowed = (
        ...
        SIO_000225 => {
        	...
        	post => sub {
                ...
                my $type = @{$self->SIO_000225}[-1] if defined $self->SIO_000225;
                return unless defined $type and $type->type;
                my $range = new semanticscience::org::resource::SIO_000225->range();
                return unless $range;
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->semanticscience::org::resource::SIO_010010::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->semanticscience::org::resource::SIO_010010::_attr_prop( $attr_name, $prop_name ) 
            if $self->semanticscience::org::resource::SIO_010010::_accessible($attr_name);
...
sub init {
    ...
    $self->semanticscience::org::resource::SIO_010010::init();
    $self->type('http://semanticscience.org/resource/SIO_010092');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->semanticscience::org::resource::SIO_010010::_get_statements();
    };

    # for each attribute, if is array do:
    if (defined $self->SIO_000225){
	    foreach (@{$self->SIO_000225}) {
	        ...
	        $self->model->addStmt(
	          new RDF::Core::Statement(
	              $subject,
	              $subject->new('http://semanticscience.org/resource/SIO_000225'), 
...
semanticscience::org::resource::SIO_010092 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_010092;
  my $class = semanticscience::org::resource::SIO_010092->new();
  ...
  $class->add_SIO_000225(new OWL::Data::OWL::Class('#someURI'));

  # get the SIO_000225 object properties
  my $SIO_000225_objects = $class->SIO_000225;
...
L<semanticscience::org::resource::SIO_010010>
