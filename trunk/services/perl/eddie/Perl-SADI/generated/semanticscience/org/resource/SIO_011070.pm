#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_011070
# Generated: 12-Aug-2010 09:35:07 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_011070;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_011070');
...
semanticscience::org::resource::SIO_011070 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_011070;
  my $class = semanticscience::org::resource::SIO_011070->new();
