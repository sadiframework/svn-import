#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_000431
# Generated: 12-Aug-2010 09:33:27 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_000431;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_000431');
...
semanticscience::org::resource::SIO_000431 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_000431;
  my $class = semanticscience::org::resource::SIO_000431->new();
