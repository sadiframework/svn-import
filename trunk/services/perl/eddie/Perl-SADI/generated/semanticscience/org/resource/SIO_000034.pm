#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_000034
# Generated: 12-Aug-2010 09:34:36 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_000034;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_000034');
...
semanticscience::org::resource::SIO_000034 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_000034;
  my $class = semanticscience::org::resource::SIO_000034->new();
