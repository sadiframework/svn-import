#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_010416
# Generated: 12-Aug-2010 09:33:55 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_010416;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_010416');
...
semanticscience::org::resource::SIO_010416 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_010416;
  my $class = semanticscience::org::resource::SIO_010416->new();
