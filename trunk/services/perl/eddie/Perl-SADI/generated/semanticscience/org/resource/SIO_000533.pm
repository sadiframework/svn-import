#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_000533
# Generated: 12-Aug-2010 09:34:56 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_000533;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_000533');
...
semanticscience::org::resource::SIO_000533 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_000533;
  my $class = semanticscience::org::resource::SIO_000533->new();
