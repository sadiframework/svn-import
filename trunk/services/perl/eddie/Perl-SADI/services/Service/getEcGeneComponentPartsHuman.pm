#-----------------------------------------------------------------
# Service name: getEcGeneComponentPartsHuman
# Authority:    dev.biordf.net
# Created:      29-Jun-2010 13:26:49 PDT
# Contact:      edward.kawas+sadiframework@gmail.com
# Description:  
#               Using TOGO WS, fetch the enzymes component human KEGG genes
#-----------------------------------------------------------------

package Service::getEcGeneComponentPartsHuman;
...
BEGIN {
    ...
    new SADI::Generators::GenServices->async_load(
	 service_names => ['getEcGeneComponentPartsHuman']);
}

# (this to stay here with any of the options above)
use vars qw( @ISA );
@ISA = qw( net::biordf::dev::getEcGeneComponentPartsHumanBase );
use strict;
...
sub process_it {
    ...
    foreach my $input (@inputs) {
        ...
        my $class = Implementations::getEcGeneComponentPartsHuman($input, $accession, $LOG);
...
Service::getEcGeneComponentPartsHuman - a SADI service
