#-----------------------------------------------------------------
# Service name: getGOTermAssociationsOMIM
#    An asynchronous service
# Authority:    illuminae.com
# Created:      19-Aug-2010 13:07:17 PDT
# Contact:      myaddress@organization.org
# Description:  
#               fetches omim entities annotated with a given GO term
#-----------------------------------------------------------------

package Service::getGOTermAssociationsOMIM;
...
sub process_it {
    ...
    foreach my $input (@inputs) {
        ...
        use Implementations;
        my $class = Implementations::getGOTermAssociationsX($input, $id, $LOG, 'omim');
...
Service::getGOTermAssociationsOMIM - a SADI service
