...
# Created:      03-Dec-2009 10:42:31 PST
# Contact:      edward.kawas@gmail.com
# Description:  
#               This service returns entrez gene ids corresponding to the input SNP ids
#-----------------------------------------------------------------

package Service::snp2gene;
...
sub process_it {
    ...
    foreach my $input (@inputs) {
        ...
        my $class = Implementations::snp2gene($input, $accession, $LOG);
...
Service::snp2gene - a SADI service
