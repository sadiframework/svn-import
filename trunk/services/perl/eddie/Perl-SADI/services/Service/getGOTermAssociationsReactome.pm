#-----------------------------------------------------------------
# Service name: getGOTermAssociationsReactome
#    An asynchronous service
# Authority:    illuminae.com
# Created:      19-Aug-2010 13:07:19 PDT
# Contact:      myaddress@organization.org
# Description:  
#               fetches reactome entities annotated with a given GO term
#-----------------------------------------------------------------

package Service::getGOTermAssociationsReactome;
...
sub process_it {
    ...
    foreach my $input (@inputs) {
        ...
        use Implementations;
        my $class = Implementations::getGOTermAssociationsX($input, $id, $LOG, 'reactome');
...
Service::getGOTermAssociationsReactome - a SADI service
