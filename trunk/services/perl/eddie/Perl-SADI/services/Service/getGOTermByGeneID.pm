#-----------------------------------------------------------------
# Service name: getGOTermByGeneID
# Authority:    dev.biordf.net
# Created:      08-Feb-2010 07:17:13 PST
# Contact:      edward.kawas+sadi@gmail.com
# Description:  
#               This service takes Entrez gene ids and fetches its GO term annotations.
#-----------------------------------------------------------------

package Service::getGOTermByGeneID;
...
BEGIN {
    ...
    new SADI::Generators::GenServices->async_load(
	 service_names => ['getGOTermByGeneID']);
}

# (this to stay here with any of the options above)
use vars qw( @ISA );
@ISA = qw( net::biordf::dev::getGOTermByGeneIDBase );
use strict;
...
sub process_it {
    ...
    foreach my $input (@inputs) {
        ...
        my $class = Implementations::getGOTermByGeneID($input, $accession, $LOG);
...
Service::getGOTermByGeneID - a SADI service
