#-----------------------------------------------------------------
# Service name: getGOTermAssociationsTigrEgad
#    An asynchronous service
# Authority:    illuminae.com
# Created:      19-Aug-2010 13:07:20 PDT
# Contact:      myaddress@organization.org
# Description:  
#               fetches tigr egad entities annotated with a given GO term
#-----------------------------------------------------------------

package Service::getGOTermAssociationsTigrEgad;
...
sub process_it {
    ...
    foreach my $input (@inputs) {
        ...
        use Implementations;
        my $class = Implementations::getGOTermAssociationsX($input, $id, $LOG, 'tigr_egad');
...
Service::getGOTermAssociationsTigrEgad - a SADI service
