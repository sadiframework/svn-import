...
public class KeggUtils 
{
	static public final Pattern[] GENE_URI_PATTERNS = {
		Pattern.compile("http://biordf\\.net/moby/KEGG/(\\S+)"),
	...
	static public final Pattern[] PATHWAY_URI_PATTERNS = {
		Pattern.compile("http://biordf\\.net/moby/KEGG_PATHWAY/(\\S+)"),
	...
	static public final Pattern[] COMPOUND_URI_PATTERNS = {
		Pattern.compile("http://biordf\\.net/moby/KEGG_COMPOUND/(\\S+)"),
		Pattern.compile("http://lsrn\\.org/KEGG_COMPOUND:(\\S+)"),
