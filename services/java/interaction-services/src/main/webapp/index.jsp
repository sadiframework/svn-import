...
<html>
  <head>
    <title>SADI Protein-Protein Interaction Services</title>
  ...
  <body>
    <div id='outer-frame'>
      <div id='inner-frame'>
        ...
        <div id='content'>
          <h2>SADI Protein-Protein Interaction Services</h2>
	      <ul>
            <li><a href="./RetrieveFlyInteractors">RetrieveFlyInteractors</a></li>
            <li><a href="./RetrieveYeastInteractors">RetrieveYeastInteractors</a></li>
	      </ul>
        </div> <!-- content -->
        <div id='footer'>
        </div> <!-- footer -->
