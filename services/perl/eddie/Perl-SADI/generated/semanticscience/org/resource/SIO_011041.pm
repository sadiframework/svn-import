#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_011041
# Generated: 12-Aug-2010 09:33:56 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_011041;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_011041');
...
semanticscience::org::resource::SIO_011041 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_011041;
  my $class = semanticscience::org::resource::SIO_011041->new();
