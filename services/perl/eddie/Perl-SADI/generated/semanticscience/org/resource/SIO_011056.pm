#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_011056
# Generated: 12-Aug-2010 09:33:41 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_011056;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_011056');
...
semanticscience::org::resource::SIO_011056 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_011056;
  my $class = semanticscience::org::resource::SIO_011056->new();
