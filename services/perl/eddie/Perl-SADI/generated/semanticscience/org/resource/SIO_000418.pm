#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_000418
# Generated: 12-Aug-2010 09:35:23 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_000418;

use OWL::Data::OWL::Class;
use Blank::genid4c6413695360;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->Blank::genid4c6413695360::_accessible($attr)
    ...
    sub _attr_prop {
        ...
        return $self->Blank::genid4c6413695360::_attr_prop( $attr_name, $prop_name ) 
            if $self->Blank::genid4c6413695360::_accessible($attr_name);
...
sub init {
    ...
    $self->Blank::genid4c6413695360::init();
    $self->semanticscience::org::resource::SIO_000391::init();
    $self->type('http://semanticscience.org/resource/SIO_000418');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->Blank::genid4c6413695360::_get_statements();
    };
    eval {
    	# add parent statements
...
semanticscience::org::resource::SIO_000418 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_000418;
  my $class = semanticscience::org::resource::SIO_000418->new();
