#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_000151
# Generated: 12-Aug-2010 09:34:11 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_000151;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_000151');
...
semanticscience::org::resource::SIO_000151 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_000151;
  my $class = semanticscience::org::resource::SIO_000151->new();
