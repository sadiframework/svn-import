#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_011112
# Generated: 12-Aug-2010 09:33:47 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_011112;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_011112');
...
semanticscience::org::resource::SIO_011112 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_011112;
  my $class = semanticscience::org::resource::SIO_011112->new();
