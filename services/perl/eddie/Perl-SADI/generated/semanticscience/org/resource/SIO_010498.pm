#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_010498
# Generated: 12-Aug-2010 09:35:12 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_010498;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_010498');
...
semanticscience::org::resource::SIO_010498 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_010498;
  my $class = semanticscience::org::resource::SIO_010498->new();
