#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_011130
# Generated: 12-Aug-2010 09:35:28 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_011130;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->semanticscience::org::resource::SIO_011120::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->semanticscience::org::resource::SIO_011120::_attr_prop( $attr_name, $prop_name ) 
            if $self->semanticscience::org::resource::SIO_011120::_accessible($attr_name);
...
sub init {
    ...
    $self->semanticscience::org::resource::SIO_011120::init();
    $self->type('http://semanticscience.org/resource/SIO_011130');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->semanticscience::org::resource::SIO_011120::_get_statements();
    };
...
semanticscience::org::resource::SIO_011130 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_011130;
  my $class = semanticscience::org::resource::SIO_011130->new();
...
L<semanticscience::org::resource::SIO_011120>
