#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_011054
# Generated: 12-Aug-2010 09:33:56 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_011054;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_011054');
...
semanticscience::org::resource::SIO_011054 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_011054;
  my $class = semanticscience::org::resource::SIO_011054->new();
