#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_010055
# Generated: 12-Aug-2010 09:35:21 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_010055;

use OWL::Data::OWL::Class;
use semanticscience::org::resource::SIO_010000;
...
@ISA = qw(
 OWL::Data::OWL::Class
 semanticscience::org::resource::SIO_010000 
);
use strict;
...

{
    my %_allowed = (
        ...
        SIO_000272 => {
        	...
        	post => sub {
                ...
                my $type = @{$self->SIO_000272}[-1] if defined $self->SIO_000272;
                return unless defined $type and $type->type;
                my $range = new semanticscience::org::resource::SIO_000272->range();
                return unless $range;
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->semanticscience::org::resource::SIO_010000::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->semanticscience::org::resource::SIO_010000::_attr_prop( $attr_name, $prop_name ) 
            if $self->semanticscience::org::resource::SIO_010000::_accessible($attr_name);
...
sub init {
    ...
    $self->semanticscience::org::resource::SIO_010000::init();
    $self->type('http://semanticscience.org/resource/SIO_010055');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->semanticscience::org::resource::SIO_010000::_get_statements();
    };

    # for each attribute, if is array do:
    if (defined $self->SIO_000272){
	    foreach (@{$self->SIO_000272}) {
	        ...
	        $self->model->addStmt(
	          new RDF::Core::Statement(
	              $subject,
	              $subject->new('http://semanticscience.org/resource/SIO_000272'), 
...
semanticscience::org::resource::SIO_010055 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_010055;
  my $class = semanticscience::org::resource::SIO_010055->new();
  ...
  $class->add_SIO_000272(new OWL::Data::OWL::Class('#someURI'));

  # get the SIO_000272 object properties
  my $SIO_000272_objects = $class->SIO_000272;
...
L<semanticscience::org::resource::SIO_010000>
