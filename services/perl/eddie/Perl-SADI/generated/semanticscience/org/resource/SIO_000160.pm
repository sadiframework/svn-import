#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_000160
# Generated: 12-Aug-2010 09:34:56 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_000160;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_000160');
...
semanticscience::org::resource::SIO_000160 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_000160;
  my $class = semanticscience::org::resource::SIO_000160->new();
