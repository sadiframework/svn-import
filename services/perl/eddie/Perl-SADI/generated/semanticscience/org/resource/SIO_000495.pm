#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_000495
# Generated: 12-Aug-2010 09:33:25 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_000495;
...
sub init {
    ...
    $self->uri('http://semanticscience.org/resource/SIO_000495');
}
...
semanticscience::org::resource::SIO_000495 - an object propery

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_000495;
  my $property = semanticscience::org::resource::SIO_000495->new();
