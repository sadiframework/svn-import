#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_000333
# Generated: 12-Aug-2010 09:33:39 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_000333;

use OWL::Data::OWL::Class;
use semanticscience::org::resource::SIO_000072;
use Blank::genid4c6413698260;
...
@ISA = qw(
 OWL::Data::OWL::Class
 semanticscience::org::resource::SIO_000072
 Blank::genid4c6413698260 
);
use strict;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->semanticscience::org::resource::SIO_000072::_accessible($attr)
          or $self->Blank::genid4c6413698260::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->semanticscience::org::resource::SIO_000072::_attr_prop( $attr_name, $prop_name ) 
            if $self->semanticscience::org::resource::SIO_000072::_accessible($attr_name);
        return $self->Blank::genid4c6413698260::_attr_prop( $attr_name, $prop_name ) 
            if $self->Blank::genid4c6413698260::_accessible($attr_name);
...
sub init {
    ...
    $self->semanticscience::org::resource::SIO_000072::init();
    $self->Blank::genid4c6413698260::init();
    $self->type('http://semanticscience.org/resource/SIO_000333');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->semanticscience::org::resource::SIO_000072::_get_statements();
    };
    eval {
    	# add parent statements
        $self->Blank::genid4c6413698260::_get_statements();
    };
...
semanticscience::org::resource::SIO_000333 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_000333;
  my $class = semanticscience::org::resource::SIO_000333->new();
...
L<semanticscience::org::resource::SIO_000072>
L<Blank::genid4c6413698260>
