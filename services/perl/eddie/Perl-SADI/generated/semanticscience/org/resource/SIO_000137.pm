#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_000137
# Generated: 12-Aug-2010 09:35:14 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_000137;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_000137');
...
semanticscience::org::resource::SIO_000137 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_000137;
  my $class = semanticscience::org::resource::SIO_000137->new();
