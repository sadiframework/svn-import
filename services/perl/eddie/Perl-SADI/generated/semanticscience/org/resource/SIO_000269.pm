...
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_000269;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_000269');
    $self->add_SIO_000300(semanticscience::org::resource::SIO_000300->new('true'));
...
semanticscience::org::resource::SIO_000269 - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = semanticscience::org::resource::SIO_000269->new();
...
=item 'SIO_000300' has value 'true', for example, (semanticscience::org::resource::SIO_000300->new('true'));
