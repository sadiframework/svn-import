#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_000388
# Generated: 12-Aug-2010 09:33:37 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_000388;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_000388');
...
semanticscience::org::resource::SIO_000388 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_000388;
  my $class = semanticscience::org::resource::SIO_000388->new();
