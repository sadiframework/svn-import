#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_000222
# Generated: 12-Aug-2010 09:33:25 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_000222;
...
sub init {
    ...
    $self->uri('http://semanticscience.org/resource/SIO_000222');
}
...
semanticscience::org::resource::SIO_000222 - an object propery

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_000222;
  my $property = semanticscience::org::resource::SIO_000222->new();
