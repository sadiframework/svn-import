#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_000255
# Generated: 12-Aug-2010 09:33:25 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_000255;
...
sub init {
    ...
    $self->range('http://semanticscience.org/resource/SIO_000133');        
    # set the uri for this object property
    $self->uri('http://semanticscience.org/resource/SIO_000255');
}
...
semanticscience::org::resource::SIO_000255 - an object propery

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_000255;
  my $property = semanticscience::org::resource::SIO_000255->new();
