#-----------------------------------------------------------------
# sadiframework::org::ontologies::properties::hasSequence
# Generated: 12-Aug-2010 09:33:25 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package sadiframework::org::ontologies::properties::hasSequence;
...
sub init {
    ...
    $self->uri('http://sadiframework.org/ontologies/properties.owl#hasSequence');
}
...
sadiframework::org::ontologies::properties::hasSequence - an object propery

=head1 SYNOPSIS

  use sadiframework::org::ontologies::properties::hasSequence;
  my $property = sadiframework::org::ontologies::properties::hasSequence->new();
