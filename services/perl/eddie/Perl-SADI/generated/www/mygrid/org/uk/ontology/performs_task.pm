#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::performs_task
# Generated: 12-Aug-2010 09:33:25 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::performs_task;
...
sub init {
    ...
    $self->range('http://www.mygrid.org.uk/ontology#bioinformatics_task');    
    # set the domain for this object property
    $self->domain('http://www.mygrid.org.uk/ontology#bioinformatics_algorithm');    
    # set the uri for this object property
    $self->uri('http://www.mygrid.org.uk/ontology#performs_task');
}
...
www::mygrid::org::uk::ontology::performs_task - an object propery

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::performs_task;
  my $property = www::mygrid::org::uk::ontology::performs_task->new();
