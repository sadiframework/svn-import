...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#WormBase');
...
www::mygrid::org::uk::ontology::WormBase - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::WormBase;
  my $class = www::mygrid::org::uk::ontology::WormBase->new();
