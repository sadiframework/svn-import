#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::Tree_of_Life
# Generated: 12-Aug-2010 09:34:08 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::Tree_of_Life;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#Tree_of_Life');
...
www::mygrid::org::uk::ontology::Tree_of_Life - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::Tree_of_Life;
  my $class = www::mygrid::org::uk::ontology::Tree_of_Life->new();
