#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::Superfamily_accession
# Generated: 12-Aug-2010 09:34:44 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::Superfamily_accession;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->www::mygrid::org::uk::ontology::protein_family_id::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->www::mygrid::org::uk::ontology::protein_family_id::_attr_prop( $attr_name, $prop_name ) 
            if $self->www::mygrid::org::uk::ontology::protein_family_id::_accessible($attr_name);
...
sub init {
    ...
    $self->www::mygrid::org::uk::ontology::protein_family_id::init();
    $self->type('http://www.mygrid.org.uk/ontology#Superfamily_accession');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->www::mygrid::org::uk::ontology::protein_family_id::_get_statements();
    };
...
www::mygrid::org::uk::ontology::Superfamily_accession - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::Superfamily_accession;
  my $class = www::mygrid::org::uk::ontology::Superfamily_accession->new();
...
L<www::mygrid::org::uk::ontology::protein_family_id>
