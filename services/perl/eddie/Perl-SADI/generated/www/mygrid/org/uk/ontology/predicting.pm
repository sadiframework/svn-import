...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#predicting');
...
www::mygrid::org::uk::ontology::predicting - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::predicting;
  my $class = www::mygrid::org::uk::ontology::predicting->new();
