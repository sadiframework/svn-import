#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::Entrez_Gene_ID
# Generated: 12-Aug-2010 09:34:09 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::Entrez_Gene_ID;

use OWL::Data::OWL::Class;
use www::mygrid::org::uk::ontology::genotype_phenotype_record_id;
use www::mygrid::org::uk::ontology::genome_map_record_id;
...
@ISA = qw(
 OWL::Data::OWL::Class
 www::mygrid::org::uk::ontology::genotype_phenotype_record_id
 www::mygrid::org::uk::ontology::genome_map_record_id 
);
use strict;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->www::mygrid::org::uk::ontology::genotype_phenotype_record_id::_accessible($attr)
          or $self->www::mygrid::org::uk::ontology::genome_map_record_id::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->www::mygrid::org::uk::ontology::genotype_phenotype_record_id::_attr_prop( $attr_name, $prop_name ) 
            if $self->www::mygrid::org::uk::ontology::genotype_phenotype_record_id::_accessible($attr_name);
        return $self->www::mygrid::org::uk::ontology::genome_map_record_id::_attr_prop( $attr_name, $prop_name ) 
            if $self->www::mygrid::org::uk::ontology::genome_map_record_id::_accessible($attr_name);
...
sub init {
    ...
    $self->www::mygrid::org::uk::ontology::genotype_phenotype_record_id::init();
    $self->www::mygrid::org::uk::ontology::genome_map_record_id::init();
    $self->type('http://www.mygrid.org.uk/ontology#Entrez_Gene_ID');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->www::mygrid::org::uk::ontology::genotype_phenotype_record_id::_get_statements();
    };
    eval {
    	# add parent statements
        $self->www::mygrid::org::uk::ontology::genome_map_record_id::_get_statements();
    };
...
www::mygrid::org::uk::ontology::Entrez_Gene_ID - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::Entrez_Gene_ID;
  my $class = www::mygrid::org::uk::ontology::Entrez_Gene_ID->new();
...
L<www::mygrid::org::uk::ontology::genotype_phenotype_record_id>
L<www::mygrid::org::uk::ontology::genome_map_record_id>
