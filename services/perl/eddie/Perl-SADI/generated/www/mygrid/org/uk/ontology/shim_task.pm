...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#shim_task');
...
www::mygrid::org::uk::ontology::shim_task - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::shim_task;
  my $class = www::mygrid::org::uk::ontology::shim_task->new();
