#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::proteomics_database
# Generated: 12-Aug-2010 09:34:36 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::proteomics_database;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#proteomics_database');
...
www::mygrid::org::uk::ontology::proteomics_database - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::proteomics_database;
  my $class = www::mygrid::org::uk::ontology::proteomics_database->new();
