...
# Generated: 12-Aug-2010 09:33:54 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::similarity_search_algorithm;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#similarity_search_algorithm');
...
www::mygrid::org::uk::ontology::similarity_search_algorithm - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = www::mygrid::org::uk::ontology::similarity_search_algorithm->new();
