...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#searching');
...
www::mygrid::org::uk::ontology::searching - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::searching;
  my $class = www::mygrid::org::uk::ontology::searching->new();
