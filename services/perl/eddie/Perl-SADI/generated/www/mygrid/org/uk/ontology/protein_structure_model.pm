...
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::protein_structure_model;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#protein_structure_model');
...
www::mygrid::org::uk::ontology::protein_structure_model - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = www::mygrid::org::uk::ontology::protein_structure_model->new();
