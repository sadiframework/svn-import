#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::model_organism_record
# Generated: 12-Aug-2010 09:35:18 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::model_organism_record;

use OWL::Data::OWL::Class;
use www::mygrid::org::uk::ontology::genome_map_record;
...
@ISA = qw(
 OWL::Data::OWL::Class
 www::mygrid::org::uk::ontology::genome_map_record 
);
use strict;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->www::mygrid::org::uk::ontology::genome_map_record::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->www::mygrid::org::uk::ontology::genome_map_record::_attr_prop( $attr_name, $prop_name ) 
            if $self->www::mygrid::org::uk::ontology::genome_map_record::_accessible($attr_name);
...
sub init {
    ...
    $self->www::mygrid::org::uk::ontology::genome_map_record::init();
    $self->type('http://www.mygrid.org.uk/ontology#model_organism_record');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->www::mygrid::org::uk::ontology::genome_map_record::_get_statements();
    };
...
www::mygrid::org::uk::ontology::model_organism_record - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::model_organism_record;
  my $class = www::mygrid::org::uk::ontology::model_organism_record->new();
  ...
  $class->add_has_part(new OWL::Data::OWL::Class('#someURI'));
...
L<www::mygrid::org::uk::ontology::genome_map_record>
