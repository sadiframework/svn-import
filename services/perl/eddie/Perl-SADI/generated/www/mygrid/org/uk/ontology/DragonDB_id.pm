...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#DragonDB_id');
...
www::mygrid::org::uk::ontology::DragonDB_id - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::DragonDB_id;
  my $class = www::mygrid::org::uk::ontology::DragonDB_id->new();
