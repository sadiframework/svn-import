#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::InAct_record
# Generated: 12-Aug-2010 09:35:28 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::InAct_record;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#InAct_record');
...
www::mygrid::org::uk::ontology::InAct_record - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::InAct_record;
  my $class = www::mygrid::org::uk::ontology::InAct_record->new();
