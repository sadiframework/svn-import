#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::ABI_graph_plot
# Generated: 12-Aug-2010 09:33:52 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::ABI_graph_plot;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#ABI_graph_plot');
...
www::mygrid::org::uk::ontology::ABI_graph_plot - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::ABI_graph_plot;
  my $class = www::mygrid::org::uk::ontology::ABI_graph_plot->new();
