...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->www::mygrid::org::uk::ontology::mouse_anatomy_ontology::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->www::mygrid::org::uk::ontology::mouse_anatomy_ontology::_attr_prop( $attr_name, $prop_name ) 
            if $self->www::mygrid::org::uk::ontology::mouse_anatomy_ontology::_accessible($attr_name);
...
sub init {
    ...
    $self->www::mygrid::org::uk::ontology::mouse_anatomy_ontology::init();
    $self->type('http://www.mygrid.org.uk/ontology#EMAP');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->www::mygrid::org::uk::ontology::mouse_anatomy_ontology::_get_statements();
    };
...
www::mygrid::org::uk::ontology::EMAP - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::EMAP;
  my $class = www::mygrid::org::uk::ontology::EMAP->new();
...
L<www::mygrid::org::uk::ontology::mouse_anatomy_ontology>
