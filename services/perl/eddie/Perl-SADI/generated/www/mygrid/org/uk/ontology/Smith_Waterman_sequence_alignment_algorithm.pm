#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::Smith_Waterman_sequence_alignment_algorithm
# Generated: 12-Aug-2010 09:34:14 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::Smith_Waterman_sequence_alignment_algorithm;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#Smith-Waterman_sequence_alignment_algorithm');
...
www::mygrid::org::uk::ontology::Smith_Waterman_sequence_alignment_algorithm - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::Smith_Waterman_sequence_alignment_algorithm;
  my $class = www::mygrid::org::uk::ontology::Smith_Waterman_sequence_alignment_algorithm->new();
