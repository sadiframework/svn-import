#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::codata_format
# Generated: 12-Aug-2010 09:34:28 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::codata_format;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#codata_format');
...
www::mygrid::org::uk::ontology::codata_format - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::codata_format;
  my $class = www::mygrid::org::uk::ontology::codata_format->new();
