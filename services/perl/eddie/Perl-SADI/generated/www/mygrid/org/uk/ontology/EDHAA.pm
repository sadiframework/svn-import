...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#EDHAA');
...
www::mygrid::org::uk::ontology::EDHAA - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::EDHAA;
  my $class = www::mygrid::org::uk::ontology::EDHAA->new();
