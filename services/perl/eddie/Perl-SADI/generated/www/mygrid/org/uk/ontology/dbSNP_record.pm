#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::dbSNP_record
# Generated: 12-Aug-2010 09:33:33 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::dbSNP_record;

use OWL::Data::OWL::Class;
use www::mygrid::org::uk::ontology::nucleotide_sequence_record;
use Blank::genid4c6413712b8c;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->Blank::genid4c6413712b8c::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->Blank::genid4c6413712b8c::_attr_prop( $attr_name, $prop_name ) 
            if $self->Blank::genid4c6413712b8c::_accessible($attr_name);
...
sub init {
    ...
    $self->Blank::genid4c6413712b8c::init();
    $self->type('http://www.mygrid.org.uk/ontology#dbSNP_record');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->Blank::genid4c6413712b8c::_get_statements();
    };
...
www::mygrid::org::uk::ontology::dbSNP_record - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::dbSNP_record;
  my $class = www::mygrid::org::uk::ontology::dbSNP_record->new();
