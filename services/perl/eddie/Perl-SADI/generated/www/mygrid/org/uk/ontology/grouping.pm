...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#grouping');
...
www::mygrid::org::uk::ontology::grouping - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::grouping;
  my $class = www::mygrid::org::uk::ontology::grouping->new();
