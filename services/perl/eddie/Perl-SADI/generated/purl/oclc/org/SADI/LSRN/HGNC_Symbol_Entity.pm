#-----------------------------------------------------------------
# purl::oclc::org::SADI::LSRN::HGNC_Symbol_Entity
# Generated: 12-Aug-2010 09:35:28 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package purl::oclc::org::SADI::LSRN::HGNC_Symbol_Entity;
...
sub init {
    ...
    $self->type('http://purl.oclc.org/SADI/LSRN/HGNC_Symbol_Entity');
...
purl::oclc::org::SADI::LSRN::HGNC_Symbol_Entity - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use purl::oclc::org::SADI::LSRN::HGNC_Symbol_Entity;
  my $class = purl::oclc::org::SADI::LSRN::HGNC_Symbol_Entity->new();
