...
sub init {
    ...
    $self->type('http://purl.oclc.org/SADI/LSRN/RESID_Entity');
...
purl::oclc::org::SADI::LSRN::RESID_Entity - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use purl::oclc::org::SADI::LSRN::RESID_Entity;
  my $class = purl::oclc::org::SADI::LSRN::RESID_Entity->new();
