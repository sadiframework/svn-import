#-----------------------------------------------------------------
# purl::oclc::org::SADI::LSRN::ATCC_in_host_Record
# Generated: 12-Aug-2010 09:33:33 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package purl::oclc::org::SADI::LSRN::ATCC_in_host_Record;
...
sub init {
    ...
    $self->type('http://purl.oclc.org/SADI/LSRN/ATCC_in-host_Record');
...
purl::oclc::org::SADI::LSRN::ATCC_in_host_Record - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use purl::oclc::org::SADI::LSRN::ATCC_in_host_Record;
  my $class = purl::oclc::org::SADI::LSRN::ATCC_in_host_Record->new();
