#-----------------------------------------------------------------
# purl::oclc::org::SADI::LSRN::PMID_Identifier
# Generated: 12-Aug-2010 09:34:54 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package purl::oclc::org::SADI::LSRN::PMID_Identifier;
...
sub init {
    ...
    $self->type('http://purl.oclc.org/SADI/LSRN/PMID_Identifier');
...
purl::oclc::org::SADI::LSRN::PMID_Identifier - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = purl::oclc::org::SADI::LSRN::PMID_Identifier->new();
