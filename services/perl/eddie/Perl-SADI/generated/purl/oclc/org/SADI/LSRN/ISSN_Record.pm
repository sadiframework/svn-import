...
sub init {
    ...
    $self->type('http://purl.oclc.org/SADI/LSRN/ISSN_Record');
...
purl::oclc::org::SADI::LSRN::ISSN_Record - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use purl::oclc::org::SADI::LSRN::ISSN_Record;
  my $class = purl::oclc::org::SADI::LSRN::ISSN_Record->new();
