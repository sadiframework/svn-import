#-----------------------------------------------------------------
# purl::oclc::org::SADI::LSRN::GeneDB_Pfalciparum_Identifier
# Generated: 12-Aug-2010 09:35:09 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package purl::oclc::org::SADI::LSRN::GeneDB_Pfalciparum_Identifier;

use OWL::Data::OWL::Class;
use purl::oclc::org::SADI::LSRN::LSRN_Identifier;
...
@ISA = qw(
 OWL::Data::OWL::Class
 purl::oclc::org::SADI::LSRN::LSRN_Identifier 
);
use strict;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->purl::oclc::org::SADI::LSRN::LSRN_Identifier::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->purl::oclc::org::SADI::LSRN::LSRN_Identifier::_attr_prop( $attr_name, $prop_name ) 
            if $self->purl::oclc::org::SADI::LSRN::LSRN_Identifier::_accessible($attr_name);
...
sub init {
    ...
    $self->purl::oclc::org::SADI::LSRN::LSRN_Identifier::init();
    $self->type('http://purl.oclc.org/SADI/LSRN/GeneDB_Pfalciparum_Identifier');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->purl::oclc::org::SADI::LSRN::LSRN_Identifier::_get_statements();
    };
...
purl::oclc::org::SADI::LSRN::GeneDB_Pfalciparum_Identifier - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use purl::oclc::org::SADI::LSRN::GeneDB_Pfalciparum_Identifier;
  my $class = purl::oclc::org::SADI::LSRN::GeneDB_Pfalciparum_Identifier->new();
...
L<purl::oclc::org::SADI::LSRN::LSRN_Identifier>
