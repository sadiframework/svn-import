...
sub init {
    ...
    $self->type('http://purl.oclc.org/SADI/LSRN/CGD_Identifier');
...
purl::oclc::org::SADI::LSRN::CGD_Identifier - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use purl::oclc::org::SADI::LSRN::CGD_Identifier;
  my $class = purl::oclc::org::SADI::LSRN::CGD_Identifier->new();
