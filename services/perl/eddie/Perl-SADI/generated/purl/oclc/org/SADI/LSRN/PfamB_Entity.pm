...
sub init {
    ...
    $self->type('http://purl.oclc.org/SADI/LSRN/PfamB_Entity');
...
purl::oclc::org::SADI::LSRN::PfamB_Entity - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use purl::oclc::org::SADI::LSRN::PfamB_Entity;
  my $class = purl::oclc::org::SADI::LSRN::PfamB_Entity->new();
