...
#-----------------------------------------------------------------
package Blank::genid4c641366cf14;

use OWL::Data::OWL::Class;
use Blank::genid4c64136651ab;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->Blank::genid4c64136651ab::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->Blank::genid4c64136651ab::_attr_prop( $attr_name, $prop_name ) 
            if $self->Blank::genid4c64136651ab::_accessible($attr_name);
...
sub init {
    ...
    $self->Blank::genid4c64136651ab::init();
    $self->type('_:genid4c641366cf14');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->Blank::genid4c64136651ab::_get_statements();
    };
...
Blank::genid4c641366cf14 - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = Blank::genid4c641366cf14->new();

  # get the uri for this class
  my $uri = $class->uri;
  # add object properties 
  use semanticscience::org::resource::SIO_010442;
  # add a SIO_000217 property (semanticscience::org::resource::SIO_010442)
  $class->add_SIO_000217(new semanticscience::org::resource::SIO_010442());
