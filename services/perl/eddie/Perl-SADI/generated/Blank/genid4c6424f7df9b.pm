...
@ISA = qw(
 OWL::Data::OWL::Class
 purl::oclc::org::SADI::LSRN::DragonDB_Locus_Record 
);
use strict;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->purl::oclc::org::SADI::LSRN::DragonDB_Locus_Record::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->purl::oclc::org::SADI::LSRN::DragonDB_Locus_Record::_attr_prop( $attr_name, $prop_name ) 
            if $self->purl::oclc::org::SADI::LSRN::DragonDB_Locus_Record::_accessible($attr_name);
...
sub init {
    ...
    $self->purl::oclc::org::SADI::LSRN::DragonDB_Locus_Record::init();
    $self->type('_:genid4c6424f7df9b');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->purl::oclc::org::SADI::LSRN::DragonDB_Locus_Record::_get_statements();
    };
...
Blank::genid4c6424f7df9b - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use Blank::genid4c6424f7df9b;
  my $class = Blank::genid4c6424f7df9b->new();

  # get the uri for this class
  my $uri = $class->uri;
  # add object properties 
  use purl::oclc::org::SADI::LSRN::DragonDB_Allele_Record;
  # add a SIO_000272 property (purl::oclc::org::SADI::LSRN::DragonDB_Allele_Record)
  $class->add_SIO_000272(new purl::oclc::org::SADI::LSRN::DragonDB_Allele_Record());
...
L<purl::oclc::org::SADI::LSRN::DragonDB_Locus_Record>
