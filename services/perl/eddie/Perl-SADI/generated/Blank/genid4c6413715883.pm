...
#-----------------------------------------------------------------
package Blank::genid4c6413715883;
...
Blank::genid4c6413715883 - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = Blank::genid4c6413715883->new();

  # get the uri for this class
  my $uri = $class->uri;
  # add object properties 
  use www::mygrid::org::uk::ontology::chEBI_ontology;
  # add a produced_by property (www::mygrid::org::uk::ontology::chEBI_ontology)
  $class->add_produced_by(new www::mygrid::org::uk::ontology::chEBI_ontology());
  ...
  # add a has_identifier property (www::mygrid::org::uk::ontology::chEBI_term_id)
  $class->add_has_identifier(new www::mygrid::org::uk::ontology::chEBI_term_id());
