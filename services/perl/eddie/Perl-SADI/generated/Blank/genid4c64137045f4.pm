...
#-----------------------------------------------------------------
package Blank::genid4c64137045f4;
...
Blank::genid4c64137045f4 - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = Blank::genid4c64137045f4->new();

  # get the uri for this class
  my $uri = $class->uri;
  # add object properties 
  use www::mygrid::org::uk::ontology::BioPax_term_id;
  # add a has_identifier property (www::mygrid::org::uk::ontology::BioPax_term_id)
  $class->add_has_identifier(new www::mygrid::org::uk::ontology::BioPax_term_id());
  ...
  # add a produced_by property (www::mygrid::org::uk::ontology::BioPax)
  $class->add_produced_by(new www::mygrid::org::uk::ontology::BioPax());
