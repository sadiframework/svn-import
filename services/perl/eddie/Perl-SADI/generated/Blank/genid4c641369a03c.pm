...
#-----------------------------------------------------------------
package Blank::genid4c641369a03c;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->semanticscience::org::resource::SIO_000257::_accessible($attr)
          or $self->semanticscience::org::resource::SIO_000258::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->semanticscience::org::resource::SIO_000257::_attr_prop( $attr_name, $prop_name ) 
            if $self->semanticscience::org::resource::SIO_000257::_accessible($attr_name);
        return $self->semanticscience::org::resource::SIO_000258::_attr_prop( $attr_name, $prop_name ) 
            if $self->semanticscience::org::resource::SIO_000258::_accessible($attr_name);
...
sub init {
    ...
    $self->semanticscience::org::resource::SIO_000257::init();
    $self->semanticscience::org::resource::SIO_000258::init();
    $self->type('_:genid4c641369a03c');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->semanticscience::org::resource::SIO_000257::_get_statements();
    };
    eval {
    	# add parent statements
        $self->semanticscience::org::resource::SIO_000258::_get_statements();
    };
...
Blank::genid4c641369a03c - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = Blank::genid4c641369a03c->new();
...
L<semanticscience::org::resource::SIO_000257>
L<semanticscience::org::resource::SIO_000258>
