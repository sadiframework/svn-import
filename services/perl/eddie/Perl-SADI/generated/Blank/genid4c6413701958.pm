...
#-----------------------------------------------------------------
package Blank::genid4c6413701958;
...
Blank::genid4c6413701958 - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = Blank::genid4c6413701958->new();

  # get the uri for this class
  my $uri = $class->uri;
  # add object properties 
  use www::mygrid::org::uk::ontology::REBASE_id;
  # add a has_identifier property (www::mygrid::org::uk::ontology::REBASE_id)
  $class->add_has_identifier(new www::mygrid::org::uk::ontology::REBASE_id());
  ...
  # add a produced_by property (www::mygrid::org::uk::ontology::REBASE)
  $class->add_produced_by(new www::mygrid::org::uk::ontology::REBASE());
