...
use semanticscience::org::resource::SIO_000427;
    ...
    my %_allowed = (
        ...
        SIO_000427 => {
        	...
        	post => sub {
                ...
                my $type = @{$self->SIO_000427}[-1] if defined $self->SIO_000427;
                return unless defined $type and $type->type;
                my $range = new semanticscience::org::resource::SIO_000427->range();
                return unless $range;
...
sub _get_statements {
    ...
    if (defined $self->SIO_000427){
	    foreach (@{$self->SIO_000427}) {
	        ...
	        $self->model->addStmt(
	          new RDF::Core::Statement(
	              $subject,
	              $subject->new('http://semanticscience.org/resource/SIO_000427'), 
...
Blank::genid4c641369732a - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use Blank::genid4c641369732a;
  my $class = Blank::genid4c641369732a->new();

  # get the uri for this class
  my $uri = $class->uri;
  # add object properties 
  use semanticscience::org::resource::SIO_000275;
  # add a SIO_000427 property (semanticscience::org::resource::SIO_000275)
  $class->add_SIO_000427(new semanticscience::org::resource::SIO_000275());
  # get the SIO_000427 object properties
  my $SIO_000427_objects = $class->SIO_000427;
