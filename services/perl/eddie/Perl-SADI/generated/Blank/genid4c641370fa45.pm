...
#-----------------------------------------------------------------
package Blank::genid4c641370fa45;
...
Blank::genid4c641370fa45 - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = Blank::genid4c641370fa45->new();

  # get the uri for this class
  my $uri = $class->uri;
  # add object properties 
  use www::mygrid::org::uk::ontology::PIR_accession;
  # add a has_identifier property (www::mygrid::org::uk::ontology::PIR_accession)
  $class->add_has_identifier(new www::mygrid::org::uk::ontology::PIR_accession());
  # get the has_identifier object properties
  my $has_identifier_objects = $class->has_identifier;
  use www::mygrid::org::uk::ontology::PIR;
  # add a produced_by property (www::mygrid::org::uk::ontology::PIR)
  $class->add_produced_by(new www::mygrid::org::uk::ontology::PIR());
