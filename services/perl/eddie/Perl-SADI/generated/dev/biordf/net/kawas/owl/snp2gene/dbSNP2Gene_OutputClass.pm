#-----------------------------------------------------------------
# dev::biordf::net::kawas::owl::snp2gene::dbSNP2Gene_OutputClass
# Generated: 12-Aug-2010 09:44:36 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package dev::biordf::net::kawas::owl::snp2gene::dbSNP2Gene_OutputClass;
...
@ISA = qw(
 OWL::Data::OWL::Class
 purl::oclc::org::SADI::LSRN::dbSNP_Record 
);
use strict;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->purl::oclc::org::SADI::LSRN::dbSNP_Record::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->purl::oclc::org::SADI::LSRN::dbSNP_Record::_attr_prop( $attr_name, $prop_name ) 
            if $self->purl::oclc::org::SADI::LSRN::dbSNP_Record::_accessible($attr_name);
...
sub init {
    ...
    $self->purl::oclc::org::SADI::LSRN::dbSNP_Record::init();
    $self->type('http://dev.biordf.net/~kawas/owl/snp2gene.owl#dbSNP2Gene_OutputClass');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->purl::oclc::org::SADI::LSRN::dbSNP_Record::_get_statements();
    };
...
dev::biordf::net::kawas::owl::snp2gene::dbSNP2Gene_OutputClass - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = dev::biordf::net::kawas::owl::snp2gene::dbSNP2Gene_OutputClass->new();
...
L<purl::oclc::org::SADI::LSRN::dbSNP_Record>
