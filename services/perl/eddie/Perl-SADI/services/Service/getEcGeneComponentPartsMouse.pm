#-----------------------------------------------------------------
# Service name: getEcGeneComponentPartsMouse
# Authority:    dev.biordf.net
# Created:      29-Jun-2010 13:26:53 PDT
# Contact:      edward.kawas+sadiframework@gmail.com
# Description:  
#               Using TOGO WS, fetch the enzymes component mouse KEGG genes
#-----------------------------------------------------------------

package Service::getEcGeneComponentPartsMouse;
...
BEGIN {
    ...
    new SADI::Generators::GenServices->async_load(
	 service_names => ['getEcGeneComponentPartsMouse']);
}

# (this to stay here with any of the options above)
use vars qw( @ISA );
@ISA = qw( net::biordf::dev::getEcGeneComponentPartsMouseBase );
use strict;
...
sub process_it {
    ...
    foreach my $input (@inputs) {
        ...
        my $class = Implementations::getEcGeneComponentPartsMouse($input, $accession, $LOG);
...
Service::getEcGeneComponentPartsMouse - a SADI service
