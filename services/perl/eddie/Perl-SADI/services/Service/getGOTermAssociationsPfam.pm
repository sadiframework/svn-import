#-----------------------------------------------------------------
# Service name: getGOTermAssociationsPfam
#    An asynchronous service
# Authority:    illuminae.com
# Created:      19-Aug-2010 13:07:18 PDT
# Contact:      myaddress@organization.org
# Description:  
#               fetches pfam entities annotated with a given GO term
#-----------------------------------------------------------------

package Service::getGOTermAssociationsPfam;
...
sub process_it {
    ...
    foreach my $input (@inputs) {
        ...
        use Implementations;
        my $class = Implementations::getGOTermAssociationsX($input, $id, $LOG, 'pfam');
...
Service::getGOTermAssociationsPfam - a SADI service
