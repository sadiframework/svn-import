#-----------------------------------------------------------------
# Service name: getGOTermAssociationsKeggCompound
#    An asynchronous service
# Authority:    illuminae.com
# Created:      19-Aug-2010 13:07:17 PDT
# Contact:      myaddress@organization.org
# Description:  
#               fetches the kegg compounds annotated with a given GO term
#-----------------------------------------------------------------

package Service::getGOTermAssociationsKeggCompound;
...
sub process_it {
    ...
    foreach my $input (@inputs) {
        ...
        use Implementations;
        my $class = Implementations::getGOTermAssociationsX($input, $id, $LOG, 'kegg_compound');
...
Service::getGOTermAssociationsKeggCompound - a SADI service
