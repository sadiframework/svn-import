#-----------------------------------------------------------------
# Service name: getGOTermAssociationsPDB
#    An asynchronous service
# Authority:    illuminae.com
# Created:      19-Aug-2010 13:38:32 PDT
# Contact:      myaddress@organization.org
# Description:  
#               fetches PDB entities annotated with a given GO term
#-----------------------------------------------------------------

package Service::getGOTermAssociationsPDB;
...
sub process_it {
    ...
    foreach my $input (@inputs) {
        ...
        use Implementations;
        my $class = Implementations::getGOTermAssociationsX($input, $id, $LOG, 'pdb');
...
Service::getGOTermAssociationsPDB - a SADI service
