#-----------------------------------------------------------------
# Service name: getGOTermAssociationsKeggPathway
#    An asynchronous service
# Authority:    illuminae.com
# Created:      19-Aug-2010 13:07:17 PDT
# Contact:      myaddress@organization.org
# Description:  
#               fetches the kegg pathways annotated with a given GO term
#-----------------------------------------------------------------

package Service::getGOTermAssociationsKeggPathway;
...
sub process_it {
    ...
    foreach my $input (@inputs) {
        ...
        use Implementations;
        my $class = Implementations::getGOTermAssociationsX($input, $id, $LOG, 'kegg_pathway');
...
Service::getGOTermAssociationsKeggPathway - a SADI service
