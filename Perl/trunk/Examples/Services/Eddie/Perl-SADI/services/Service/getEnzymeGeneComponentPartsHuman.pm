...
BEGIN {
    ...
    new SADI::Generators::GenServices->async_load(
	 service_names => ['getEnzymeGeneComponentPartsHuman']);
}


# (this to stay here with any of the options above)
use vars qw( @ISA );
@ISA = qw( net::biordf::dev::getEnzymeGeneComponentPartsHumanBase );
use strict;
...
sub process_it {
    ...
    foreach my $input (@inputs) {
        ...
        my $class = Implementations::getEnzymeGeneComponentPartsHuman($input, $accession, $LOG);
...
Service::getEnzymeGeneComponentPartsHuman - a SADI service
