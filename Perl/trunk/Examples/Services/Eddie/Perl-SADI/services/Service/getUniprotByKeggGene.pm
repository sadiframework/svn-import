#-----------------------------------------------------------------
# Service name: getUniprotByKeggGene
# Authority:    dev.biordf.net
# Created:      19-Jan-2010 16:06:09 PST
# Contact:      edward.kawas+sadi@gmail.com
# Description:  
#               A service that takes kegg gene records and fetches their uniprot equivalents.
#-----------------------------------------------------------------

package Service::getUniprotByKeggGene;
...
BEGIN {
    ...
    new SADI::Generators::GenServices->async_load(
	 service_names => ['getUniprotByKeggGene']);
}

# (this to stay here with any of the options above)
use vars qw( @ISA );
@ISA = qw( net::biordf::dev::getUniprotByKeggGeneBase );
use strict;
...
sub process_it {
    ...
    foreach my $input (@inputs) {
        ...
        my $output = Implementations::getUniprotByKeggGene($input, $accession, $LOG);
...
Service::getUniprotByKeggGene - a SADI service
