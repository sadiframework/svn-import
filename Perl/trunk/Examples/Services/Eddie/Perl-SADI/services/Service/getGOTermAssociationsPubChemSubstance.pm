#-----------------------------------------------------------------
# Service name: getGOTermAssociationsPubChemSubstance
#    An asynchronous service
# Authority:    illuminae.com
# Created:      19-Aug-2010 13:07:19 PDT
# Contact:      myaddress@organization.org
# Description:  
#               fetches the pubchem substance entities annotated with a given GO term
#-----------------------------------------------------------------

package Service::getGOTermAssociationsPubChemSubstance;
...
sub process_it {
    ...
    foreach my $input (@inputs) {
        ...
        use Implementations;
        my $class = Implementations::getGOTermAssociationsX($input, $id, $LOG, 'pubchem_substance');
...
Service::getGOTermAssociationsPubChemSubstance - a SADI service
