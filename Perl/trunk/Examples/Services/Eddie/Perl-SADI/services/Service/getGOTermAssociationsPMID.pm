#-----------------------------------------------------------------
# Service name: getGOTermAssociationsPMID
#    An asynchronous service
# Authority:    illuminae.com
# Created:      19-Aug-2010 13:07:18 PDT
# Contact:      myaddress@organization.org
# Description:  
#               fetches pubmed publications annotated with a given GO term
#-----------------------------------------------------------------

package Service::getGOTermAssociationsPMID;
...
sub process_it {
    ...
    foreach my $input (@inputs) {
        ...
        use Implementations;
        my $class = Implementations::getGOTermAssociationsX($input, $id, $LOG, 'pmid');
...
Service::getGOTermAssociationsPMID - a SADI service
