...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#REBASE');
...
www::mygrid::org::uk::ontology::REBASE - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::REBASE;
  my $class = www::mygrid::org::uk::ontology::REBASE->new();
