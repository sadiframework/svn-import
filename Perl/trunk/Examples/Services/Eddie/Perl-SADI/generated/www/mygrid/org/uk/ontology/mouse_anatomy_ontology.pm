#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::mouse_anatomy_ontology
# Generated: 12-Aug-2010 09:33:26 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::mouse_anatomy_ontology;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#mouse_anatomy_ontology');
...
www::mygrid::org::uk::ontology::mouse_anatomy_ontology - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::mouse_anatomy_ontology;
  my $class = www::mygrid::org::uk::ontology::mouse_anatomy_ontology->new();
