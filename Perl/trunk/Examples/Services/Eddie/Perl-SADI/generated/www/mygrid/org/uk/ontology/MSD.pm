...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#MSD');
...
www::mygrid::org::uk::ontology::MSD - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::MSD;
  my $class = www::mygrid::org::uk::ontology::MSD->new();
