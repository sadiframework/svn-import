#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::DDBJ_accession
# Generated: 12-Aug-2010 09:33:46 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::DDBJ_accession;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#DDBJ_accession');
...
www::mygrid::org::uk::ontology::DDBJ_accession - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::DDBJ_accession;
  my $class = www::mygrid::org::uk::ontology::DDBJ_accession->new();
