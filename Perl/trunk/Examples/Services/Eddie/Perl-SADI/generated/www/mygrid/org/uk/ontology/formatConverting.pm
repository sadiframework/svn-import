...
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::formatConverting;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->www::mygrid::org::uk::ontology::shim_task::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->www::mygrid::org::uk::ontology::shim_task::_attr_prop( $attr_name, $prop_name ) 
            if $self->www::mygrid::org::uk::ontology::shim_task::_accessible($attr_name);
...
sub init {
    ...
    $self->www::mygrid::org::uk::ontology::shim_task::init();
    $self->type('http://www.mygrid.org.uk/ontology#formatConverting');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->www::mygrid::org::uk::ontology::shim_task::_get_statements();
    };
...
www::mygrid::org::uk::ontology::formatConverting - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = www::mygrid::org::uk::ontology::formatConverting->new();
...
L<www::mygrid::org::uk::ontology::shim_task>
