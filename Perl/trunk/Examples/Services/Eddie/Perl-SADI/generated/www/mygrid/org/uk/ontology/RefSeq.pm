...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#RefSeq');
...
www::mygrid::org::uk::ontology::RefSeq - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::RefSeq;
  my $class = www::mygrid::org::uk::ontology::RefSeq->new();
