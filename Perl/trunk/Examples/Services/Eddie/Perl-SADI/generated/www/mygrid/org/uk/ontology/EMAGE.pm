...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#EMAGE');
...
www::mygrid::org::uk::ontology::EMAGE - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::EMAGE;
  my $class = www::mygrid::org::uk::ontology::EMAGE->new();
