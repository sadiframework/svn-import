...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#BioPax');
...
www::mygrid::org::uk::ontology::BioPax - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::BioPax;
  my $class = www::mygrid::org::uk::ontology::BioPax->new();
