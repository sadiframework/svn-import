#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::interacting_molecule_resource
# Generated: 12-Aug-2010 09:35:27 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::interacting_molecule_resource;

use OWL::Data::OWL::Class;
use www::mygrid::org::uk::ontology::bioinformatics_data_resource;
...
@ISA = qw(
 OWL::Data::OWL::Class
 www::mygrid::org::uk::ontology::bioinformatics_data_resource 
);
use strict;
...
use www::mygrid::org::uk::ontology::produces;
...

{
    my %_allowed = (
        ...
        produces => {
        	...
        	post => sub {
                ...
                my $type = @{$self->produces}[-1] if defined $self->produces;
                return unless defined $type and $type->type;
                my $range = new www::mygrid::org::uk::ontology::produces->range();
                return unless $range;
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->www::mygrid::org::uk::ontology::bioinformatics_data_resource::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->www::mygrid::org::uk::ontology::bioinformatics_data_resource::_attr_prop( $attr_name, $prop_name ) 
            if $self->www::mygrid::org::uk::ontology::bioinformatics_data_resource::_accessible($attr_name);
...
sub init {
    ...
    $self->www::mygrid::org::uk::ontology::bioinformatics_data_resource::init();
    $self->type('http://www.mygrid.org.uk/ontology#interacting_molecule_resource');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->www::mygrid::org::uk::ontology::bioinformatics_data_resource::_get_statements();
    };

    # for each attribute, if is array do:
    if (defined $self->produces){
	    foreach (@{$self->produces}) {
	        ...
	        $self->model->addStmt(
	          new RDF::Core::Statement(
	              $subject,
	              $subject->new('http://www.mygrid.org.uk/ontology#produces'), 
...
www::mygrid::org::uk::ontology::interacting_molecule_resource - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::interacting_molecule_resource;
  my $class = www::mygrid::org::uk::ontology::interacting_molecule_resource->new();
  ...
  $class->add_produces(new OWL::Data::OWL::Class('#someURI'));

  # get the produces object properties
  my $produces_objects = $class->produces;
...
L<www::mygrid::org::uk::ontology::bioinformatics_data_resource>
