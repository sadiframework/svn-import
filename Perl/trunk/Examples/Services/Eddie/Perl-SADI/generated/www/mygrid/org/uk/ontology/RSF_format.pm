...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#RSF_format');
...
www::mygrid::org::uk::ontology::RSF_format - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::RSF_format;
  my $class = www::mygrid::org::uk::ontology::RSF_format->new();
