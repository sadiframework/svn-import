...
# Generated: 12-Aug-2010 09:34:12 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::protein_sequence_record;

use OWL::Data::OWL::Class;
use www::mygrid::org::uk::ontology::sequence_record;
use Blank::genid4c6413713a5e;
...
@ISA = qw(
 OWL::Data::OWL::Class
 www::mygrid::org::uk::ontology::sequence_record
 Blank::genid4c6413713a5e 
);
use strict;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->www::mygrid::org::uk::ontology::sequence_record::_accessible($attr)
          or $self->Blank::genid4c6413713a5e::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->www::mygrid::org::uk::ontology::sequence_record::_attr_prop( $attr_name, $prop_name ) 
            if $self->www::mygrid::org::uk::ontology::sequence_record::_accessible($attr_name);
        return $self->Blank::genid4c6413713a5e::_attr_prop( $attr_name, $prop_name ) 
            if $self->Blank::genid4c6413713a5e::_accessible($attr_name);
...
sub init {
    ...
    $self->www::mygrid::org::uk::ontology::sequence_record::init();
    $self->Blank::genid4c6413713a5e::init();
    $self->type('http://www.mygrid.org.uk/ontology#protein_sequence_record');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->www::mygrid::org::uk::ontology::sequence_record::_get_statements();
    };
    eval {
    	# add parent statements
        $self->Blank::genid4c6413713a5e::_get_statements();
    };
...
www::mygrid::org::uk::ontology::protein_sequence_record - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = www::mygrid::org::uk::ontology::protein_sequence_record->new();
...
L<www::mygrid::org::uk::ontology::sequence_record>
L<Blank::genid4c6413713a5e>
