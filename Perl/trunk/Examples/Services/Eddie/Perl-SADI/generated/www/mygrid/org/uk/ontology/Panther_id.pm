...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#Panther_id');
...
www::mygrid::org::uk::ontology::Panther_id - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::Panther_id;
  my $class = www::mygrid::org::uk::ontology::Panther_id->new();
