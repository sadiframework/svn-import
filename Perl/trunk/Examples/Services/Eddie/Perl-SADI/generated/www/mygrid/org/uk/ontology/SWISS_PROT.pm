...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#SWISS-PROT');
...
www::mygrid::org::uk::ontology::SWISS_PROT - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::SWISS_PROT;
  my $class = www::mygrid::org::uk::ontology::SWISS_PROT->new();
