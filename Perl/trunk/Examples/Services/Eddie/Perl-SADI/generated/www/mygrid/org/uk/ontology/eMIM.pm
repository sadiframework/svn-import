...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#eMIM');
...
www::mygrid::org::uk::ontology::eMIM - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::eMIM;
  my $class = www::mygrid::org::uk::ontology::eMIM->new();
