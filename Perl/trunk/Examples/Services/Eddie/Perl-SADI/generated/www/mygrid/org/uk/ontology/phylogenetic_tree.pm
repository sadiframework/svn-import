#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::phylogenetic_tree
# Generated: 12-Aug-2010 09:34:54 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::phylogenetic_tree;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->www::mygrid::org::uk::ontology::phylogenetic_report::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->www::mygrid::org::uk::ontology::phylogenetic_report::_attr_prop( $attr_name, $prop_name ) 
            if $self->www::mygrid::org::uk::ontology::phylogenetic_report::_accessible($attr_name);
...
sub init {
    ...
    $self->www::mygrid::org::uk::ontology::phylogenetic_report::init();
    $self->type('http://www.mygrid.org.uk/ontology#phylogenetic_tree');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->www::mygrid::org::uk::ontology::phylogenetic_report::_get_statements();
    };
...
www::mygrid::org::uk::ontology::phylogenetic_tree - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::phylogenetic_tree;
  my $class = www::mygrid::org::uk::ontology::phylogenetic_tree->new();
...
L<www::mygrid::org::uk::ontology::phylogenetic_report>
