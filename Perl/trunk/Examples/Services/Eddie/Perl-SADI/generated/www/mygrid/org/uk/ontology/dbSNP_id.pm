...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#dbSNP_id');
...
www::mygrid::org::uk::ontology::dbSNP_id - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::dbSNP_id;
  my $class = www::mygrid::org::uk::ontology::dbSNP_id->new();
