#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::gene_ontology_term_record
# Generated: 12-Aug-2010 09:34:38 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::gene_ontology_term_record;

use OWL::Data::OWL::Class;
use www::mygrid::org::uk::ontology::ontology_term_record;
use Blank::genid4c641371f495;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->www::mygrid::org::uk::ontology::ontology_term_record::_accessible($attr)
          or $self->Blank::genid4c641371f495::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->www::mygrid::org::uk::ontology::ontology_term_record::_attr_prop( $attr_name, $prop_name ) 
            if $self->www::mygrid::org::uk::ontology::ontology_term_record::_accessible($attr_name);
        return $self->Blank::genid4c641371f495::_attr_prop( $attr_name, $prop_name ) 
            if $self->Blank::genid4c641371f495::_accessible($attr_name);
...
sub init {
    ...
    $self->www::mygrid::org::uk::ontology::ontology_term_record::init();
    $self->Blank::genid4c641371f495::init();
    $self->type('http://www.mygrid.org.uk/ontology#gene_ontology_term_record');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->www::mygrid::org::uk::ontology::ontology_term_record::_get_statements();
    };
    eval {
    	# add parent statements
        $self->Blank::genid4c641371f495::_get_statements();
    };
...
www::mygrid::org::uk::ontology::gene_ontology_term_record - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::gene_ontology_term_record;
  my $class = www::mygrid::org::uk::ontology::gene_ontology_term_record->new();
...
L<www::mygrid::org::uk::ontology::ontology_term_record>
L<Blank::genid4c641371f495>
