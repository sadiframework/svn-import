#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::ABI_sequence_trace
# Generated: 12-Aug-2010 09:34:55 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::ABI_sequence_trace;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#ABI_sequence_trace');
...
www::mygrid::org::uk::ontology::ABI_sequence_trace - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::ABI_sequence_trace;
  my $class = www::mygrid::org::uk::ontology::ABI_sequence_trace->new();
