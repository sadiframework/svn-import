...
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::bioinformatics_task;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#bioinformatics_task');
...
www::mygrid::org::uk::ontology::bioinformatics_task - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = www::mygrid::org::uk::ontology::bioinformatics_task->new();
