#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::sequence_file_formats
# Generated: 12-Aug-2010 09:34:28 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::sequence_file_formats;

use OWL::Data::OWL::Class;
use www::mygrid::org::uk::ontology::bioinformatics_file_formats;
...
@ISA = qw(
 OWL::Data::OWL::Class
 www::mygrid::org::uk::ontology::bioinformatics_file_formats 
);
use strict;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->www::mygrid::org::uk::ontology::bioinformatics_file_formats::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->www::mygrid::org::uk::ontology::bioinformatics_file_formats::_attr_prop( $attr_name, $prop_name ) 
            if $self->www::mygrid::org::uk::ontology::bioinformatics_file_formats::_accessible($attr_name);
...
sub init {
    ...
    $self->www::mygrid::org::uk::ontology::bioinformatics_file_formats::init();
    $self->type('http://www.mygrid.org.uk/ontology#sequence_file_formats');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->www::mygrid::org::uk::ontology::bioinformatics_file_formats::_get_statements();
    };
...
www::mygrid::org::uk::ontology::sequence_file_formats - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::sequence_file_formats;
  my $class = www::mygrid::org::uk::ontology::sequence_file_formats->new();
...
L<www::mygrid::org::uk::ontology::bioinformatics_file_formats>
