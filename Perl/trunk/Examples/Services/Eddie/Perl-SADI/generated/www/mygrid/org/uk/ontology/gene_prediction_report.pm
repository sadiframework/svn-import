#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::gene_prediction_report
# Generated: 12-Aug-2010 09:35:18 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::gene_prediction_report;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#gene_prediction_report');
...
www::mygrid::org::uk::ontology::gene_prediction_report - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::gene_prediction_report;
  my $class = www::mygrid::org::uk::ontology::gene_prediction_report->new();
