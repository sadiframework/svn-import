...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#FASTA');
...
www::mygrid::org::uk::ontology::FASTA - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::FASTA;
  my $class = www::mygrid::org::uk::ontology::FASTA->new();
