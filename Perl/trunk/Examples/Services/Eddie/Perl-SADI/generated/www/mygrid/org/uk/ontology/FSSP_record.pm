...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#FSSP_record');
...
www::mygrid::org::uk::ontology::FSSP_record - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::FSSP_record;
  my $class = www::mygrid::org::uk::ontology::FSSP_record->new();
