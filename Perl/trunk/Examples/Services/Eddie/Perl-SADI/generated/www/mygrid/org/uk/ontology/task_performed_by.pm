#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::task_performed_by
# Generated: 12-Aug-2010 09:33:24 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::task_performed_by;
...
sub init {
    ...
    $self->range('http://www.mygrid.org.uk/ontology#bioinformatics_algorithm');    
    # set the domain for this object property
    $self->domain('http://www.mygrid.org.uk/ontology#bioinformatics_task');    
    # set the uri for this object property
    $self->uri('http://www.mygrid.org.uk/ontology#task_performed_by');
}
...
www::mygrid::org::uk::ontology::task_performed_by - an object propery

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::task_performed_by;
  my $property = www::mygrid::org::uk::ontology::task_performed_by->new();
