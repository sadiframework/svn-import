#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::Zebrafish_Information_Network_ZFIN
# Generated: 12-Aug-2010 09:33:53 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::Zebrafish_Information_Network_ZFIN;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#Zebrafish_Information_Network_ZFIN');
...
www::mygrid::org::uk::ontology::Zebrafish_Information_Network_ZFIN - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::Zebrafish_Information_Network_ZFIN;
  my $class = www::mygrid::org::uk::ontology::Zebrafish_Information_Network_ZFIN->new();
