...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#dbEST');
...
www::mygrid::org::uk::ontology::dbEST - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::dbEST;
  my $class = www::mygrid::org::uk::ontology::dbEST->new();
