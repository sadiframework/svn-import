...
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::interacting_molecule_record;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#interacting_molecule_record');
...
www::mygrid::org::uk::ontology::interacting_molecule_record - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = www::mygrid::org::uk::ontology::interacting_molecule_record->new();
