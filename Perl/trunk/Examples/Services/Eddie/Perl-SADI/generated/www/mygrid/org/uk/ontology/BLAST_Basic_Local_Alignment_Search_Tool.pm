#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::BLAST_Basic_Local_Alignment_Search_Tool
# Generated: 12-Aug-2010 09:34:20 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::BLAST_Basic_Local_Alignment_Search_Tool;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#BLAST_Basic_Local_Alignment_Search_Tool');
...
www::mygrid::org::uk::ontology::BLAST_Basic_Local_Alignment_Search_Tool - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::BLAST_Basic_Local_Alignment_Search_Tool;
  my $class = www::mygrid::org::uk::ontology::BLAST_Basic_Local_Alignment_Search_Tool->new();
