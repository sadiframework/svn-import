...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#inserting');
...
www::mygrid::org::uk::ontology::inserting - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::inserting;
  my $class = www::mygrid::org::uk::ontology::inserting->new();
