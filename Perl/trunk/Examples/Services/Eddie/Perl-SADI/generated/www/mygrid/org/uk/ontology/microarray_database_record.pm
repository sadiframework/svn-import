#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::microarray_database_record
# Generated: 12-Aug-2010 09:33:34 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::microarray_database_record;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#microarray_database_record');
...
www::mygrid::org::uk::ontology::microarray_database_record - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::microarray_database_record;
  my $class = www::mygrid::org::uk::ontology::microarray_database_record->new();
