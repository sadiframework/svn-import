...
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::sequence_record;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->Blank::genid4c641371358c::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->Blank::genid4c641371358c::_attr_prop( $attr_name, $prop_name ) 
            if $self->Blank::genid4c641371358c::_accessible($attr_name);
...
sub init {
    ...
    $self->Blank::genid4c641371358c::init();
    $self->type('http://www.mygrid.org.uk/ontology#sequence_record');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->Blank::genid4c641371358c::_get_statements();
    };
...
www::mygrid::org::uk::ontology::sequence_record - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = www::mygrid::org::uk::ontology::sequence_record->new();
