...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#IG_format');
...
www::mygrid::org::uk::ontology::IG_format - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::IG_format;
  my $class = www::mygrid::org::uk::ontology::IG_format->new();
