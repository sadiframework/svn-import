#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::single_nucleotide_polymorphism_location
# Generated: 12-Aug-2010 09:33:58 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::single_nucleotide_polymorphism_location;

use OWL::Data::OWL::Class;
use www::mygrid::org::uk::ontology::genome_location;
...
@ISA = qw(
 OWL::Data::OWL::Class
 www::mygrid::org::uk::ontology::genome_location 
);
use strict;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->www::mygrid::org::uk::ontology::genome_location::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->www::mygrid::org::uk::ontology::genome_location::_attr_prop( $attr_name, $prop_name ) 
            if $self->www::mygrid::org::uk::ontology::genome_location::_accessible($attr_name);
...
sub init {
    ...
    $self->www::mygrid::org::uk::ontology::genome_location::init();
    $self->type('http://www.mygrid.org.uk/ontology#single_nucleotide_polymorphism_location');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->www::mygrid::org::uk::ontology::genome_location::_get_statements();
    };
...
www::mygrid::org::uk::ontology::single_nucleotide_polymorphism_location - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::single_nucleotide_polymorphism_location;
  my $class = www::mygrid::org::uk::ontology::single_nucleotide_polymorphism_location->new();
...
L<www::mygrid::org::uk::ontology::genome_location>
