#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::EC_number
# Generated: 12-Aug-2010 09:34:51 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::EC_number;

use OWL::Data::OWL::Class;
use www::mygrid::org::uk::ontology::enzyme_record_id;
use Blank::genid4c641370d8a1;
...
@ISA = qw(
 OWL::Data::OWL::Class
 www::mygrid::org::uk::ontology::enzyme_record_id
 Blank::genid4c641370d8a1 
);
use strict;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->www::mygrid::org::uk::ontology::enzyme_record_id::_accessible($attr)
          or $self->Blank::genid4c641370d8a1::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->www::mygrid::org::uk::ontology::enzyme_record_id::_attr_prop( $attr_name, $prop_name ) 
            if $self->www::mygrid::org::uk::ontology::enzyme_record_id::_accessible($attr_name);
        return $self->Blank::genid4c641370d8a1::_attr_prop( $attr_name, $prop_name ) 
            if $self->Blank::genid4c641370d8a1::_accessible($attr_name);
...
sub init {
    ...
    $self->www::mygrid::org::uk::ontology::enzyme_record_id::init();
    $self->Blank::genid4c641370d8a1::init();
    $self->type('http://www.mygrid.org.uk/ontology#EC_number');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->www::mygrid::org::uk::ontology::enzyme_record_id::_get_statements();
    };
    eval {
    	# add parent statements
        $self->Blank::genid4c641370d8a1::_get_statements();
    };
...
www::mygrid::org::uk::ontology::EC_number - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = www::mygrid::org::uk::ontology::EC_number->new();
...
L<www::mygrid::org::uk::ontology::enzyme_record_id>
L<Blank::genid4c641370d8a1>
