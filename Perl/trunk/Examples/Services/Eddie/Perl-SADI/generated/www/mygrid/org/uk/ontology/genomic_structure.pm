#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::genomic_structure
# Generated: 12-Aug-2010 09:33:48 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::genomic_structure;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#genomic_structure');
...
www::mygrid::org::uk::ontology::genomic_structure - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::genomic_structure;
  my $class = www::mygrid::org::uk::ontology::genomic_structure->new();
