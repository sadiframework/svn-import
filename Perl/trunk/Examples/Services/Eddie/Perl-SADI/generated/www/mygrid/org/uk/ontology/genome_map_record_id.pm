...
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::genome_map_record_id;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#genome_map_record_id');
...
www::mygrid::org::uk::ontology::genome_map_record_id - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = www::mygrid::org::uk::ontology::genome_map_record_id->new();
