...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#INOH');
...
www::mygrid::org::uk::ontology::INOH - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::INOH;
  my $class = www::mygrid::org::uk::ontology::INOH->new();
