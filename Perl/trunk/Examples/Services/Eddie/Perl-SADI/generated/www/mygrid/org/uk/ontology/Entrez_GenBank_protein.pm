#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::Entrez_GenBank_protein
# Generated: 12-Aug-2010 09:34:44 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::Entrez_GenBank_protein;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#Entrez_GenBank_protein');
...
www::mygrid::org::uk::ontology::Entrez_GenBank_protein - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::Entrez_GenBank_protein;
  my $class = www::mygrid::org::uk::ontology::Entrez_GenBank_protein->new();
