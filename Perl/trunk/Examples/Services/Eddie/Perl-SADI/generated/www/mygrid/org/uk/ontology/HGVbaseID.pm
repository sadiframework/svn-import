...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#HGVbaseID');
...
www::mygrid::org::uk::ontology::HGVbaseID - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::HGVbaseID;
  my $class = www::mygrid::org::uk::ontology::HGVbaseID->new();
