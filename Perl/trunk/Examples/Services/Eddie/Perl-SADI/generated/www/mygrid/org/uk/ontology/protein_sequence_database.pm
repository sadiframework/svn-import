...
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::protein_sequence_database;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#protein_sequence_database');
...
www::mygrid::org::uk::ontology::protein_sequence_database - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = www::mygrid::org::uk::ontology::protein_sequence_database->new();
