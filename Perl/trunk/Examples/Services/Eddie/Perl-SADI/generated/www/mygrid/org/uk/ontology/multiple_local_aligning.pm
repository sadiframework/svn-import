...
# Generated: 12-Aug-2010 09:35:29 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::multiple_local_aligning;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#multiple_local_aligning');
...
www::mygrid::org::uk::ontology::multiple_local_aligning - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::multiple_local_aligning;
  my $class = www::mygrid::org::uk::ontology::multiple_local_aligning->new();
