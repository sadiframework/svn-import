...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#UMLS');
...
www::mygrid::org::uk::ontology::UMLS - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::UMLS;
  my $class = www::mygrid::org::uk::ontology::UMLS->new();
