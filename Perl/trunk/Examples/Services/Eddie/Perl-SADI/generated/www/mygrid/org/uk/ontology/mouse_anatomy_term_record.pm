...
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::mouse_anatomy_term_record;

use OWL::Data::OWL::Class;
use www::mygrid::org::uk::ontology::anatomy_term_record;
...
@ISA = qw(
 OWL::Data::OWL::Class
 www::mygrid::org::uk::ontology::anatomy_term_record 
);
use strict;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->www::mygrid::org::uk::ontology::anatomy_term_record::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->www::mygrid::org::uk::ontology::anatomy_term_record::_attr_prop( $attr_name, $prop_name ) 
            if $self->www::mygrid::org::uk::ontology::anatomy_term_record::_accessible($attr_name);
...
sub init {
    ...
    $self->www::mygrid::org::uk::ontology::anatomy_term_record::init();
    $self->type('http://www.mygrid.org.uk/ontology#mouse_anatomy_term_record');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->www::mygrid::org::uk::ontology::anatomy_term_record::_get_statements();
    };
...
www::mygrid::org::uk::ontology::mouse_anatomy_term_record - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = www::mygrid::org::uk::ontology::mouse_anatomy_term_record->new();
...
L<www::mygrid::org::uk::ontology::anatomy_term_record>
