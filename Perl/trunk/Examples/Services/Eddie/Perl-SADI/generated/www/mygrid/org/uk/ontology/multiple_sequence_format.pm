...
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::multiple_sequence_format;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->www::mygrid::org::uk::ontology::sequence_file_formats::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->www::mygrid::org::uk::ontology::sequence_file_formats::_attr_prop( $attr_name, $prop_name ) 
            if $self->www::mygrid::org::uk::ontology::sequence_file_formats::_accessible($attr_name);
...
sub init {
    ...
    $self->www::mygrid::org::uk::ontology::sequence_file_formats::init();
    $self->type('http://www.mygrid.org.uk/ontology#multiple_sequence_format');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->www::mygrid::org::uk::ontology::sequence_file_formats::_get_statements();
    };
...
www::mygrid::org::uk::ontology::multiple_sequence_format - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = www::mygrid::org::uk::ontology::multiple_sequence_format->new();
...
L<www::mygrid::org::uk::ontology::sequence_file_formats>
