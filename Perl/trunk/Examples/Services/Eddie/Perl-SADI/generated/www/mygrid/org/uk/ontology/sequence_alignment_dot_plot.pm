#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::sequence_alignment_dot_plot
# Generated: 12-Aug-2010 09:33:56 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::sequence_alignment_dot_plot;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#sequence_alignment_dot_plot');
...
www::mygrid::org::uk::ontology::sequence_alignment_dot_plot - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::sequence_alignment_dot_plot;
  my $class = www::mygrid::org::uk::ontology::sequence_alignment_dot_plot->new();
