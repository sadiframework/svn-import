...
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::DNA_sequence;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->www::mygrid::org::uk::ontology::nucleotide_sequence::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->www::mygrid::org::uk::ontology::nucleotide_sequence::_attr_prop( $attr_name, $prop_name ) 
            if $self->www::mygrid::org::uk::ontology::nucleotide_sequence::_accessible($attr_name);
...
sub init {
    ...
    $self->www::mygrid::org::uk::ontology::nucleotide_sequence::init();
    $self->type('http://www.mygrid.org.uk/ontology#DNA_sequence');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->www::mygrid::org::uk::ontology::nucleotide_sequence::_get_statements();
    };
...
www::mygrid::org::uk::ontology::DNA_sequence - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = www::mygrid::org::uk::ontology::DNA_sequence->new();
...
L<www::mygrid::org::uk::ontology::nucleotide_sequence>
