#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::UniProt_accession
# Generated: 12-Aug-2010 09:34:41 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::UniProt_accession;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#UniProt_accession');
...
www::mygrid::org::uk::ontology::UniProt_accession - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = www::mygrid::org::uk::ontology::UniProt_accession->new();
