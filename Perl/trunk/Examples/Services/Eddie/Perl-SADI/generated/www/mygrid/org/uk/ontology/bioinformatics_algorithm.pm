...
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::bioinformatics_algorithm;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#bioinformatics_algorithm');
...
www::mygrid::org::uk::ontology::bioinformatics_algorithm - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = www::mygrid::org::uk::ontology::bioinformatics_algorithm->new();
