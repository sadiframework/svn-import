#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::PIR_accession
# Generated: 12-Aug-2010 09:34:52 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::PIR_accession;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#PIR_accession');
...
www::mygrid::org::uk::ontology::PIR_accession - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::PIR_accession;
  my $class = www::mygrid::org::uk::ontology::PIR_accession->new();
