#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::genotype_phenotype_database
# Generated: 12-Aug-2010 09:33:49 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::genotype_phenotype_database;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#genotype-phenotype_database');
...
www::mygrid::org::uk::ontology::genotype_phenotype_database - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::genotype_phenotype_database;
  my $class = www::mygrid::org::uk::ontology::genotype_phenotype_database->new();
