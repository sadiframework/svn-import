...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#HGNC');
...
www::mygrid::org::uk::ontology::HGNC - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::HGNC;
  my $class = www::mygrid::org::uk::ontology::HGNC->new();
