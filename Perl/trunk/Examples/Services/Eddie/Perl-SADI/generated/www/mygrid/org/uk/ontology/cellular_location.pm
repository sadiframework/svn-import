#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::cellular_location
# Generated: 12-Aug-2010 09:34:52 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::cellular_location;

use OWL::Data::OWL::Class;
use www::mygrid::org::uk::ontology::biological_location;
...
@ISA = qw(
 OWL::Data::OWL::Class
 www::mygrid::org::uk::ontology::biological_location 
);
use strict;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->www::mygrid::org::uk::ontology::biological_location::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->www::mygrid::org::uk::ontology::biological_location::_attr_prop( $attr_name, $prop_name ) 
            if $self->www::mygrid::org::uk::ontology::biological_location::_accessible($attr_name);
...
sub init {
    ...
    $self->www::mygrid::org::uk::ontology::biological_location::init();
    $self->type('http://www.mygrid.org.uk/ontology#cellular_location');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->www::mygrid::org::uk::ontology::biological_location::_get_statements();
    };
...
www::mygrid::org::uk::ontology::cellular_location - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::cellular_location;
  my $class = www::mygrid::org::uk::ontology::cellular_location->new();
...
L<www::mygrid::org::uk::ontology::biological_location>
