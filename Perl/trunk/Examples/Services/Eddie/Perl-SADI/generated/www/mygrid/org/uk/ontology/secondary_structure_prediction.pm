#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::secondary_structure_prediction
# Generated: 12-Aug-2010 09:33:42 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::secondary_structure_prediction;

use OWL::Data::OWL::Class;
use www::mygrid::org::uk::ontology::protein_structure_model;
...
@ISA = qw(
 OWL::Data::OWL::Class
 www::mygrid::org::uk::ontology::protein_structure_model 
);
use strict;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->www::mygrid::org::uk::ontology::protein_structure_model::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->www::mygrid::org::uk::ontology::protein_structure_model::_attr_prop( $attr_name, $prop_name ) 
            if $self->www::mygrid::org::uk::ontology::protein_structure_model::_accessible($attr_name);
...
sub init {
    ...
    $self->www::mygrid::org::uk::ontology::protein_structure_model::init();
    $self->type('http://www.mygrid.org.uk/ontology#secondary_structure_prediction');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->www::mygrid::org::uk::ontology::protein_structure_model::_get_statements();
    };
...
www::mygrid::org::uk::ontology::secondary_structure_prediction - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::secondary_structure_prediction;
  my $class = www::mygrid::org::uk::ontology::secondary_structure_prediction->new();
...
L<www::mygrid::org::uk::ontology::protein_structure_model>
