...
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::protein_interaction_record;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#protein_interaction_record');
...
www::mygrid::org::uk::ontology::protein_interaction_record - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = www::mygrid::org::uk::ontology::protein_interaction_record->new();
