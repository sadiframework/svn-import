#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::Gene_ontology_GO
# Generated: 12-Aug-2010 09:34:41 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::Gene_ontology_GO;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#Gene_ontology_GO');
...
www::mygrid::org::uk::ontology::Gene_ontology_GO - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::Gene_ontology_GO;
  my $class = www::mygrid::org::uk::ontology::Gene_ontology_GO->new();
