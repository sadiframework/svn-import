...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#removing');
...
www::mygrid::org::uk::ontology::removing - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::removing;
  my $class = www::mygrid::org::uk::ontology::removing->new();
