...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#SGD_id');
...
www::mygrid::org::uk::ontology::SGD_id - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::SGD_id;
  my $class = www::mygrid::org::uk::ontology::SGD_id->new();
