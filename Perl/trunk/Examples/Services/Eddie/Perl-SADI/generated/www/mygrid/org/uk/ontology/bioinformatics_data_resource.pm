...
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::bioinformatics_data_resource;

use OWL::Data::OWL::Class;
use www::mygrid::org::uk::ontology::bioinformatics_concept;
...
@ISA = qw(
 OWL::Data::OWL::Class
 www::mygrid::org::uk::ontology::bioinformatics_concept 
);
use strict;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->www::mygrid::org::uk::ontology::bioinformatics_concept::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->www::mygrid::org::uk::ontology::bioinformatics_concept::_attr_prop( $attr_name, $prop_name ) 
            if $self->www::mygrid::org::uk::ontology::bioinformatics_concept::_accessible($attr_name);
...
sub init {
    ...
    $self->www::mygrid::org::uk::ontology::bioinformatics_concept::init();
    $self->type('http://www.mygrid.org.uk/ontology#bioinformatics_data_resource');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->www::mygrid::org::uk::ontology::bioinformatics_concept::_get_statements();
    };
...
www::mygrid::org::uk::ontology::bioinformatics_data_resource - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = www::mygrid::org::uk::ontology::bioinformatics_data_resource->new();
...
L<www::mygrid::org::uk::ontology::bioinformatics_concept>
