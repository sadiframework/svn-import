...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#PRINTS');
...
www::mygrid::org::uk::ontology::PRINTS - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::PRINTS;
  my $class = www::mygrid::org::uk::ontology::PRINTS->new();
