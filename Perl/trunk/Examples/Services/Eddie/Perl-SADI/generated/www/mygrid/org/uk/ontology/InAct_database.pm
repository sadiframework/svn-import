#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::InAct_database
# Generated: 12-Aug-2010 09:34:22 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::InAct_database;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#InAct_database');
...
www::mygrid::org::uk::ontology::InAct_database - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::InAct_database;
  my $class = www::mygrid::org::uk::ontology::InAct_database->new();
