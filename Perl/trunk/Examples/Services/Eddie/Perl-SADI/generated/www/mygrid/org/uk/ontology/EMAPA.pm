...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#EMAPA');
...
www::mygrid::org::uk::ontology::EMAPA - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::EMAPA;
  my $class = www::mygrid::org::uk::ontology::EMAPA->new();
