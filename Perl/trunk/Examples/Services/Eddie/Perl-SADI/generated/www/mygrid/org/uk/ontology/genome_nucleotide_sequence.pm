#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::genome_nucleotide_sequence
# Generated: 12-Aug-2010 09:34:45 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::genome_nucleotide_sequence;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#genome_nucleotide_sequence');
...
www::mygrid::org::uk::ontology::genome_nucleotide_sequence - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::genome_nucleotide_sequence;
  my $class = www::mygrid::org::uk::ontology::genome_nucleotide_sequence->new();
