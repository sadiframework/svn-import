#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::single_nucleotide_polymorphism
# Generated: 12-Aug-2010 09:34:18 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::single_nucleotide_polymorphism;

use OWL::Data::OWL::Class;
use www::mygrid::org::uk::ontology::DNA_sequence;
...
@ISA = qw(
 OWL::Data::OWL::Class
 www::mygrid::org::uk::ontology::DNA_sequence 
);
use strict;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->www::mygrid::org::uk::ontology::DNA_sequence::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->www::mygrid::org::uk::ontology::DNA_sequence::_attr_prop( $attr_name, $prop_name ) 
            if $self->www::mygrid::org::uk::ontology::DNA_sequence::_accessible($attr_name);
...
sub init {
    ...
    $self->www::mygrid::org::uk::ontology::DNA_sequence::init();
    $self->type('http://www.mygrid.org.uk/ontology#single_nucleotide_polymorphism');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->www::mygrid::org::uk::ontology::DNA_sequence::_get_statements();
    };
...
www::mygrid::org::uk::ontology::single_nucleotide_polymorphism - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::single_nucleotide_polymorphism;
  my $class = www::mygrid::org::uk::ontology::single_nucleotide_polymorphism->new();
...
L<www::mygrid::org::uk::ontology::DNA_sequence>
