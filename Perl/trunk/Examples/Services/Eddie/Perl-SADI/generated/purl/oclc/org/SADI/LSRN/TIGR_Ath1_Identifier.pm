#-----------------------------------------------------------------
# purl::oclc::org::SADI::LSRN::TIGR_Ath1_Identifier
# Generated: 12-Aug-2010 09:34:03 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package purl::oclc::org::SADI::LSRN::TIGR_Ath1_Identifier;
...
sub init {
    ...
    $self->type('http://purl.oclc.org/SADI/LSRN/TIGR_Ath1_Identifier');
...
purl::oclc::org::SADI::LSRN::TIGR_Ath1_Identifier - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use purl::oclc::org::SADI::LSRN::TIGR_Ath1_Identifier;
  my $class = purl::oclc::org::SADI::LSRN::TIGR_Ath1_Identifier->new();
