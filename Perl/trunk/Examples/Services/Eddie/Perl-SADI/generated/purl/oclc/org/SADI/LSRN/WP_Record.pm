...
sub init {
    ...
    $self->type('http://purl.oclc.org/SADI/LSRN/WP_Record');
...
purl::oclc::org::SADI::LSRN::WP_Record - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use purl::oclc::org::SADI::LSRN::WP_Record;
  my $class = purl::oclc::org::SADI::LSRN::WP_Record->new();
