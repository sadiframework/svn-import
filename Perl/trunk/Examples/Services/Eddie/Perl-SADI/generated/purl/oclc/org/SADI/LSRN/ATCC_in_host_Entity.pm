#-----------------------------------------------------------------
# purl::oclc::org::SADI::LSRN::ATCC_in_host_Entity
# Generated: 12-Aug-2010 09:34:21 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package purl::oclc::org::SADI::LSRN::ATCC_in_host_Entity;
...
sub init {
    ...
    $self->type('http://purl.oclc.org/SADI/LSRN/ATCC_in-host_Entity');
...
purl::oclc::org::SADI::LSRN::ATCC_in_host_Entity - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use purl::oclc::org::SADI::LSRN::ATCC_in_host_Entity;
  my $class = purl::oclc::org::SADI::LSRN::ATCC_in_host_Entity->new();
