...
sub init {
    ...
    $self->type('http://purl.oclc.org/SADI/LSRN/ASAP_Entity');
...
purl::oclc::org::SADI::LSRN::ASAP_Entity - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use purl::oclc::org::SADI::LSRN::ASAP_Entity;
  my $class = purl::oclc::org::SADI::LSRN::ASAP_Entity->new();
