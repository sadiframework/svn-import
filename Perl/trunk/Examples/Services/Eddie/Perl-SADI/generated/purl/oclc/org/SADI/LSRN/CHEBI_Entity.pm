...
sub init {
    ...
    $self->type('http://purl.oclc.org/SADI/LSRN/CHEBI_Entity');
...
purl::oclc::org::SADI::LSRN::CHEBI_Entity - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use purl::oclc::org::SADI::LSRN::CHEBI_Entity;
  my $class = purl::oclc::org::SADI::LSRN::CHEBI_Entity->new();
