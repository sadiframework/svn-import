...
sub init {
    ...
    $self->type('http://purl.oclc.org/SADI/LSRN/CGEN_Record');
...
purl::oclc::org::SADI::LSRN::CGEN_Record - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use purl::oclc::org::SADI::LSRN::CGEN_Record;
  my $class = purl::oclc::org::SADI::LSRN::CGEN_Record->new();
