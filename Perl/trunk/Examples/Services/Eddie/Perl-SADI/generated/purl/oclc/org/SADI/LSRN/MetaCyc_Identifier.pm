#-----------------------------------------------------------------
# purl::oclc::org::SADI::LSRN::MetaCyc_Identifier
# Generated: 12-Aug-2010 09:34:06 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package purl::oclc::org::SADI::LSRN::MetaCyc_Identifier;
...
sub init {
    ...
    $self->type('http://purl.oclc.org/SADI/LSRN/MetaCyc_Identifier');
...
purl::oclc::org::SADI::LSRN::MetaCyc_Identifier - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use purl::oclc::org::SADI::LSRN::MetaCyc_Identifier;
  my $class = purl::oclc::org::SADI::LSRN::MetaCyc_Identifier->new();
