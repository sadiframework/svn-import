#-----------------------------------------------------------------
# purl::oclc::org::SADI::LSRN::H_invDB_locus_Identifier
# Generated: 12-Aug-2010 09:34:27 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package purl::oclc::org::SADI::LSRN::H_invDB_locus_Identifier;
...
sub init {
    ...
    $self->type('http://purl.oclc.org/SADI/LSRN/H-invDB_locus_Identifier');
...
purl::oclc::org::SADI::LSRN::H_invDB_locus_Identifier - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use purl::oclc::org::SADI::LSRN::H_invDB_locus_Identifier;
  my $class = purl::oclc::org::SADI::LSRN::H_invDB_locus_Identifier->new();
