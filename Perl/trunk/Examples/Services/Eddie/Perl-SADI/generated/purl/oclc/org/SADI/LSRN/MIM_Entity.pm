...
sub init {
    ...
    $self->type('http://purl.oclc.org/SADI/LSRN/MIM_Entity');
...
purl::oclc::org::SADI::LSRN::MIM_Entity - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use purl::oclc::org::SADI::LSRN::MIM_Entity;
  my $class = purl::oclc::org::SADI::LSRN::MIM_Entity->new();
