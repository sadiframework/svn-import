...
sub init {
    ...
    $self->type('http://purl.oclc.org/SADI/LSRN/PMID_Record');
...
purl::oclc::org::SADI::LSRN::PMID_Record - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = purl::oclc::org::SADI::LSRN::PMID_Record->new();
