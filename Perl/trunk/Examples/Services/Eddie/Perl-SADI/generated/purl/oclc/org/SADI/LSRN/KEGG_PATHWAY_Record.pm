...
#-----------------------------------------------------------------
package purl::oclc::org::SADI::LSRN::KEGG_PATHWAY_Record;
...
sub init {
    ...
    $self->type('http://purl.oclc.org/SADI/LSRN/KEGG_PATHWAY_Record');
...
purl::oclc::org::SADI::LSRN::KEGG_PATHWAY_Record - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = purl::oclc::org::SADI::LSRN::KEGG_PATHWAY_Record->new();
