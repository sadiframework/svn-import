...
sub init {
    ...
    $self->type('http://purl.oclc.org/SADI/LSRN/RGD_Record');
...
purl::oclc::org::SADI::LSRN::RGD_Record - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use purl::oclc::org::SADI::LSRN::RGD_Record;
  my $class = purl::oclc::org::SADI::LSRN::RGD_Record->new();
