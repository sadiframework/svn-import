#-----------------------------------------------------------------
# purl::oclc::org::SADI::LSRN::ATCC_in_host_Identifier
# Generated: 12-Aug-2010 09:35:17 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package purl::oclc::org::SADI::LSRN::ATCC_in_host_Identifier;
...
sub init {
    ...
    $self->type('http://purl.oclc.org/SADI/LSRN/ATCC_in-host_Identifier');
...
purl::oclc::org::SADI::LSRN::ATCC_in_host_Identifier - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use purl::oclc::org::SADI::LSRN::ATCC_in_host_Identifier;
  my $class = purl::oclc::org::SADI::LSRN::ATCC_in_host_Identifier->new();
