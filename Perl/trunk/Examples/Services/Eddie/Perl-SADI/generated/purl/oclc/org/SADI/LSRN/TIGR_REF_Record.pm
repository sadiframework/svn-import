#-----------------------------------------------------------------
# purl::oclc::org::SADI::LSRN::TIGR_REF_Record
# Generated: 12-Aug-2010 09:34:40 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package purl::oclc::org::SADI::LSRN::TIGR_REF_Record;
...
sub init {
    ...
    $self->type('http://purl.oclc.org/SADI/LSRN/TIGR_REF_Record');
...
purl::oclc::org::SADI::LSRN::TIGR_REF_Record - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use purl::oclc::org::SADI::LSRN::TIGR_REF_Record;
  my $class = purl::oclc::org::SADI::LSRN::TIGR_REF_Record->new();
