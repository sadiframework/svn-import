#-----------------------------------------------------------------
# purl::oclc::org::SADI::LSRN::dbSTS_Identifier
# Generated: 12-Aug-2010 09:35:26 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package purl::oclc::org::SADI::LSRN::dbSTS_Identifier;
...
sub init {
    ...
    $self->type('http://purl.oclc.org/SADI/LSRN/dbSTS_Identifier');
...
purl::oclc::org::SADI::LSRN::dbSTS_Identifier - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use purl::oclc::org::SADI::LSRN::dbSTS_Identifier;
  my $class = purl::oclc::org::SADI::LSRN::dbSTS_Identifier->new();
