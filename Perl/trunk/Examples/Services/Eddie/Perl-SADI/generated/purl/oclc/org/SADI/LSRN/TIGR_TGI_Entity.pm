#-----------------------------------------------------------------
# purl::oclc::org::SADI::LSRN::TIGR_TGI_Entity
# Generated: 12-Aug-2010 09:34:06 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package purl::oclc::org::SADI::LSRN::TIGR_TGI_Entity;
...
sub init {
    ...
    $self->type('http://purl.oclc.org/SADI/LSRN/TIGR_TGI_Entity');
...
purl::oclc::org::SADI::LSRN::TIGR_TGI_Entity - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use purl::oclc::org::SADI::LSRN::TIGR_TGI_Entity;
  my $class = purl::oclc::org::SADI::LSRN::TIGR_TGI_Entity->new();
