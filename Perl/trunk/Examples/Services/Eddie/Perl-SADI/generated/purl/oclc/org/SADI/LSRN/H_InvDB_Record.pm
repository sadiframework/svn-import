...
sub init {
    ...
    $self->type('http://purl.oclc.org/SADI/LSRN/H-InvDB_Record');
...
purl::oclc::org::SADI::LSRN::H_InvDB_Record - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use purl::oclc::org::SADI::LSRN::H_InvDB_Record;
  my $class = purl::oclc::org::SADI::LSRN::H_InvDB_Record->new();
