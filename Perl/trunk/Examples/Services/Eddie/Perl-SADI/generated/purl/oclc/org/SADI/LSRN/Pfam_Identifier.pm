#-----------------------------------------------------------------
# purl::oclc::org::SADI::LSRN::Pfam_Identifier
# Generated: 12-Aug-2010 09:34:06 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package purl::oclc::org::SADI::LSRN::Pfam_Identifier;
...
sub init {
    ...
    $self->type('http://purl.oclc.org/SADI/LSRN/Pfam_Identifier');
...
purl::oclc::org::SADI::LSRN::Pfam_Identifier - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = purl::oclc::org::SADI::LSRN::Pfam_Identifier->new();
