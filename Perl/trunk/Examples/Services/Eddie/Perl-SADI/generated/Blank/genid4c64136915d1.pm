#-----------------------------------------------------------------
# Blank::genid4c64136915d1
# Generated: 12-Aug-2010 09:33:56 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package Blank::genid4c64136915d1;

use OWL::Data::OWL::Class;
use semanticscience::org::resource::SIO_000269;
use semanticscience::org::resource::SIO_000270;
...
@ISA = qw(
 OWL::Data::OWL::Class
 semanticscience::org::resource::SIO_000269
 semanticscience::org::resource::SIO_000270 
);
use strict;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->semanticscience::org::resource::SIO_000269::_accessible($attr)
          or $self->semanticscience::org::resource::SIO_000270::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->semanticscience::org::resource::SIO_000269::_attr_prop( $attr_name, $prop_name ) 
            if $self->semanticscience::org::resource::SIO_000269::_accessible($attr_name);
        return $self->semanticscience::org::resource::SIO_000270::_attr_prop( $attr_name, $prop_name ) 
            if $self->semanticscience::org::resource::SIO_000270::_accessible($attr_name);
...
sub init {
    ...
    $self->semanticscience::org::resource::SIO_000269::init();
    $self->semanticscience::org::resource::SIO_000270::init();
    $self->type('_:genid4c64136915d1');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->semanticscience::org::resource::SIO_000269::_get_statements();
    };
    eval {
    	# add parent statements
        $self->semanticscience::org::resource::SIO_000270::_get_statements();
    };
...
Blank::genid4c64136915d1 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use Blank::genid4c64136915d1;
  my $class = Blank::genid4c64136915d1->new();
...
L<semanticscience::org::resource::SIO_000269>
L<semanticscience::org::resource::SIO_000270>
