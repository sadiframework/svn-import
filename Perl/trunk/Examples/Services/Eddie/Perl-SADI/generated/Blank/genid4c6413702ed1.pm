...
#-----------------------------------------------------------------
package Blank::genid4c6413702ed1;
...
Blank::genid4c6413702ed1 - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = Blank::genid4c6413702ed1->new();

  # get the uri for this class
  my $uri = $class->uri;
  # add object properties 
  use www::mygrid::org::uk::ontology::genbank_GI;
  # add a has_identifier property (www::mygrid::org::uk::ontology::genbank_GI)
  $class->add_has_identifier(new www::mygrid::org::uk::ontology::genbank_GI());
  ...
  # add a produced_by property (www::mygrid::org::uk::ontology::Genbank_nucleotide_sequence_database)
  $class->add_produced_by(new www::mygrid::org::uk::ontology::Genbank_nucleotide_sequence_database());
