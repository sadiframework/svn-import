...
#-----------------------------------------------------------------
package Blank::genid4c6413713a5e;
...
Blank::genid4c6413713a5e - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = Blank::genid4c6413713a5e->new();

  # get the uri for this class
  my $uri = $class->uri;
  # add object properties 
  use www::mygrid::org::uk::ontology::protein_sequence;
  # add a has_part property (www::mygrid::org::uk::ontology::protein_sequence)
  $class->add_has_part(new www::mygrid::org::uk::ontology::protein_sequence());
  # get the has_part object properties
  my $has_part_objects = $class->has_part;
  use www::mygrid::org::uk::ontology::protein_sequence_id;
  # add a has_identifier property (www::mygrid::org::uk::ontology::protein_sequence_id)
  $class->add_has_identifier(new www::mygrid::org::uk::ontology::protein_sequence_id());
