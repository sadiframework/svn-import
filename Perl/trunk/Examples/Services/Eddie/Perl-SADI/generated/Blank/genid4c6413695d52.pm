...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->Blank::genid4c6413693fa6::_accessible($attr)
    ...
    sub _attr_prop {
        ...
        return $self->Blank::genid4c6413693fa6::_attr_prop( $attr_name, $prop_name ) 
            if $self->Blank::genid4c6413693fa6::_accessible($attr_name);
...
sub init {
    ...
    $self->Blank::genid4c6413693fa6::init();
    $self->semanticscience::org::resource::SIO_000014::init();
    $self->type('_:genid4c6413695d52');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->Blank::genid4c6413693fa6::_get_statements();
    };
    eval {
    	# add parent statements
...
Blank::genid4c6413695d52 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use Blank::genid4c6413695d52;
  my $class = Blank::genid4c6413695d52->new();
