...
#-----------------------------------------------------------------
package Blank::genid4c641370099c;
...
Blank::genid4c641370099c - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = Blank::genid4c641370099c->new();

  # get the uri for this class
  my $uri = $class->uri;
  # add object properties 
  use www::mygrid::org::uk::ontology::MEDLINE_reference_id;
  # add a has_identifier property (www::mygrid::org::uk::ontology::MEDLINE_reference_id)
  $class->add_has_identifier(new www::mygrid::org::uk::ontology::MEDLINE_reference_id());
  ...
  # add a produced_by property (www::mygrid::org::uk::ontology::MEDLINE)
  $class->add_produced_by(new www::mygrid::org::uk::ontology::MEDLINE());
