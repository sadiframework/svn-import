...
#-----------------------------------------------------------------
package Blank::genid4c64136926e7;

use OWL::Data::OWL::Class;
use semanticscience::org::resource::SIO_000456;
use semanticscience::org::resource::SIO_000457;
...
@ISA = qw(
 OWL::Data::OWL::Class
 semanticscience::org::resource::SIO_000456
 semanticscience::org::resource::SIO_000457 
);
use strict;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->semanticscience::org::resource::SIO_000456::_accessible($attr)
          or $self->semanticscience::org::resource::SIO_000457::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->semanticscience::org::resource::SIO_000456::_attr_prop( $attr_name, $prop_name ) 
            if $self->semanticscience::org::resource::SIO_000456::_accessible($attr_name);
        return $self->semanticscience::org::resource::SIO_000457::_attr_prop( $attr_name, $prop_name ) 
            if $self->semanticscience::org::resource::SIO_000457::_accessible($attr_name);
...
sub init {
    ...
    $self->semanticscience::org::resource::SIO_000456::init();
    $self->semanticscience::org::resource::SIO_000457::init();
    $self->type('_:genid4c64136926e7');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->semanticscience::org::resource::SIO_000456::_get_statements();
    };
    eval {
    	# add parent statements
        $self->semanticscience::org::resource::SIO_000457::_get_statements();
    };
...
Blank::genid4c64136926e7 - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = Blank::genid4c64136926e7->new();
...
L<semanticscience::org::resource::SIO_000456>
L<semanticscience::org::resource::SIO_000457>
