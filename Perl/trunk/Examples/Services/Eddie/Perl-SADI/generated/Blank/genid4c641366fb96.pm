...
#-----------------------------------------------------------------
package Blank::genid4c641366fb96;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->Blank::genid4c641366edea::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->Blank::genid4c641366edea::_attr_prop( $attr_name, $prop_name ) 
            if $self->Blank::genid4c641366edea::_accessible($attr_name);
...
sub init {
    ...
    $self->Blank::genid4c641366edea::init();
    $self->type('_:genid4c641366fb96');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->Blank::genid4c641366edea::_get_statements();
    };
...
Blank::genid4c641366fb96 - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = Blank::genid4c641366fb96->new();

  # get the uri for this class
  my $uri = $class->uri;
  # add object properties 
  use Blank::genid4c641366b9b7;
  # add a SIO_000225 property (Blank::genid4c641366b9b7)
  $class->add_SIO_000225(new Blank::genid4c641366b9b7());
