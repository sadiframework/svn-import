...
use semanticscience::org::resource::SIO_000283;
    ...
    my %_allowed = (
        ...
        SIO_000283 => {
        	...
        	post => sub {
                ...
                my $type = @{$self->SIO_000283}[-1] if defined $self->SIO_000283;
                return unless defined $type and $type->type;
                my $range = new semanticscience::org::resource::SIO_000283->range();
                return unless $range;
...
sub _get_statements {
    ...
    if (defined $self->SIO_000283){
	    foreach (@{$self->SIO_000283}) {
	        ...
	        $self->model->addStmt(
	          new RDF::Core::Statement(
	              $subject,
	              $subject->new('http://semanticscience.org/resource/SIO_000283'), 
...
Blank::genid4c6413694356 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use Blank::genid4c6413694356;
  my $class = Blank::genid4c6413694356->new();

  # get the uri for this class
  my $uri = $class->uri;
  # add object properties 
  use semanticscience::org::resource::SIO_000275;
  # add a SIO_000283 property (semanticscience::org::resource::SIO_000275)
  $class->add_SIO_000283(new semanticscience::org::resource::SIO_000275());
  # get the SIO_000283 object properties
  my $SIO_000283_objects = $class->SIO_000283;
