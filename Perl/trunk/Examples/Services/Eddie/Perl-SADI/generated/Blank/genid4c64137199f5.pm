...
#-----------------------------------------------------------------
package Blank::genid4c64137199f5;
...
Blank::genid4c64137199f5 - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = Blank::genid4c64137199f5->new();

  # get the uri for this class
  my $uri = $class->uri;
  # add object properties 
  use www::mygrid::org::uk::ontology::Unigene;
  # add a produced_by property (www::mygrid::org::uk::ontology::Unigene)
  $class->add_produced_by(new www::mygrid::org::uk::ontology::Unigene());
  # get the produced_by object properties
  my $produced_by_objects = $class->produced_by;
  use www::mygrid::org::uk::ontology::UniGene_id;
  # add a has_identifier property (www::mygrid::org::uk::ontology::UniGene_id)
  $class->add_has_identifier(new www::mygrid::org::uk::ontology::UniGene_id());
