#-----------------------------------------------------------------
# Blank::genid4c64136654f2
# Generated: 12-Aug-2010 09:34:01 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package Blank::genid4c64136654f2;

use OWL::Data::OWL::Class;
use semanticscience::org::resource::SIO_010366;
...
@ISA = qw(
 OWL::Data::OWL::Class
 semanticscience::org::resource::SIO_010366 
);
use strict;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->semanticscience::org::resource::SIO_010366::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->semanticscience::org::resource::SIO_010366::_attr_prop( $attr_name, $prop_name ) 
            if $self->semanticscience::org::resource::SIO_010366::_accessible($attr_name);
...
sub init {
    ...
    $self->semanticscience::org::resource::SIO_010366::init();
    $self->type('_:genid4c64136654f2');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->semanticscience::org::resource::SIO_010366::_get_statements();
    };
...
Blank::genid4c64136654f2 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use Blank::genid4c64136654f2;
  my $class = Blank::genid4c64136654f2->new();
...
L<semanticscience::org::resource::SIO_010366>
