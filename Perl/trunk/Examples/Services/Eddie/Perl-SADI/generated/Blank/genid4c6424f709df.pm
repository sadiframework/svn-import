#-----------------------------------------------------------------
# Blank::genid4c6424f709df
# Generated: 12-Aug-2010 09:44:40 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package Blank::genid4c6424f709df;
...
@ISA = qw(
 OWL::Data::OWL::Class
 purl::oclc::org::SADI::LSRN::KEGG_PATHWAY_Record 
);
use strict;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->purl::oclc::org::SADI::LSRN::KEGG_PATHWAY_Record::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->purl::oclc::org::SADI::LSRN::KEGG_PATHWAY_Record::_attr_prop( $attr_name, $prop_name ) 
            if $self->purl::oclc::org::SADI::LSRN::KEGG_PATHWAY_Record::_accessible($attr_name);
...
sub init {
    ...
    $self->purl::oclc::org::SADI::LSRN::KEGG_PATHWAY_Record::init();
    $self->type('_:genid4c6424f709df');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->purl::oclc::org::SADI::LSRN::KEGG_PATHWAY_Record::_get_statements();
    };
...
Blank::genid4c6424f709df - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use Blank::genid4c6424f709df;
  my $class = Blank::genid4c6424f709df->new();

  # get the uri for this class
  my $uri = $class->uri;
  # add object properties 
  use purl::oclc::org::SADI::LSRN::PMID_Record;
  # add a SIO_000253 property (purl::oclc::org::SADI::LSRN::PMID_Record)
  $class->add_SIO_000253(new purl::oclc::org::SADI::LSRN::PMID_Record());
...
L<purl::oclc::org::SADI::LSRN::KEGG_PATHWAY_Record>
