...
@ISA = qw(
 OWL::Data::OWL::Class
 semanticscience::org::resource::SIO_010358 
);
use strict;
...
use semanticscience::org::resource::SIO_000236;
...

{
    my %_allowed = (
        ...
        SIO_000236 => {
        	...
        	post => sub {
                ...
                my $type = @{$self->SIO_000236}[-1] if defined $self->SIO_000236;
                return unless defined $type and $type->type;
                my $range = new semanticscience::org::resource::SIO_000236->range();
                return unless $range;
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->semanticscience::org::resource::SIO_010358::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->semanticscience::org::resource::SIO_010358::_attr_prop( $attr_name, $prop_name ) 
            if $self->semanticscience::org::resource::SIO_010358::_accessible($attr_name);
...
sub init {
    ...
    $self->semanticscience::org::resource::SIO_010358::init();
    $self->type('_:genid4c6413669beb');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->semanticscience::org::resource::SIO_010358::_get_statements();
    };

    # for each attribute, if is array do:
    if (defined $self->SIO_000236){
	    foreach (@{$self->SIO_000236}) {
	        ...
	        $self->model->addStmt(
	          new RDF::Core::Statement(
	              $subject,
	              $subject->new('http://semanticscience.org/resource/SIO_000236'), 
...
Blank::genid4c6413669beb - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use Blank::genid4c6413669beb;
  my $class = Blank::genid4c6413669beb->new();

  # get the uri for this class
  my $uri = $class->uri;
  # add object properties 
  use semanticscience::org::resource::SIO_011125;
  # add a SIO_000236 property (semanticscience::org::resource::SIO_011125)
  $class->add_SIO_000236(new semanticscience::org::resource::SIO_011125());
  # get the SIO_000236 object properties
  my $SIO_000236_objects = $class->SIO_000236;
...
L<semanticscience::org::resource::SIO_010358>
