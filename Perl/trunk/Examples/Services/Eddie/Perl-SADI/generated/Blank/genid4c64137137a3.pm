...
#-----------------------------------------------------------------
package Blank::genid4c64137137a3;
...
Blank::genid4c64137137a3 - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = Blank::genid4c64137137a3->new();

  # get the uri for this class
  my $uri = $class->uri;
  # add object properties 
  use www::mygrid::org::uk::ontology::dbEST_accession;
  # add a has_identifier property (www::mygrid::org::uk::ontology::dbEST_accession)
  $class->add_has_identifier(new www::mygrid::org::uk::ontology::dbEST_accession());
  ...
  # add a has_part property (www::mygrid::org::uk::ontology::expressed_sequence_tag)
  $class->add_has_part(new www::mygrid::org::uk::ontology::expressed_sequence_tag());
