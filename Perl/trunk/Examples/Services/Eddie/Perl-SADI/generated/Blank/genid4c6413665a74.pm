#-----------------------------------------------------------------
# Blank::genid4c6413665a74
# Generated: 12-Aug-2010 09:33:56 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package Blank::genid4c6413665a74;

use OWL::Data::OWL::Class;
use semanticscience::org::resource::SIO_010782;
use semanticscience::org::resource::SIO_010783;
...
@ISA = qw(
 OWL::Data::OWL::Class
 semanticscience::org::resource::SIO_010782
 semanticscience::org::resource::SIO_010783 
);
use strict;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->semanticscience::org::resource::SIO_010782::_accessible($attr)
          or $self->semanticscience::org::resource::SIO_010783::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->semanticscience::org::resource::SIO_010782::_attr_prop( $attr_name, $prop_name ) 
            if $self->semanticscience::org::resource::SIO_010782::_accessible($attr_name);
        return $self->semanticscience::org::resource::SIO_010783::_attr_prop( $attr_name, $prop_name ) 
            if $self->semanticscience::org::resource::SIO_010783::_accessible($attr_name);
...
sub init {
    ...
    $self->semanticscience::org::resource::SIO_010782::init();
    $self->semanticscience::org::resource::SIO_010783::init();
    $self->type('_:genid4c6413665a74');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->semanticscience::org::resource::SIO_010782::_get_statements();
    };
    eval {
    	# add parent statements
        $self->semanticscience::org::resource::SIO_010783::_get_statements();
    };
...
Blank::genid4c6413665a74 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use Blank::genid4c6413665a74;
  my $class = Blank::genid4c6413665a74->new();
...
L<semanticscience::org::resource::SIO_010782>
L<semanticscience::org::resource::SIO_010783>
