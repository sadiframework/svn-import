...
@ISA = qw(
 OWL::Data::OWL::Class
 semanticscience::org::resource::SIO_010359 
);
use strict;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->semanticscience::org::resource::SIO_010359::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->semanticscience::org::resource::SIO_010359::_attr_prop( $attr_name, $prop_name ) 
            if $self->semanticscience::org::resource::SIO_010359::_accessible($attr_name);
...
sub init {
    ...
    $self->semanticscience::org::resource::SIO_010359::init();
    $self->type('_:genid4c641366630f');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->semanticscience::org::resource::SIO_010359::_get_statements();
    };
...
Blank::genid4c641366630f - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use Blank::genid4c641366630f;
  my $class = Blank::genid4c641366630f->new();
...
L<semanticscience::org::resource::SIO_010359>
