...
#-----------------------------------------------------------------
package Blank::genid4c6413702162;
...
Blank::genid4c6413702162 - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = Blank::genid4c6413702162->new();

  # get the uri for this class
  my $uri = $class->uri;
  # add object properties 
  use www::mygrid::org::uk::ontology::HGVbaseID;
  # add a has_identifier property (www::mygrid::org::uk::ontology::HGVbaseID)
  $class->add_has_identifier(new www::mygrid::org::uk::ontology::HGVbaseID());
  ...
  # add a produced_by property (www::mygrid::org::uk::ontology::HGVbase)
  $class->add_produced_by(new www::mygrid::org::uk::ontology::HGVbase());
