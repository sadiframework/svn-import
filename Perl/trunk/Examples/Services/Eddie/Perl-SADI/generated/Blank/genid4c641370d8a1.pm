...
#-----------------------------------------------------------------
package Blank::genid4c641370d8a1;
...
Blank::genid4c641370d8a1 - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = Blank::genid4c641370d8a1->new();

  # get the uri for this class
  my $uri = $class->uri;
  # add object properties 
  use www::mygrid::org::uk::ontology::ENZYME_Record;
  # add a is_identifier_of property (www::mygrid::org::uk::ontology::ENZYME_Record)
  $class->add_is_identifier_of(new www::mygrid::org::uk::ontology::ENZYME_Record());
  use www::mygrid::org::uk::ontology::BRENDA_Record;
  # add a is_identifier_of property (www::mygrid::org::uk::ontology::BRENDA_Record)
  $class->add_is_identifier_of(new www::mygrid::org::uk::ontology::BRENDA_Record());
