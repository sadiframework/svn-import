...
#-----------------------------------------------------------------
package Blank::genid4c641371f495;
...
Blank::genid4c641371f495 - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = Blank::genid4c641371f495->new();

  # get the uri for this class
  my $uri = $class->uri;
  # add object properties 
  use www::mygrid::org::uk::ontology::Gene_ontology_GO;
  # add a produced_by property (www::mygrid::org::uk::ontology::Gene_ontology_GO)
  $class->add_produced_by(new www::mygrid::org::uk::ontology::Gene_ontology_GO());
  ...
  # add a has_identifier property (www::mygrid::org::uk::ontology::Gene_Ontology_term_id)
  $class->add_has_identifier(new www::mygrid::org::uk::ontology::Gene_Ontology_term_id());
