...
use semanticscience::org::resource::SIO_000355;
    ...
    my %_allowed = (
        ...
        SIO_000355 => {
        	...
        	post => sub {
                ...
                my $type = @{$self->SIO_000355}[-1] if defined $self->SIO_000355;
                return unless defined $type and $type->type;
                my $range = new semanticscience::org::resource::SIO_000355->range();
                return unless $range;
...
sub _get_statements {
    ...
    if (defined $self->SIO_000355){
	    foreach (@{$self->SIO_000355}) {
	        ...
	        $self->model->addStmt(
	          new RDF::Core::Statement(
	              $subject,
	              $subject->new('http://semanticscience.org/resource/SIO_000355'), 
...
Blank::genid4c6413667ff5 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use Blank::genid4c6413667ff5;
  my $class = Blank::genid4c6413667ff5->new();

  # get the uri for this class
  my $uri = $class->uri;
  # add object properties 
  use Blank::genid4c641366630f;
  # add a SIO_000355 property (Blank::genid4c641366630f)
  $class->add_SIO_000355(new Blank::genid4c641366630f());
  use Blank::genid4c6413669beb;
  # add a SIO_000355 property (Blank::genid4c6413669beb)
  $class->add_SIO_000355(new Blank::genid4c6413669beb());
  # get the SIO_000355 object properties
  my $SIO_000355_objects = $class->SIO_000355;
