...
#-----------------------------------------------------------------
package Blank::genid4c6413663f0e;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->semanticscience::org::resource::SIO_010043::_accessible($attr)
          or $self->semanticscience::org::resource::SIO_010497::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->semanticscience::org::resource::SIO_010043::_attr_prop( $attr_name, $prop_name ) 
            if $self->semanticscience::org::resource::SIO_010043::_accessible($attr_name);
        return $self->semanticscience::org::resource::SIO_010497::_attr_prop( $attr_name, $prop_name ) 
            if $self->semanticscience::org::resource::SIO_010497::_accessible($attr_name);
...
sub init {
    ...
    $self->semanticscience::org::resource::SIO_010043::init();
    $self->semanticscience::org::resource::SIO_010497::init();
    $self->type('_:genid4c6413663f0e');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->semanticscience::org::resource::SIO_010043::_get_statements();
    };
    eval {
    	# add parent statements
        $self->semanticscience::org::resource::SIO_010497::_get_statements();
    };
...
Blank::genid4c6413663f0e - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = Blank::genid4c6413663f0e->new();
...
L<semanticscience::org::resource::SIO_010043>
L<semanticscience::org::resource::SIO_010497>
