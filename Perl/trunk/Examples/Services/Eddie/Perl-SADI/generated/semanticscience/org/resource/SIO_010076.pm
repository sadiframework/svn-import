#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_010076
# Generated: 12-Aug-2010 09:35:00 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_010076;

use OWL::Data::OWL::Class;
use semanticscience::org::resource::SIO_010038;
...
@ISA = qw(
 OWL::Data::OWL::Class
 semanticscience::org::resource::SIO_010038 
);
use strict;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->semanticscience::org::resource::SIO_010038::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->semanticscience::org::resource::SIO_010038::_attr_prop( $attr_name, $prop_name ) 
            if $self->semanticscience::org::resource::SIO_010038::_accessible($attr_name);
...
sub init {
    ...
    $self->semanticscience::org::resource::SIO_010038::init();
    $self->type('http://semanticscience.org/resource/SIO_010076');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->semanticscience::org::resource::SIO_010038::_get_statements();
    };
...
semanticscience::org::resource::SIO_010076 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_010076;
  my $class = semanticscience::org::resource::SIO_010076->new();
...
L<semanticscience::org::resource::SIO_010038>
