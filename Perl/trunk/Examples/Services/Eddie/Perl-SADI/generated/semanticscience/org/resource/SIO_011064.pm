#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_011064
# Generated: 12-Aug-2010 09:34:53 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_011064;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_011064');
...
semanticscience::org::resource::SIO_011064 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_011064;
  my $class = semanticscience::org::resource::SIO_011064->new();
