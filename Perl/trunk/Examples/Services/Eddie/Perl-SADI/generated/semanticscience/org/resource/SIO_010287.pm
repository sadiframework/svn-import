...
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_010287;

use OWL::Data::OWL::Class;
use semanticscience::org::resource::SIO_010069;
...
@ISA = qw(
 OWL::Data::OWL::Class
 semanticscience::org::resource::SIO_010069 
);
use strict;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->semanticscience::org::resource::SIO_010069::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->semanticscience::org::resource::SIO_010069::_attr_prop( $attr_name, $prop_name ) 
            if $self->semanticscience::org::resource::SIO_010069::_accessible($attr_name);
...
sub init {
    ...
    $self->semanticscience::org::resource::SIO_010069::init();
    $self->type('http://semanticscience.org/resource/SIO_010287');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->semanticscience::org::resource::SIO_010069::_get_statements();
    };
...
semanticscience::org::resource::SIO_010287 - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = semanticscience::org::resource::SIO_010287->new();
...
L<semanticscience::org::resource::SIO_010069>
