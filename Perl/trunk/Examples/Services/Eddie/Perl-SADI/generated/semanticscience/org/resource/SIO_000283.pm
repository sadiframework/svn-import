#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_000283
# Generated: 12-Aug-2010 09:33:24 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_000283;
...
sub init {
    ...
    $self->uri('http://semanticscience.org/resource/SIO_000283');
}
...
semanticscience::org::resource::SIO_000283 - an object propery

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_000283;
  my $property = semanticscience::org::resource::SIO_000283->new();
