#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_000100
# Generated: 12-Aug-2010 09:33:26 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_000100;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_000100');
...
semanticscience::org::resource::SIO_000100 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_000100;
  my $class = semanticscience::org::resource::SIO_000100->new();
