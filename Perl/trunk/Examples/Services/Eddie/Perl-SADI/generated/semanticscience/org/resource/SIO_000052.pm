#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_000052
# Generated: 12-Aug-2010 09:34:49 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_000052;

use OWL::Data::OWL::Class;
use semanticscience::org::resource::SIO_000070;
use Blank::genid4c641369a03c;
...
@ISA = qw(
 OWL::Data::OWL::Class
 semanticscience::org::resource::SIO_000070
 Blank::genid4c641369a03c 
);
use strict;
...
use semanticscience::org::resource::SIO_000215;
...

{
    my %_allowed = (
        ...
        SIO_000215 => {
        	...
        	post => sub {
                ...
                my $type = @{$self->SIO_000215}[-1] if defined $self->SIO_000215;
                return unless defined $type and $type->type;
                my $range = new semanticscience::org::resource::SIO_000215->range();
                return unless $range;
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->semanticscience::org::resource::SIO_000070::_accessible($attr)
          or $self->Blank::genid4c641369a03c::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->semanticscience::org::resource::SIO_000070::_attr_prop( $attr_name, $prop_name ) 
            if $self->semanticscience::org::resource::SIO_000070::_accessible($attr_name);
        return $self->Blank::genid4c641369a03c::_attr_prop( $attr_name, $prop_name ) 
            if $self->Blank::genid4c641369a03c::_accessible($attr_name);
...
sub init {
    ...
    $self->semanticscience::org::resource::SIO_000070::init();
    $self->Blank::genid4c641369a03c::init();
    $self->type('http://semanticscience.org/resource/SIO_000052');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->semanticscience::org::resource::SIO_000070::_get_statements();
    };
    eval {
    	# add parent statements
        $self->Blank::genid4c641369a03c::_get_statements();
    };

    # for each attribute, if is array do:
    if (defined $self->SIO_000215){
	    foreach (@{$self->SIO_000215}) {
	        ...
	        $self->model->addStmt(
	          new RDF::Core::Statement(
	              $subject,
	              $subject->new('http://semanticscience.org/resource/SIO_000215'), 
...
semanticscience::org::resource::SIO_000052 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_000052;
  my $class = semanticscience::org::resource::SIO_000052->new();
  ...
  my $SIO_000300_property = $class->SIO_000300;  # add object properties 
  # Make sure to use the appropriate OWL class! 
  # OWL::Data::OWL::Class used as an example
  $class->add_SIO_000215(new OWL::Data::OWL::Class('#someURI'));

  # get the SIO_000215 object properties
  my $SIO_000215_objects = $class->SIO_000215;
...
L<semanticscience::org::resource::SIO_000070>
L<Blank::genid4c641369a03c>
