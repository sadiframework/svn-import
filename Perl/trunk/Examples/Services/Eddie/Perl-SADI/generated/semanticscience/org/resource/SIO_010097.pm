#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_010097
# Generated: 12-Aug-2010 09:33:48 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_010097;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_010097');
...
semanticscience::org::resource::SIO_010097 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_010097;
  my $class = semanticscience::org::resource::SIO_010097->new();
  ...
  $class->add_SIO_000245(new OWL::Data::OWL::Class('#someURI'));
