#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_011104
# Generated: 12-Aug-2010 09:33:27 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_011104;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_011104');
...
semanticscience::org::resource::SIO_011104 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_011104;
  my $class = semanticscience::org::resource::SIO_011104->new();
