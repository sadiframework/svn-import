#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_000022
# Generated: 12-Aug-2010 09:34:47 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_000022;
...
use semanticscience::org::resource::SIO_000096;
    ...
    my %_allowed = (
        ...
        SIO_000096 => {
        	...
        	post => sub {
                ...
                my $type = @{$self->SIO_000096}[-1] if defined $self->SIO_000096;
                return unless defined $type and $type->type;
                my $range = new semanticscience::org::resource::SIO_000096->range();
                return unless $range;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_000022');
...
sub _get_statements {
    ...
    if (defined $self->SIO_000096){
	    foreach (@{$self->SIO_000096}) {
	        ...
	        $self->model->addStmt(
	          new RDF::Core::Statement(
	              $subject,
	              $subject->new('http://semanticscience.org/resource/SIO_000096'), 
...
semanticscience::org::resource::SIO_000022 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_000022;
  my $class = semanticscience::org::resource::SIO_000022->new();
  ...
  $class->add_SIO_000096(new OWL::Data::OWL::Class('#someURI'));

  # get the SIO_000096 object properties
  my $SIO_000096_objects = $class->SIO_000096;
