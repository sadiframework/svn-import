#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_000125
# Generated: 12-Aug-2010 09:35:02 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_000125;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->Blank::genid4c641369732a::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->Blank::genid4c641369732a::_attr_prop( $attr_name, $prop_name ) 
            if $self->Blank::genid4c641369732a::_accessible($attr_name);
...
sub init {
    ...
    $self->Blank::genid4c641369732a::init();
    $self->type('http://semanticscience.org/resource/SIO_000125');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->Blank::genid4c641369732a::_get_statements();
    };
...
semanticscience::org::resource::SIO_000125 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_000125;
  my $class = semanticscience::org::resource::SIO_000125->new();
