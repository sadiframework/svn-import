#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_000413
# Generated: 12-Aug-2010 09:34:41 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_000413;

use OWL::Data::OWL::Class;
use semanticscience::org::resource::SIO_000414;
...
@ISA = qw(
 OWL::Data::OWL::Class
 semanticscience::org::resource::SIO_000414 
);
use strict;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->semanticscience::org::resource::SIO_000414::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->semanticscience::org::resource::SIO_000414::_attr_prop( $attr_name, $prop_name ) 
            if $self->semanticscience::org::resource::SIO_000414::_accessible($attr_name);
...
sub init {
    ...
    $self->semanticscience::org::resource::SIO_000414::init();
    $self->type('http://semanticscience.org/resource/SIO_000413');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->semanticscience::org::resource::SIO_000414::_get_statements();
    };
...
semanticscience::org::resource::SIO_000413 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_000413;
  my $class = semanticscience::org::resource::SIO_000413->new();
...
L<semanticscience::org::resource::SIO_000414>
