#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_011007
# Generated: 12-Aug-2010 09:34:59 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_011007;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_011007');
...
semanticscience::org::resource::SIO_011007 - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = semanticscience::org::resource::SIO_011007->new();
