#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_011030
# Generated: 12-Aug-2010 09:34:22 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_011030;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_011030');
...
semanticscience::org::resource::SIO_011030 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_011030;
  my $class = semanticscience::org::resource::SIO_011030->new();
