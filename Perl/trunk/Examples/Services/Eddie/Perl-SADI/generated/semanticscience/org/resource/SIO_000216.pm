#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_000216
# Generated: 12-Aug-2010 09:33:24 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_000216;
...
sub init {
    ...
    $self->range('http://semanticscience.org/resource/SIO_000070');        
    # set the uri for this object property
    $self->uri('http://semanticscience.org/resource/SIO_000216');
}
...
semanticscience::org::resource::SIO_000216 - an object propery

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_000216;
  my $property = semanticscience::org::resource::SIO_000216->new();
