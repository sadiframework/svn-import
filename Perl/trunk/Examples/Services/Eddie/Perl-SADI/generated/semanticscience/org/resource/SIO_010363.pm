#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_010363
# Generated: 12-Aug-2010 09:33:31 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_010363;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->Blank::genid4c641366078a::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->Blank::genid4c641366078a::_attr_prop( $attr_name, $prop_name ) 
            if $self->Blank::genid4c641366078a::_accessible($attr_name);
...
sub init {
    ...
    $self->Blank::genid4c641366078a::init();
    $self->type('http://semanticscience.org/resource/SIO_010363');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->Blank::genid4c641366078a::_get_statements();
    };
...
semanticscience::org::resource::SIO_010363 - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = semanticscience::org::resource::SIO_010363->new();
