#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_011004
# Generated: 12-Aug-2010 09:35:20 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_011004;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_011004');
...
semanticscience::org::resource::SIO_011004 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_011004;
  my $class = semanticscience::org::resource::SIO_011004->new();
