#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_011087
# Generated: 12-Aug-2010 09:35:22 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_011087;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_011087');
...
semanticscience::org::resource::SIO_011087 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_011087;
  my $class = semanticscience::org::resource::SIO_011087->new();
