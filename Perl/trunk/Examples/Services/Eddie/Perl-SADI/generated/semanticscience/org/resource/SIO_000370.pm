#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_000370
# Generated: 12-Aug-2010 09:35:05 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_000370;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->semanticscience::org::resource::SIO_000416::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->semanticscience::org::resource::SIO_000416::_attr_prop( $attr_name, $prop_name ) 
            if $self->semanticscience::org::resource::SIO_000416::_accessible($attr_name);
...
sub init {
    ...
    $self->semanticscience::org::resource::SIO_000416::init();
    $self->type('http://semanticscience.org/resource/SIO_000370');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->semanticscience::org::resource::SIO_000416::_get_statements();
    };
...
semanticscience::org::resource::SIO_000370 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_000370;
  my $class = semanticscience::org::resource::SIO_000370->new();
...
L<semanticscience::org::resource::SIO_000416>
