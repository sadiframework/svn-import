...
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_010043;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->semanticscience::org::resource::SIO_010007::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->semanticscience::org::resource::SIO_010007::_attr_prop( $attr_name, $prop_name ) 
            if $self->semanticscience::org::resource::SIO_010007::_accessible($attr_name);
...
sub init {
    ...
    $self->semanticscience::org::resource::SIO_010007::init();
    $self->type('http://semanticscience.org/resource/SIO_010043');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->semanticscience::org::resource::SIO_010007::_get_statements();
    };
...
semanticscience::org::resource::SIO_010043 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_010043;
  my $class = semanticscience::org::resource::SIO_010043->new();
...
L<semanticscience::org::resource::SIO_010007>
