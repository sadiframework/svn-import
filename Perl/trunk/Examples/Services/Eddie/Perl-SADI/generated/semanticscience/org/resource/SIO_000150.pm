...
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_000150;

use OWL::Data::OWL::Class;
use semanticscience::org::resource::SIO_000089;
...
@ISA = qw(
 OWL::Data::OWL::Class
 semanticscience::org::resource::SIO_000089 
);
use strict;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->semanticscience::org::resource::SIO_000089::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->semanticscience::org::resource::SIO_000089::_attr_prop( $attr_name, $prop_name ) 
            if $self->semanticscience::org::resource::SIO_000089::_accessible($attr_name);
...
sub init {
    ...
    $self->semanticscience::org::resource::SIO_000089::init();
    $self->type('http://semanticscience.org/resource/SIO_000150');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->semanticscience::org::resource::SIO_000089::_get_statements();
    };
...
semanticscience::org::resource::SIO_000150 - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = semanticscience::org::resource::SIO_000150->new();
...
L<semanticscience::org::resource::SIO_000089>
