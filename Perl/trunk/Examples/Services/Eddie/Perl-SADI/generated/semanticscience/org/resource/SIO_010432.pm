#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_010432
# Generated: 12-Aug-2010 09:33:40 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_010432;

use OWL::Data::OWL::Class;
use Blank::genid4c641366d9aa;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->Blank::genid4c641366d9aa::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->Blank::genid4c641366d9aa::_attr_prop( $attr_name, $prop_name ) 
            if $self->Blank::genid4c641366d9aa::_accessible($attr_name);
...
sub init {
    ...
    $self->Blank::genid4c641366d9aa::init();
    $self->type('http://semanticscience.org/resource/SIO_010432');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->Blank::genid4c641366d9aa::_get_statements();
    };
...
semanticscience::org::resource::SIO_010432 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_010432;
  my $class = semanticscience::org::resource::SIO_010432->new();
