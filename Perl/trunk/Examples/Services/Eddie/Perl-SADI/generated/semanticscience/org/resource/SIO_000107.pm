#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_000107
# Generated: 12-Aug-2010 09:35:01 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_000107;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_000107');
...
semanticscience::org::resource::SIO_000107 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_000107;
  my $class = semanticscience::org::resource::SIO_000107->new();
