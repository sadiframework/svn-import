#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_010084
# Generated: 12-Aug-2010 09:33:48 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_010084;

use OWL::Data::OWL::Class;
use semanticscience::org::resource::SIO_010335;
...
@ISA = qw(
 OWL::Data::OWL::Class
 semanticscience::org::resource::SIO_010335 
);
use strict;
...
use semanticscience::org::resource::SIO_000093;
use semanticscience::org::resource::SIO_000369;
use semanticscience::org::resource::SIO_010080;
...

{
    my %_allowed = (
        ...
        SIO_000093 => {
        	...
        	post => sub {
                ...
                my $type = @{$self->SIO_000093}[-1] if defined $self->SIO_000093;
                return unless defined $type and $type->type;
                my $range = new semanticscience::org::resource::SIO_000093->range();
                return unless $range;
        ...
        SIO_000369 => {
        	...
        	post => sub {
        		my ($self) = shift;
        		return unless $self->strict;
                my $type = @{$self->SIO_000369}[-1] if defined $self->SIO_000369;
                return unless defined $type and $type->type;
                my $range = new semanticscience::org::resource::SIO_000369->range();
                return unless $range;
                $range = $self->uri2package($range);
                eval {
                	$range = $range->new();
        ...
        SIO_010080 => {
        	...
        	post => sub {
        		my ($self) = shift;
        		return unless $self->strict;
                my $type = @{$self->SIO_010080}[-1] if defined $self->SIO_010080;
                return unless defined $type and $type->type;
                my $range = new semanticscience::org::resource::SIO_010080->range();
                return unless $range;
                $range = $self->uri2package($range);
                eval {
                	$range = $range->new();
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->semanticscience::org::resource::SIO_010335::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->semanticscience::org::resource::SIO_010335::_attr_prop( $attr_name, $prop_name ) 
            if $self->semanticscience::org::resource::SIO_010335::_accessible($attr_name);
...
sub init {
    ...
    $self->semanticscience::org::resource::SIO_010335::init();
    $self->type('http://semanticscience.org/resource/SIO_010084');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->semanticscience::org::resource::SIO_010335::_get_statements();
    };

    # for each attribute, if is array do:
    if (defined $self->SIO_000093){
	    foreach (@{$self->SIO_000093}) {
	        ...
	        $self->model->addStmt(
	          new RDF::Core::Statement(
	              $subject,
	              $subject->new('http://semanticscience.org/resource/SIO_000093'), 
    ...
    # for each attribute, if is array do:
    if (defined $self->SIO_000369){
	    foreach (@{$self->SIO_000369}) {
	        # add all statements from $_
	        my $enumerator = $_->_get_statements if defined $_->_get_statements;
	        next unless defined $enumerator;
            my $statement = $enumerator->getFirst;
	        ...
	        $self->model->addStmt(
	          new RDF::Core::Statement(
	              $subject,
	              $subject->new('http://semanticscience.org/resource/SIO_000369'), 
	              (defined $_->subject ? $_->subject : RDF::Core::Resource->new($_->value))
	          )
	        );
	        $add_type_statement = 1;
    ...
    # for each attribute, if is array do:
    if (defined $self->SIO_010080){
	    foreach (@{$self->SIO_010080}) {
	        # add all statements from $_
	        my $enumerator = $_->_get_statements if defined $_->_get_statements;
	        next unless defined $enumerator;
            my $statement = $enumerator->getFirst;
	        ...
	        $self->model->addStmt(
	          new RDF::Core::Statement(
	              $subject,
	              $subject->new('http://semanticscience.org/resource/SIO_010080'), 
	              (defined $_->subject ? $_->subject : RDF::Core::Resource->new($_->value))
	          )
	        );
	        $add_type_statement = 1;
...
semanticscience::org::resource::SIO_010084 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_010084;
  my $class = semanticscience::org::resource::SIO_010084->new();
  ...
  $class->add_SIO_000093(new OWL::Data::OWL::Class('#someURI'));

  # get the SIO_000093 object properties
  my $SIO_000093_objects = $class->SIO_000093;
  # Make sure to use the appropriate OWL class! 
  # OWL::Data::OWL::Class used as an example
  $class->add_SIO_000369(new OWL::Data::OWL::Class('#someURI'));

  # get the SIO_000369 object properties
  my $SIO_000369_objects = $class->SIO_000369;
  # Make sure to use the appropriate OWL class! 
  # OWL::Data::OWL::Class used as an example
  $class->add_SIO_010080(new OWL::Data::OWL::Class('#someURI'));

  # get the SIO_010080 object properties
  my $SIO_010080_objects = $class->SIO_010080;
...
L<semanticscience::org::resource::SIO_010335>
