#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_010011
# Generated: 12-Aug-2010 09:34:01 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_010011;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_010011');
...
semanticscience::org::resource::SIO_010011 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_010011;
  my $class = semanticscience::org::resource::SIO_010011->new();
