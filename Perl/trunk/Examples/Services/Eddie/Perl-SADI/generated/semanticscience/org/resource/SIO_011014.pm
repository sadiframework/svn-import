#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_011014
# Generated: 12-Aug-2010 09:34:17 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_011014;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_011014');
...
semanticscience::org::resource::SIO_011014 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_011014;
  my $class = semanticscience::org::resource::SIO_011014->new();
