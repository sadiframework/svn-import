#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_000227
# Generated: 12-Aug-2010 09:33:24 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_000227;
...
sub init {
    ...
    $self->domain('http://semanticscience.org/resource/SIO_000016');    
    # set the uri for this object property
    $self->uri('http://semanticscience.org/resource/SIO_000227');
}
...
semanticscience::org::resource::SIO_000227 - an object propery

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_000227;
  my $property = semanticscience::org::resource::SIO_000227->new();
