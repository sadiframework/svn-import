#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_000366
# Generated: 12-Aug-2010 09:34:07 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_000366;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_000366');
...
semanticscience::org::resource::SIO_000366 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_000366;
  my $class = semanticscience::org::resource::SIO_000366->new();
