#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_000435
# Generated: 12-Aug-2010 09:35:00 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_000435;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->semanticscience::org::resource::SIO_000417::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->semanticscience::org::resource::SIO_000417::_attr_prop( $attr_name, $prop_name ) 
            if $self->semanticscience::org::resource::SIO_000417::_accessible($attr_name);
...
sub init {
    ...
    $self->semanticscience::org::resource::SIO_000417::init();
    $self->type('http://semanticscience.org/resource/SIO_000435');
    $self->add_SIO_000300(semanticscience::org::resource::SIO_000300->new('PT1S'));
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->semanticscience::org::resource::SIO_000417::_get_statements();
    };
...
semanticscience::org::resource::SIO_000435 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_000435;
  my $class = semanticscience::org::resource::SIO_000435->new();
...
L<semanticscience::org::resource::SIO_000417>
...
=item 'SIO_000300' has value 'PT1S', for example, (semanticscience::org::resource::SIO_000300->new('PT1S'));
