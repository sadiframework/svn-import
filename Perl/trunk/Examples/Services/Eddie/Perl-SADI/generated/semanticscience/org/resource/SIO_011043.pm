#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_011043
# Generated: 12-Aug-2010 09:33:48 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_011043;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_011043');
...
semanticscience::org::resource::SIO_011043 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_011043;
  my $class = semanticscience::org::resource::SIO_011043->new();
