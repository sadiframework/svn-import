#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_011059
# Generated: 12-Aug-2010 09:34:42 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_011059;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_011059');
...
semanticscience::org::resource::SIO_011059 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_011059;
  my $class = semanticscience::org::resource::SIO_011059->new();
