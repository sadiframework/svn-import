#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_000352
# Generated: 12-Aug-2010 09:33:24 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_000352;
...
sub init {
    ...
    $self->uri('http://semanticscience.org/resource/SIO_000352');
}
...
semanticscience::org::resource::SIO_000352 - an object propery

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_000352;
  my $property = semanticscience::org::resource::SIO_000352->new();
