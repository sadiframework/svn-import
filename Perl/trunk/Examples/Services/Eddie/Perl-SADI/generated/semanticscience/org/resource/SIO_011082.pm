#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_011082
# Generated: 12-Aug-2010 09:35:20 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_011082;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_011082');
...
semanticscience::org::resource::SIO_011082 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_011082;
  my $class = semanticscience::org::resource::SIO_011082->new();
