#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_000119
# Generated: 12-Aug-2010 09:34:46 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_000119;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_000119');
...
semanticscience::org::resource::SIO_000119 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_000119;
  my $class = semanticscience::org::resource::SIO_000119->new();
