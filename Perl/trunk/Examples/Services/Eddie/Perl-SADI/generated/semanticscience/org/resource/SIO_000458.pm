...
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_000458;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->Blank::genid4c6413694be8::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->Blank::genid4c6413694be8::_attr_prop( $attr_name, $prop_name ) 
            if $self->Blank::genid4c6413694be8::_accessible($attr_name);
...
sub init {
    ...
    $self->Blank::genid4c6413694be8::init();
    $self->type('http://semanticscience.org/resource/SIO_000458');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->Blank::genid4c6413694be8::_get_statements();
    };
...
semanticscience::org::resource::SIO_000458 - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = semanticscience::org::resource::SIO_000458->new();
