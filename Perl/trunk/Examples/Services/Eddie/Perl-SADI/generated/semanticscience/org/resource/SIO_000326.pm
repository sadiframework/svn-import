#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_000326
# Generated: 12-Aug-2010 09:35:03 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_000326;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_000326');
...
semanticscience::org::resource::SIO_000326 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_000326;
  my $class = semanticscience::org::resource::SIO_000326->new();
