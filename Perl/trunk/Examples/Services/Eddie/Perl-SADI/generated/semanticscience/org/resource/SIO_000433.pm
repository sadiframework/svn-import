#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_000433
# Generated: 12-Aug-2010 09:33:49 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_000433;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_000433');
...
semanticscience::org::resource::SIO_000433 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_000433;
  my $class = semanticscience::org::resource::SIO_000433->new();
