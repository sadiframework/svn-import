#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_011119
# Generated: 12-Aug-2010 09:35:01 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_011119;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->semanticscience::org::resource::SIO_011121::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->semanticscience::org::resource::SIO_011121::_attr_prop( $attr_name, $prop_name ) 
            if $self->semanticscience::org::resource::SIO_011121::_accessible($attr_name);
...
sub init {
    ...
    $self->semanticscience::org::resource::SIO_011121::init();
    $self->type('http://semanticscience.org/resource/SIO_011119');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->semanticscience::org::resource::SIO_011121::_get_statements();
    };
...
semanticscience::org::resource::SIO_011119 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_011119;
  my $class = semanticscience::org::resource::SIO_011119->new();
...
L<semanticscience::org::resource::SIO_011121>
