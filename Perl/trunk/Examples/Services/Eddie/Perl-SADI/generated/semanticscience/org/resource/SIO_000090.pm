#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_000090
# Generated: 12-Aug-2010 09:34:54 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_000090;
...
use semanticscience::org::resource::SIO_000362;
...

{
    my %_allowed = (
        ...
        SIO_000362 => {
        	...
        	post => sub {
                ...
                my $type = @{$self->SIO_000362}[-1] if defined $self->SIO_000362;
                return unless defined $type and $type->type;
                my $range = new semanticscience::org::resource::SIO_000362->range();
                return unless $range;
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->semanticscience::org::resource::SIO_000015::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->semanticscience::org::resource::SIO_000015::_attr_prop( $attr_name, $prop_name ) 
            if $self->semanticscience::org::resource::SIO_000015::_accessible($attr_name);
...
sub init {
    ...
    $self->semanticscience::org::resource::SIO_000015::init();
    $self->type('http://semanticscience.org/resource/SIO_000090');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->semanticscience::org::resource::SIO_000015::_get_statements();
    };

    # for each attribute, if is array do:
    if (defined $self->SIO_000362){
	    foreach (@{$self->SIO_000362}) {
	        ...
	        $self->model->addStmt(
	          new RDF::Core::Statement(
	              $subject,
	              $subject->new('http://semanticscience.org/resource/SIO_000362'), 
...
semanticscience::org::resource::SIO_000090 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_000090;
  my $class = semanticscience::org::resource::SIO_000090->new();
  ...
  $class->add_SIO_000362(new OWL::Data::OWL::Class('#someURI'));

  # get the SIO_000362 object properties
  my $SIO_000362_objects = $class->SIO_000362;
  # Make sure to use the appropriate OWL class! 
  # OWL::Data::OWL::Class used as an example
...
L<semanticscience::org::resource::SIO_000015>
