#-----------------------------------------------------------------
# sadiframework::org::ontologies::properties::has3DStructure
# Generated: 12-Aug-2010 09:33:24 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package sadiframework::org::ontologies::properties::has3DStructure;
...
sub init {
    ...
    $self->uri('http://sadiframework.org/ontologies/properties.owl#has3DStructure');
}
...
sadiframework::org::ontologies::properties::has3DStructure - an object propery

=head1 SYNOPSIS

  use sadiframework::org::ontologies::properties::has3DStructure;
  my $property = sadiframework::org::ontologies::properties::has3DStructure->new();
