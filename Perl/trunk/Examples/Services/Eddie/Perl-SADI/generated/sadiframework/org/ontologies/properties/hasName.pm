#-----------------------------------------------------------------
# sadiframework::org::ontologies::properties::hasName
# Generated: 12-Aug-2010 09:33:25 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package sadiframework::org::ontologies::properties::hasName;
...
sub init {
    ...
    $self->uri('http://sadiframework.org/ontologies/properties.owl#hasName');
}
...
sadiframework::org::ontologies::properties::hasName - an object propery

=head1 SYNOPSIS

  use sadiframework::org::ontologies::properties::hasName;
  my $property = sadiframework::org::ontologies::properties::hasName->new();
