...
#-----------------------------------------------------------------
package dev::biordf::net::kawas::owl::getdbSNPRecordByUniprotID::getdbSNPRecordByUniprotID_Output;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->Blank::genid4c6424f13106::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->Blank::genid4c6424f13106::_attr_prop( $attr_name, $prop_name ) 
            if $self->Blank::genid4c6424f13106::_accessible($attr_name);
...
sub init {
    ...
    $self->Blank::genid4c6424f13106::init();
    $self->type('http://dev.biordf.net/~kawas/owl/getdbSNPRecordByUniprotID.owl#getdbSNPRecordByUniprotID_Output');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->Blank::genid4c6424f13106::_get_statements();
    };
...
dev::biordf::net::kawas::owl::getdbSNPRecordByUniprotID::getdbSNPRecordByUniprotID_Output - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use dev::biordf::net::kawas::owl::getdbSNPRecordByUniprotID::getdbSNPRecordByUniprotID_Output;
  my $class = dev::biordf::net::kawas::owl::getdbSNPRecordByUniprotID::getdbSNPRecordByUniprotID_Output->new();
