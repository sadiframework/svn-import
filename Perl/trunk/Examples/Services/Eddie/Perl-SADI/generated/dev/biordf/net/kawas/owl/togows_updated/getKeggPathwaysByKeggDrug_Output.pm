...
#-----------------------------------------------------------------
package dev::biordf::net::kawas::owl::togows_updated::getKeggPathwaysByKeggDrug_Output;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->Blank::genid4c6424fe366b::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->Blank::genid4c6424fe366b::_attr_prop( $attr_name, $prop_name ) 
            if $self->Blank::genid4c6424fe366b::_accessible($attr_name);
...
sub init {
    ...
    $self->Blank::genid4c6424fe366b::init();
    $self->type('http://dev.biordf.net/~kawas/owl/togows-updated.owl#getKeggPathwaysByKeggDrug_Output');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->Blank::genid4c6424fe366b::_get_statements();
    };
...
dev::biordf::net::kawas::owl::togows_updated::getKeggPathwaysByKeggDrug_Output - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = dev::biordf::net::kawas::owl::togows_updated::getKeggPathwaysByKeggDrug_Output->new();
