...
# Generated: 12-Aug-2010 09:44:41 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package dev::biordf::net::kawas::owl::getUniprotByKeggGene::UniprotByKeggGeneOutputClass;
...
@ISA = qw(
 OWL::Data::OWL::Class
 purl::oclc::org::SADI::LSRN::KEGG_Record 
);
use strict;
...
use semanticscience::org::resource::SIO_010078;
...

{
    my %_allowed = (
        ...
        SIO_010078 => {
        	...
        	post => sub {
                ...
                my $type = @{$self->SIO_010078}[-1] if defined $self->SIO_010078;
                return unless defined $type and $type->type;
                my $range = new semanticscience::org::resource::SIO_010078->range();
                return unless $range;
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->purl::oclc::org::SADI::LSRN::KEGG_Record::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->purl::oclc::org::SADI::LSRN::KEGG_Record::_attr_prop( $attr_name, $prop_name ) 
            if $self->purl::oclc::org::SADI::LSRN::KEGG_Record::_accessible($attr_name);
...
sub init {
    ...
    $self->purl::oclc::org::SADI::LSRN::KEGG_Record::init();
    $self->type('http://dev.biordf.net/~kawas/owl/getUniprotByKeggGene.owl#UniprotByKeggGeneOutputClass');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->purl::oclc::org::SADI::LSRN::KEGG_Record::_get_statements();
    };

    # for each attribute, if is array do:
    if (defined $self->SIO_010078){
	    foreach (@{$self->SIO_010078}) {
	        ...
	        $self->model->addStmt(
	          new RDF::Core::Statement(
	              $subject,
	              $subject->new('http://semanticscience.org/resource/SIO_010078'), 
...
dev::biordf::net::kawas::owl::getUniprotByKeggGene::UniprotByKeggGeneOutputClass - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = dev::biordf::net::kawas::owl::getUniprotByKeggGene::UniprotByKeggGeneOutputClass->new();
  ...
  $class->add_SIO_010078(new OWL::Data::OWL::Class('#someURI'));

  # get the SIO_010078 object properties
  my $SIO_010078_objects = $class->SIO_010078;
...
L<purl::oclc::org::SADI::LSRN::KEGG_Record>
