#-----------------------------------------------------------------
# dev::biordf::net::kawas::owl::kegg2pfam::kegg2pfam_OutputClass
# Generated: 12-Aug-2010 09:44:45 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package dev::biordf::net::kawas::owl::kegg2pfam::kegg2pfam_OutputClass;

use OWL::Data::OWL::Class;
use purl::oclc::org::SADI::LSRN::KEGG_Record;
use Blank::genid4c6424fcec90;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->Blank::genid4c6424fcec90::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->Blank::genid4c6424fcec90::_attr_prop( $attr_name, $prop_name ) 
            if $self->Blank::genid4c6424fcec90::_accessible($attr_name);
...
sub init {
    ...
    $self->Blank::genid4c6424fcec90::init();
    $self->type('http://dev.biordf.net/~kawas/owl/kegg2pfam.owl#kegg2pfam_OutputClass');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->Blank::genid4c6424fcec90::_get_statements();
    };
...
dev::biordf::net::kawas::owl::kegg2pfam::kegg2pfam_OutputClass - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = dev::biordf::net::kawas::owl::kegg2pfam::kegg2pfam_OutputClass->new();
