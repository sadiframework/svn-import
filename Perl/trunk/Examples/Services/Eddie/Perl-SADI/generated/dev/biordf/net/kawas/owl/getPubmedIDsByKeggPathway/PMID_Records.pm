#-----------------------------------------------------------------
# dev::biordf::net::kawas::owl::getPubmedIDsByKeggPathway::PMID_Records
# Generated: 12-Aug-2010 09:44:40 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package dev::biordf::net::kawas::owl::getPubmedIDsByKeggPathway::PMID_Records;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->Blank::genid4c6424f709df::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->Blank::genid4c6424f709df::_attr_prop( $attr_name, $prop_name ) 
            if $self->Blank::genid4c6424f709df::_accessible($attr_name);
...
sub init {
    ...
    $self->Blank::genid4c6424f709df::init();
    $self->type('http://dev.biordf.net/~kawas/owl/getPubmedIDsByKeggPathway.owl#PMID_Records');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->Blank::genid4c6424f709df::_get_statements();
    };
...
dev::biordf::net::kawas::owl::getPubmedIDsByKeggPathway::PMID_Records - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = dev::biordf::net::kawas::owl::getPubmedIDsByKeggPathway::PMID_Records->new();
