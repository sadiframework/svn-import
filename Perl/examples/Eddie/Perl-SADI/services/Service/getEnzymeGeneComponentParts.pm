...
BEGIN {
    ...
    new SADI::Generators::GenServices->async_load(
	 service_names => ['getEnzymeGeneComponentParts']);
}

# (this to stay here with any of the options above)
use vars qw( @ISA );
@ISA = qw( net::biordf::dev::getEnzymeGeneComponentPartsBase );
use strict;
...
sub process_it {
    ...
    foreach my $input (@inputs) {
        ...
        my $class = Implementations::getEnzymeGeneComponentParts($input, $accession, $LOG);
...
Service::getEnzymeGeneComponentParts - a SADI service
