#-----------------------------------------------------------------
# Service name: getGOTermAssociationsTigrAth1
#    An asynchronous service
# Authority:    illuminae.com
# Created:      19-Aug-2010 13:07:19 PDT
# Contact:      myaddress@organization.org
# Description:  
#               fetches tigr ath1 entities annotated with a given GO term
#-----------------------------------------------------------------

package Service::getGOTermAssociationsTigrAth1;
...
sub process_it {
    ...
    foreach my $input (@inputs) {
        ...
        use Implementations;
        my $class = Implementations::getGOTermAssociationsX($input, $id, $LOG, 'tigr_ath1');
...
Service::getGOTermAssociationsTigrAth1 - a SADI service
