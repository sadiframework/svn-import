#-----------------------------------------------------------------
# Service name: kegg2prosite
# Authority:    dev.biordf.net
# Created:      15-Dec-2009 10:46:34 PST
# Contact:      edward.kawas@gmail.com
# Description:  
#               this service consumes kegg gene ids and returns prosite motifs from KEGG
#-----------------------------------------------------------------

package Service::kegg2prosite;
...
BEGIN {
    ...
    new SADI::Generators::GenServices->async_load(
	 service_names => ['kegg2prosite']);
}

# (this to stay here with any of the options above)
use vars qw( @ISA );
@ISA = qw( net::biordf::dev::kegg2prositeBase );
use strict;
...
sub process_it {
    ...
    foreach my $input (@inputs) {
        ...
        my $output = Implementations::kegg2prosite($input, $accession, $LOG);
...
Service::kegg2prosite - a SADI service
