...
#-----------------------------------------------------------------
package Blank::genid4c641371691c;
...
Blank::genid4c641371691c - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = Blank::genid4c641371691c->new();

  # get the uri for this class
  my $uri = $class->uri;
  # add object properties 
  use www::mygrid::org::uk::ontology::pubmed;
  # add a produced_by property (www::mygrid::org::uk::ontology::pubmed)
  $class->add_produced_by(new www::mygrid::org::uk::ontology::pubmed());
  # get the produced_by object properties
  my $produced_by_objects = $class->produced_by;
  use www::mygrid::org::uk::ontology::PubMed_id;
  # add a has_identifier property (www::mygrid::org::uk::ontology::PubMed_id)
  $class->add_has_identifier(new www::mygrid::org::uk::ontology::PubMed_id());
