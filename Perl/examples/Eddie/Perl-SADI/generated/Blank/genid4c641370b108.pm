...
#-----------------------------------------------------------------
package Blank::genid4c641370b108;
...
Blank::genid4c641370b108 - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = Blank::genid4c641370b108->new();

  # get the uri for this class
  my $uri = $class->uri;
  # add object properties 
  use www::mygrid::org::uk::ontology::EDHA;
  # add a produced_by property (www::mygrid::org::uk::ontology::EDHA)
  $class->add_produced_by(new www::mygrid::org::uk::ontology::EDHA());
  # get the produced_by object properties
  my $produced_by_objects = $class->produced_by;
  use www::mygrid::org::uk::ontology::EDHA_term_id;
  # add a has_identifier property (www::mygrid::org::uk::ontology::EDHA_term_id)
  $class->add_has_identifier(new www::mygrid::org::uk::ontology::EDHA_term_id());
