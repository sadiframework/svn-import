#-----------------------------------------------------------------
# Blank::genid4c6424f2b4d5
# Generated: 12-Aug-2010 09:44:35 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package Blank::genid4c6424f2b4d5;
...
@ISA = qw(
 OWL::Data::OWL::Class
 purl::oclc::org::SADI::LSRN::GeneID_Record 
);
use strict;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->purl::oclc::org::SADI::LSRN::GeneID_Record::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->purl::oclc::org::SADI::LSRN::GeneID_Record::_attr_prop( $attr_name, $prop_name ) 
            if $self->purl::oclc::org::SADI::LSRN::GeneID_Record::_accessible($attr_name);
...
sub init {
    ...
    $self->purl::oclc::org::SADI::LSRN::GeneID_Record::init();
    $self->type('_:genid4c6424f2b4d5');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->purl::oclc::org::SADI::LSRN::GeneID_Record::_get_statements();
    };
...
Blank::genid4c6424f2b4d5 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use Blank::genid4c6424f2b4d5;
  my $class = Blank::genid4c6424f2b4d5->new();
...
L<purl::oclc::org::SADI::LSRN::GeneID_Record>
