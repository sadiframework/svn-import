...
#-----------------------------------------------------------------
package Blank::genid4c6413718a11;
...
Blank::genid4c6413718a11 - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = Blank::genid4c6413718a11->new();

  # get the uri for this class
  my $uri = $class->uri;
  # add object properties 
  use www::mygrid::org::uk::ontology::nucleotide_sequence;
  # add a has_part property (www::mygrid::org::uk::ontology::nucleotide_sequence)
  $class->add_has_part(new www::mygrid::org::uk::ontology::nucleotide_sequence());
  ...
  # add a has_identifier property (www::mygrid::org::uk::ontology::nucleotide_sequence_id)
  $class->add_has_identifier(new www::mygrid::org::uk::ontology::nucleotide_sequence_id());
