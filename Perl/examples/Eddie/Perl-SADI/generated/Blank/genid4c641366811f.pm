...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->semanticscience::org::resource::SIO_010450::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->semanticscience::org::resource::SIO_010450::_attr_prop( $attr_name, $prop_name ) 
            if $self->semanticscience::org::resource::SIO_010450::_accessible($attr_name);
...
sub init {
    ...
    $self->semanticscience::org::resource::SIO_010450::init();
    $self->type('_:genid4c641366811f');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->semanticscience::org::resource::SIO_010450::_get_statements();
    };
...
Blank::genid4c641366811f - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use Blank::genid4c641366811f;
  my $class = Blank::genid4c641366811f->new();

  # get the uri for this class
  my $uri = $class->uri;
  # add object properties 
  use semanticscience::org::resource::SIO_010007;
  # add a SIO_010082 property (semanticscience::org::resource::SIO_010007)
  $class->add_SIO_010082(new semanticscience::org::resource::SIO_010007());
...
L<semanticscience::org::resource::SIO_010450>
