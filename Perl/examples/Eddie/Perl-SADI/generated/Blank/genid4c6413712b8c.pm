...
#-----------------------------------------------------------------
package Blank::genid4c6413712b8c;
...
Blank::genid4c6413712b8c - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = Blank::genid4c6413712b8c->new();

  # get the uri for this class
  my $uri = $class->uri;
  # add object properties 
  use www::mygrid::org::uk::ontology::dbSNP;
  # add a produced_by property (www::mygrid::org::uk::ontology::dbSNP)
  $class->add_produced_by(new www::mygrid::org::uk::ontology::dbSNP());
  ...
  # add a has_part property (www::mygrid::org::uk::ontology::single_nucleotide_polymorphism)
  $class->add_has_part(new www::mygrid::org::uk::ontology::single_nucleotide_polymorphism());
