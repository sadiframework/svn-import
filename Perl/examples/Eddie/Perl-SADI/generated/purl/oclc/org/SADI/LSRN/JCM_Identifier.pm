...
sub init {
    ...
    $self->type('http://purl.oclc.org/SADI/LSRN/JCM_Identifier');
...
purl::oclc::org::SADI::LSRN::JCM_Identifier - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use purl::oclc::org::SADI::LSRN::JCM_Identifier;
  my $class = purl::oclc::org::SADI::LSRN::JCM_Identifier->new();
