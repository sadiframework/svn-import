...
sub init {
    ...
    $self->type('http://purl.oclc.org/SADI/LSRN/H-InvDB_Entity');
...
purl::oclc::org::SADI::LSRN::H_InvDB_Entity - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use purl::oclc::org::SADI::LSRN::H_InvDB_Entity;
  my $class = purl::oclc::org::SADI::LSRN::H_InvDB_Entity->new();
