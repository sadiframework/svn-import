#-----------------------------------------------------------------
# purl::oclc::org::SADI::LSRN::RiceGenes_Record
# Generated: 12-Aug-2010 09:34:14 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package purl::oclc::org::SADI::LSRN::RiceGenes_Record;
...
sub init {
    ...
    $self->type('http://purl.oclc.org/SADI/LSRN/RiceGenes_Record');
...
purl::oclc::org::SADI::LSRN::RiceGenes_Record - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use purl::oclc::org::SADI::LSRN::RiceGenes_Record;
  my $class = purl::oclc::org::SADI::LSRN::RiceGenes_Record->new();
