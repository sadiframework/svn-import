#-----------------------------------------------------------------
# purl::oclc::org::SADI::LSRN::UM_BBD_enzymeID_Identifier
# Generated: 12-Aug-2010 09:33:54 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package purl::oclc::org::SADI::LSRN::UM_BBD_enzymeID_Identifier;
...
sub init {
    ...
    $self->type('http://purl.oclc.org/SADI/LSRN/UM-BBD_enzymeID_Identifier');
...
purl::oclc::org::SADI::LSRN::UM_BBD_enzymeID_Identifier - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use purl::oclc::org::SADI::LSRN::UM_BBD_enzymeID_Identifier;
  my $class = purl::oclc::org::SADI::LSRN::UM_BBD_enzymeID_Identifier->new();
