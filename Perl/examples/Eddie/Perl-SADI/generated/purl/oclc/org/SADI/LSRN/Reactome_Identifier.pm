#-----------------------------------------------------------------
# purl::oclc::org::SADI::LSRN::Reactome_Identifier
# Generated: 12-Aug-2010 09:35:10 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package purl::oclc::org::SADI::LSRN::Reactome_Identifier;
...
sub init {
    ...
    $self->type('http://purl.oclc.org/SADI/LSRN/Reactome_Identifier');
...
purl::oclc::org::SADI::LSRN::Reactome_Identifier - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use purl::oclc::org::SADI::LSRN::Reactome_Identifier;
  my $class = purl::oclc::org::SADI::LSRN::Reactome_Identifier->new();
