#-----------------------------------------------------------------
# purl::oclc::org::SADI::LSRN::MeSH_Identifier
# Generated: 12-Aug-2010 09:35:03 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package purl::oclc::org::SADI::LSRN::MeSH_Identifier;
...
sub init {
    ...
    $self->type('http://purl.oclc.org/SADI/LSRN/MeSH_Identifier');
...
purl::oclc::org::SADI::LSRN::MeSH_Identifier - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use purl::oclc::org::SADI::LSRN::MeSH_Identifier;
  my $class = purl::oclc::org::SADI::LSRN::MeSH_Identifier->new();
