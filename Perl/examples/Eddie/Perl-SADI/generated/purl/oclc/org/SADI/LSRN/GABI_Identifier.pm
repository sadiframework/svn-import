#-----------------------------------------------------------------
# purl::oclc::org::SADI::LSRN::GABI_Identifier
# Generated: 12-Aug-2010 09:33:45 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package purl::oclc::org::SADI::LSRN::GABI_Identifier;
...
sub init {
    ...
    $self->type('http://purl.oclc.org/SADI/LSRN/GABI_Identifier');
...
purl::oclc::org::SADI::LSRN::GABI_Identifier - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use purl::oclc::org::SADI::LSRN::GABI_Identifier;
  my $class = purl::oclc::org::SADI::LSRN::GABI_Identifier->new();
