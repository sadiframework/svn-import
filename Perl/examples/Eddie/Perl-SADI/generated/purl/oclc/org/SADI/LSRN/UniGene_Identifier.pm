#-----------------------------------------------------------------
# purl::oclc::org::SADI::LSRN::UniGene_Identifier
# Generated: 12-Aug-2010 09:34:30 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package purl::oclc::org::SADI::LSRN::UniGene_Identifier;
...
sub init {
    ...
    $self->type('http://purl.oclc.org/SADI/LSRN/UniGene_Identifier');
...
purl::oclc::org::SADI::LSRN::UniGene_Identifier - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use purl::oclc::org::SADI::LSRN::UniGene_Identifier;
  my $class = purl::oclc::org::SADI::LSRN::UniGene_Identifier->new();
