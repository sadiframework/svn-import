#-----------------------------------------------------------------
# purl::oclc::org::SADI::LSRN::ENZYME_Identifier
# Generated: 12-Aug-2010 09:33:26 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package purl::oclc::org::SADI::LSRN::ENZYME_Identifier;
...
sub init {
    ...
    $self->type('http://purl.oclc.org/SADI/LSRN/ENZYME_Identifier');
...
purl::oclc::org::SADI::LSRN::ENZYME_Identifier - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = purl::oclc::org::SADI::LSRN::ENZYME_Identifier->new();
