#-----------------------------------------------------------------
# purl::oclc::org::SADI::LSRN::IMGT_GENE_DB_Record
# Generated: 12-Aug-2010 09:33:33 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package purl::oclc::org::SADI::LSRN::IMGT_GENE_DB_Record;
...
sub init {
    ...
    $self->type('http://purl.oclc.org/SADI/LSRN/IMGT_GENE-DB_Record');
...
purl::oclc::org::SADI::LSRN::IMGT_GENE_DB_Record - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use purl::oclc::org::SADI::LSRN::IMGT_GENE_DB_Record;
  my $class = purl::oclc::org::SADI::LSRN::IMGT_GENE_DB_Record->new();
