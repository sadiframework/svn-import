#-----------------------------------------------------------------
# dev::biordf::net::kawas::owl::getGOTermAssociations::getGOTermAssociations_Output
# Generated: 12-Aug-2010 09:44:42 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package dev::biordf::net::kawas::owl::getGOTermAssociations::getGOTermAssociations_Output;

use OWL::Data::OWL::Class;
use Blank::genid4c6424fa5c56;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->Blank::genid4c6424fa5c56::_accessible($attr)
    ...
    sub _attr_prop {
        ...
        return $self->Blank::genid4c6424fa5c56::_attr_prop( $attr_name, $prop_name ) 
            if $self->Blank::genid4c6424fa5c56::_accessible($attr_name);
...
sub init {
    ...
    $self->Blank::genid4c6424fa5c56::init();
    $self->purl::oclc::org::SADI::LSRN::GO_Record::init();
    $self->type('http://dev.biordf.net/~kawas/owl/getGOTermAssociations.owl#getGOTermAssociations_Output');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->Blank::genid4c6424fa5c56::_get_statements();
    };
    eval {
    	# add parent statements
...
dev::biordf::net::kawas::owl::getGOTermAssociations::getGOTermAssociations_Output - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = dev::biordf::net::kawas::owl::getGOTermAssociations::getGOTermAssociations_Output->new();
