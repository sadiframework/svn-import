...
#-----------------------------------------------------------------
package dev::biordf::net::kawas::owl::togows_updated::getEnzymeGeneComponentParts_Output;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->Blank::genid4c6424fe4739::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->Blank::genid4c6424fe4739::_attr_prop( $attr_name, $prop_name ) 
            if $self->Blank::genid4c6424fe4739::_accessible($attr_name);
...
sub init {
    ...
    $self->Blank::genid4c6424fe4739::init();
    $self->type('http://dev.biordf.net/~kawas/owl/togows-updated.owl#getEnzymeGeneComponentParts_Output');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->Blank::genid4c6424fe4739::_get_statements();
    };
...
dev::biordf::net::kawas::owl::togows_updated::getEnzymeGeneComponentParts_Output - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = dev::biordf::net::kawas::owl::togows_updated::getEnzymeGeneComponentParts_Output->new();
