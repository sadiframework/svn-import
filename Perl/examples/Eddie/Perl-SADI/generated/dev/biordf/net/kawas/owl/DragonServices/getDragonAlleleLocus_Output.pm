...
#-----------------------------------------------------------------
package dev::biordf::net::kawas::owl::DragonServices::getDragonAlleleLocus_Output;

use OWL::Data::OWL::Class;
use Blank::genid4c642503133e;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->Blank::genid4c642503133e::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->Blank::genid4c642503133e::_attr_prop( $attr_name, $prop_name ) 
            if $self->Blank::genid4c642503133e::_accessible($attr_name);
...
sub init {
    ...
    $self->Blank::genid4c642503133e::init();
    $self->type('http://dev.biordf.net/~kawas/owl/DragonServices.owl#getDragonAlleleLocus_Output');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->Blank::genid4c642503133e::_get_statements();
    };
...
dev::biordf::net::kawas::owl::DragonServices::getDragonAlleleLocus_Output - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = dev::biordf::net::kawas::owl::DragonServices::getDragonAlleleLocus_Output->new();
