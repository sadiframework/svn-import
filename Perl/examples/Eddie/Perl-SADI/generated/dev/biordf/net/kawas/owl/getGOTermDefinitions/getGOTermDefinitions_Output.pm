...
# Generated: 12-Aug-2010 09:44:39 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package dev::biordf::net::kawas::owl::getGOTermDefinitions::getGOTermDefinitions_Output;

use OWL::Data::OWL::Class;
use Blank::genid4c6424f6769b;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->Blank::genid4c6424f6769b::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->Blank::genid4c6424f6769b::_attr_prop( $attr_name, $prop_name ) 
            if $self->Blank::genid4c6424f6769b::_accessible($attr_name);
...
sub init {
    ...
    $self->Blank::genid4c6424f6769b::init();
    $self->type('http://dev.biordf.net/~kawas/owl/getGOTermDefinitions.owl#getGOTermDefinitions_Output');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->Blank::genid4c6424f6769b::_get_statements();
    };
...
dev::biordf::net::kawas::owl::getGOTermDefinitions::getGOTermDefinitions_Output - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = dev::biordf::net::kawas::owl::getGOTermDefinitions::getGOTermDefinitions_Output->new();
