#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_000037
# Generated: 12-Aug-2010 09:33:26 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_000037;

use OWL::Data::OWL::Class;
use semanticscience::org::resource::SIO_000026;
...
@ISA = qw(
 OWL::Data::OWL::Class
 semanticscience::org::resource::SIO_000026 
);
use strict;
...
use semanticscience::org::resource::SIO_000216;
...

{
    my %_allowed = (
        ...
        SIO_000216 => {
        	...
        	post => sub {
                ...
                my $type = @{$self->SIO_000216}[-1] if defined $self->SIO_000216;
                return unless defined $type and $type->type;
                my $range = new semanticscience::org::resource::SIO_000216->range();
                return unless $range;
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->semanticscience::org::resource::SIO_000026::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->semanticscience::org::resource::SIO_000026::_attr_prop( $attr_name, $prop_name ) 
            if $self->semanticscience::org::resource::SIO_000026::_accessible($attr_name);
...
sub init {
    ...
    $self->semanticscience::org::resource::SIO_000026::init();
    $self->type('http://semanticscience.org/resource/SIO_000037');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->semanticscience::org::resource::SIO_000026::_get_statements();
    };

    # for each attribute, if is array do:
    if (defined $self->SIO_000216){
	    foreach (@{$self->SIO_000216}) {
	        ...
	        $self->model->addStmt(
	          new RDF::Core::Statement(
	              $subject,
	              $subject->new('http://semanticscience.org/resource/SIO_000216'), 
...
semanticscience::org::resource::SIO_000037 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_000037;
  my $class = semanticscience::org::resource::SIO_000037->new();
  ...
  $class->add_SIO_000216(new OWL::Data::OWL::Class('#someURI'));

  # get the SIO_000216 object properties
  my $SIO_000216_objects = $class->SIO_000216;
...
L<semanticscience::org::resource::SIO_000026>
