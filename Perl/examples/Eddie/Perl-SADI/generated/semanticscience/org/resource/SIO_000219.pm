...
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_000219;
...
sub init {
    ...
    $self->uri('http://semanticscience.org/resource/SIO_000219');
}
...
semanticscience::org::resource::SIO_000219 - an object propery

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_000219;
  my $property = semanticscience::org::resource::SIO_000219->new();
