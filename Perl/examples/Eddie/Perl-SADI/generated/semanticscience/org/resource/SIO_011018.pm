#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_011018
# Generated: 12-Aug-2010 09:33:47 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_011018;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_011018');
...
semanticscience::org::resource::SIO_011018 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_011018;
  my $class = semanticscience::org::resource::SIO_011018->new();
