#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_011039
# Generated: 12-Aug-2010 09:34:35 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_011039;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_011039');
...
semanticscience::org::resource::SIO_011039 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_011039;
  my $class = semanticscience::org::resource::SIO_011039->new();
