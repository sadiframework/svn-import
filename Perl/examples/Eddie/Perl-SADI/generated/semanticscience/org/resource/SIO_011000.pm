#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_011000
# Generated: 12-Aug-2010 09:34:12 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_011000;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_011000');
...
semanticscience::org::resource::SIO_011000 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_011000;
  my $class = semanticscience::org::resource::SIO_011000->new();
