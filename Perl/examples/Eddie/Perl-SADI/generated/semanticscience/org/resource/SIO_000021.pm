...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->Blank::genid4c641369d8ed::_accessible($attr)
          or $self->Blank::genid4c641369e969::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->Blank::genid4c641369d8ed::_attr_prop( $attr_name, $prop_name ) 
            if $self->Blank::genid4c641369d8ed::_accessible($attr_name);
        return $self->Blank::genid4c641369e969::_attr_prop( $attr_name, $prop_name ) 
            if $self->Blank::genid4c641369e969::_accessible($attr_name);
...
sub init {
    ...
    $self->Blank::genid4c641369d8ed::init();
    $self->Blank::genid4c641369e969::init();
    $self->type('http://semanticscience.org/resource/SIO_000021');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->Blank::genid4c641369d8ed::_get_statements();
    };
    eval {
    	# add parent statements
        $self->Blank::genid4c641369e969::_get_statements();
    };
...
semanticscience::org::resource::SIO_000021 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_000021;
  my $class = semanticscience::org::resource::SIO_000021->new();
...
L<Blank::genid4c641369d8ed>
L<Blank::genid4c641369e969>
