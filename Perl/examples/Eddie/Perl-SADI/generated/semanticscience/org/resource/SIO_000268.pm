#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_000268
# Generated: 12-Aug-2010 09:35:18 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_000268;

use OWL::Data::OWL::Class;
use semanticscience::org::resource::SIO_000436;
...
@ISA = qw(
 OWL::Data::OWL::Class
 semanticscience::org::resource::SIO_000436
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->semanticscience::org::resource::SIO_000436::_accessible($attr)
          or $self->Blank::genid4c64136915d1::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->semanticscience::org::resource::SIO_000436::_attr_prop( $attr_name, $prop_name ) 
            if $self->semanticscience::org::resource::SIO_000436::_accessible($attr_name);
        return $self->Blank::genid4c64136915d1::_attr_prop( $attr_name, $prop_name ) 
            if $self->Blank::genid4c64136915d1::_accessible($attr_name);
...
sub init {
    ...
    $self->semanticscience::org::resource::SIO_000436::init();
    $self->Blank::genid4c64136915d1::init();
    $self->type('http://semanticscience.org/resource/SIO_000268');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->semanticscience::org::resource::SIO_000436::_get_statements();
    };
    eval {
    	# add parent statements
        $self->Blank::genid4c64136915d1::_get_statements();
    };
...
semanticscience::org::resource::SIO_000268 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_000268;
  my $class = semanticscience::org::resource::SIO_000268->new();
...
L<semanticscience::org::resource::SIO_000436>
L<Blank::genid4c64136915d1>
