#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_011084
# Generated: 12-Aug-2010 09:33:54 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_011084;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_011084');
...
semanticscience::org::resource::SIO_011084 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_011084;
  my $class = semanticscience::org::resource::SIO_011084->new();
