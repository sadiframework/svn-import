#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_011011
# Generated: 12-Aug-2010 09:33:27 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_011011;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_011011');
...
semanticscience::org::resource::SIO_011011 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_011011;
  my $class = semanticscience::org::resource::SIO_011011->new();
