#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_011029
# Generated: 12-Aug-2010 09:35:19 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_011029;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_011029');
...
semanticscience::org::resource::SIO_011029 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_011029;
  my $class = semanticscience::org::resource::SIO_011029->new();
