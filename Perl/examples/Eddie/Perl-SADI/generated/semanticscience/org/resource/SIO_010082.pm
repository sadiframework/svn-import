#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_010082
# Generated: 12-Aug-2010 09:33:24 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_010082;
...
sub init {
    ...
    $self->range('http://semanticscience.org/resource/SIO_010007');    
    ...
    $self->uri('http://semanticscience.org/resource/SIO_010082');
}
...
semanticscience::org::resource::SIO_010082 - an object propery

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_010082;
  my $property = semanticscience::org::resource::SIO_010082->new();
