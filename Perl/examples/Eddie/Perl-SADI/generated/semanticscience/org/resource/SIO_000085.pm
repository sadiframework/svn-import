#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_000085
# Generated: 12-Aug-2010 09:35:04 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_000085;
...
sub init {
    ...
    $self->type('http://semanticscience.org/resource/SIO_000085');
...
semanticscience::org::resource::SIO_000085 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_000085;
  my $class = semanticscience::org::resource::SIO_000085->new();
