...
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_000070;

use OWL::Data::OWL::Class;
use Blank::genid4c641369d4dd;
use semanticscience::org::resource::SIO_000069;
...
@ISA = qw(
 ...
 semanticscience::org::resource::SIO_000069 
);
use strict;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->Blank::genid4c641369d4dd::_accessible($attr)
          or $self->semanticscience::org::resource::SIO_000069::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->Blank::genid4c641369d4dd::_attr_prop( $attr_name, $prop_name ) 
            if $self->Blank::genid4c641369d4dd::_accessible($attr_name);
        return $self->semanticscience::org::resource::SIO_000069::_attr_prop( $attr_name, $prop_name ) 
            if $self->semanticscience::org::resource::SIO_000069::_accessible($attr_name);
...
sub init {
    ...
    $self->Blank::genid4c641369d4dd::init();
    $self->semanticscience::org::resource::SIO_000069::init();
    $self->type('http://semanticscience.org/resource/SIO_000070');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->Blank::genid4c641369d4dd::_get_statements();
    };
    eval {
    	# add parent statements
        $self->semanticscience::org::resource::SIO_000069::_get_statements();
    };
...
semanticscience::org::resource::SIO_000070 - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = semanticscience::org::resource::SIO_000070->new();
...
L<Blank::genid4c641369d4dd>
L<semanticscience::org::resource::SIO_000069>
