#-----------------------------------------------------------------
# semanticscience::org::resource::SIO_010450
# Generated: 12-Aug-2010 09:33:49 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_010450;
...

{
    my %_allowed = (
        ...
        SIO_010081 => {
        	...
        	post => sub {
                ...
                my $type = @{$self->SIO_010081}[-1] if defined $self->SIO_010081;
                return unless defined $type and $type->type;
                my $range = new semanticscience::org::resource::SIO_010081->range();
                return unless $range;
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->semanticscience::org::resource::SIO_010009::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->semanticscience::org::resource::SIO_010009::_attr_prop( $attr_name, $prop_name ) 
            if $self->semanticscience::org::resource::SIO_010009::_accessible($attr_name);
...
sub init {
    ...
    $self->semanticscience::org::resource::SIO_010009::init();
    $self->type('http://semanticscience.org/resource/SIO_010450');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->semanticscience::org::resource::SIO_010009::_get_statements();
    };

    # for each attribute, if is array do:
    if (defined $self->SIO_010081){
	    foreach (@{$self->SIO_010081}) {
	        ...
	        $self->model->addStmt(
	          new RDF::Core::Statement(
	              $subject,
	              $subject->new('http://semanticscience.org/resource/SIO_010081'), 
...
semanticscience::org::resource::SIO_010450 - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use semanticscience::org::resource::SIO_010450;
  my $class = semanticscience::org::resource::SIO_010450->new();
  ...
  $class->add_SIO_010081(new OWL::Data::OWL::Class('#someURI'));

  # get the SIO_010081 object properties
  my $SIO_010081_objects = $class->SIO_010081;
...
L<semanticscience::org::resource::SIO_010009>
