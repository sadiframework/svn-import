...
#-----------------------------------------------------------------
package semanticscience::org::resource::SIO_010455;

use OWL::Data::OWL::Class;
use Blank::genid4c6413663d2e;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->Blank::genid4c6413663d2e::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->Blank::genid4c6413663d2e::_attr_prop( $attr_name, $prop_name ) 
            if $self->Blank::genid4c6413663d2e::_accessible($attr_name);
...
sub init {
    ...
    $self->Blank::genid4c6413663d2e::init();
    $self->type('http://semanticscience.org/resource/SIO_010455');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->Blank::genid4c6413663d2e::_get_statements();
    };
...
semanticscience::org::resource::SIO_010455 - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = semanticscience::org::resource::SIO_010455->new();
