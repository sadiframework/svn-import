...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#Pfam');
...
www::mygrid::org::uk::ontology::Pfam - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::Pfam;
  my $class = www::mygrid::org::uk::ontology::Pfam->new();
