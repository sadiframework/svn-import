...
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::retrieving;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#retrieving');
...
www::mygrid::org::uk::ontology::retrieving - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::retrieving;
  my $class = www::mygrid::org::uk::ontology::retrieving->new();
