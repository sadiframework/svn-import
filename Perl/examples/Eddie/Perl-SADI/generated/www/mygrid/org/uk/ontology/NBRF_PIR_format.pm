#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::NBRF_PIR_format
# Generated: 12-Aug-2010 09:33:58 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::NBRF_PIR_format;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#NBRF_PIR_format');
...
www::mygrid::org::uk::ontology::NBRF_PIR_format - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::NBRF_PIR_format;
  my $class = www::mygrid::org::uk::ontology::NBRF_PIR_format->new();
