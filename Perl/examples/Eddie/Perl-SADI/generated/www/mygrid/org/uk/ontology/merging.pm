...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->www::mygrid::org::uk::ontology::parsing::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->www::mygrid::org::uk::ontology::parsing::_attr_prop( $attr_name, $prop_name ) 
            if $self->www::mygrid::org::uk::ontology::parsing::_accessible($attr_name);
...
sub init {
    ...
    $self->www::mygrid::org::uk::ontology::parsing::init();
    $self->type('http://www.mygrid.org.uk/ontology#merging');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->www::mygrid::org::uk::ontology::parsing::_get_statements();
    };
...
www::mygrid::org::uk::ontology::merging - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::merging;
  my $class = www::mygrid::org::uk::ontology::merging->new();
...
L<www::mygrid::org::uk::ontology::parsing>
