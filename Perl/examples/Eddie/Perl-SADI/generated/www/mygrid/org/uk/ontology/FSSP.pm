...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#FSSP');
...
www::mygrid::org::uk::ontology::FSSP - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::FSSP;
  my $class = www::mygrid::org::uk::ontology::FSSP->new();
