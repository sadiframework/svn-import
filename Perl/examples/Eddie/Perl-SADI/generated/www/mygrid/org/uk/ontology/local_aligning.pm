...
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::local_aligning;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#local_aligning');
...
www::mygrid::org::uk::ontology::local_aligning - an automatically generated owl class!
...
=head1 SYNOPSIS
  ...
  my $class = www::mygrid::org::uk::ontology::local_aligning->new();
