#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::Plant_ontology_PO
# Generated: 12-Aug-2010 09:35:32 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::Plant_ontology_PO;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->www::mygrid::org::uk::ontology::bio_ontology_resource::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->www::mygrid::org::uk::ontology::bio_ontology_resource::_attr_prop( $attr_name, $prop_name ) 
            if $self->www::mygrid::org::uk::ontology::bio_ontology_resource::_accessible($attr_name);
...
sub init {
    ...
    $self->www::mygrid::org::uk::ontology::bio_ontology_resource::init();
    $self->type('http://www.mygrid.org.uk/ontology#Plant_ontology_PO');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->www::mygrid::org::uk::ontology::bio_ontology_resource::_get_statements();
    };
...
www::mygrid::org::uk::ontology::Plant_ontology_PO - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::Plant_ontology_PO;
  my $class = www::mygrid::org::uk::ontology::Plant_ontology_PO->new();
...
L<www::mygrid::org::uk::ontology::bio_ontology_resource>
