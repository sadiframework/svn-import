#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::gene_expression_database
# Generated: 12-Aug-2010 09:33:58 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::gene_expression_database;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#gene_expression_database');
...
www::mygrid::org::uk::ontology::gene_expression_database - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::gene_expression_database;
  my $class = www::mygrid::org::uk::ontology::gene_expression_database->new();
