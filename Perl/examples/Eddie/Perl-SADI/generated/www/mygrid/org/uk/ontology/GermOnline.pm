...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#GermOnline');
...
www::mygrid::org::uk::ontology::GermOnline - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::GermOnline;
  my $class = www::mygrid::org::uk::ontology::GermOnline->new();
