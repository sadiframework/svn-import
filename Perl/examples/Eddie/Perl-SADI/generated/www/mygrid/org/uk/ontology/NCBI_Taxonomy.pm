#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::NCBI_Taxonomy
# Generated: 12-Aug-2010 09:34:31 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::NCBI_Taxonomy;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#NCBI_Taxonomy');
...
www::mygrid::org::uk::ontology::NCBI_Taxonomy - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::NCBI_Taxonomy;
  my $class = www::mygrid::org::uk::ontology::NCBI_Taxonomy->new();
