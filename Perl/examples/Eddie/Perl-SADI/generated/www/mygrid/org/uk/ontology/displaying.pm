#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::displaying
# Generated: 12-Aug-2010 09:34:16 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::displaying;

use OWL::Data::OWL::Class;
use www::mygrid::org::uk::ontology::formatConverting;
...
@ISA = qw(
 OWL::Data::OWL::Class
 www::mygrid::org::uk::ontology::formatConverting 
);
use strict;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->www::mygrid::org::uk::ontology::formatConverting::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->www::mygrid::org::uk::ontology::formatConverting::_attr_prop( $attr_name, $prop_name ) 
            if $self->www::mygrid::org::uk::ontology::formatConverting::_accessible($attr_name);
...
sub init {
    ...
    $self->www::mygrid::org::uk::ontology::formatConverting::init();
    $self->type('http://www.mygrid.org.uk/ontology#displaying');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->www::mygrid::org::uk::ontology::formatConverting::_get_statements();
    };
...
www::mygrid::org::uk::ontology::displaying - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::displaying;
  my $class = www::mygrid::org::uk::ontology::displaying->new();
...
L<www::mygrid::org::uk::ontology::formatConverting>
