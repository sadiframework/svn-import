#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::translating
# Generated: 12-Aug-2010 09:35:21 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::translating;

use OWL::Data::OWL::Class;
use www::mygrid::org::uk::ontology::bioinformatics_task;
...
@ISA = qw(
 OWL::Data::OWL::Class
 www::mygrid::org::uk::ontology::bioinformatics_task 
);
use strict;
...
use www::mygrid::org::uk::ontology::task_performed_by;
...

{
    my %_allowed = (
        ...
        task_performed_by => {
        	...
        	post => sub {
                ...
                my $type = @{$self->task_performed_by}[-1] if defined $self->task_performed_by;
                return unless defined $type and $type->type;
                my $range = new www::mygrid::org::uk::ontology::task_performed_by->range();
                return unless $range;
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->www::mygrid::org::uk::ontology::bioinformatics_task::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->www::mygrid::org::uk::ontology::bioinformatics_task::_attr_prop( $attr_name, $prop_name ) 
            if $self->www::mygrid::org::uk::ontology::bioinformatics_task::_accessible($attr_name);
...
sub init {
    ...
    $self->www::mygrid::org::uk::ontology::bioinformatics_task::init();
    $self->type('http://www.mygrid.org.uk/ontology#translating');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->www::mygrid::org::uk::ontology::bioinformatics_task::_get_statements();
    };

    # for each attribute, if is array do:
    if (defined $self->task_performed_by){
	    foreach (@{$self->task_performed_by}) {
	        ...
	        $self->model->addStmt(
	          new RDF::Core::Statement(
	              $subject,
	              $subject->new('http://www.mygrid.org.uk/ontology#task_performed_by'), 
...
www::mygrid::org::uk::ontology::translating - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::translating;
  my $class = www::mygrid::org::uk::ontology::translating->new();
  ...
  $class->add_task_performed_by(new OWL::Data::OWL::Class('#someURI'));

  # get the task_performed_by object properties
  my $task_performed_by_objects = $class->task_performed_by;
...
L<www::mygrid::org::uk::ontology::bioinformatics_task>
