...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#aMAZE');
...
www::mygrid::org::uk::ontology::aMAZE - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::aMAZE;
  my $class = www::mygrid::org::uk::ontology::aMAZE->new();
