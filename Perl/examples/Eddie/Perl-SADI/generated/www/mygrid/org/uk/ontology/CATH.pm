...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#CATH');
...
www::mygrid::org::uk::ontology::CATH - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::CATH;
  my $class = www::mygrid::org::uk::ontology::CATH->new();
