#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::gene_expression_profile
# Generated: 12-Aug-2010 09:35:09 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::gene_expression_profile;

use OWL::Data::OWL::Class;
use www::mygrid::org::uk::ontology::gene_expression_report;
...
@ISA = qw(
 OWL::Data::OWL::Class
 www::mygrid::org::uk::ontology::gene_expression_report 
);
use strict;
...

{
    ...
    sub _accessible {
        ...
        exists $_allowed{$attr} 
          ...
          or $self->www::mygrid::org::uk::ontology::gene_expression_report::_accessible($attr)
    }
    ...
    sub _attr_prop {
        ...
        return $self->www::mygrid::org::uk::ontology::gene_expression_report::_attr_prop( $attr_name, $prop_name ) 
            if $self->www::mygrid::org::uk::ontology::gene_expression_report::_accessible($attr_name);
...
sub init {
    ...
    $self->www::mygrid::org::uk::ontology::gene_expression_report::init();
    $self->type('http://www.mygrid.org.uk/ontology#gene_expression_profile');
...
sub _get_statements {
    ...
    eval {
    	# add parent statements
        $self->www::mygrid::org::uk::ontology::gene_expression_report::_get_statements();
    };
...
www::mygrid::org::uk::ontology::gene_expression_profile - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::gene_expression_profile;
  my $class = www::mygrid::org::uk::ontology::gene_expression_profile->new();
...
L<www::mygrid::org::uk::ontology::gene_expression_report>
