#-----------------------------------------------------------------
# www::mygrid::org::uk::ontology::RNA_sequence
# Generated: 12-Aug-2010 09:33:39 PDT
# Contact: Edward Kawas <edward.kawas+owl2perl@gmail.com>
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::RNA_sequence;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#RNA_sequence');
...
www::mygrid::org::uk::ontology::RNA_sequence - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::RNA_sequence;
  my $class = www::mygrid::org::uk::ontology::RNA_sequence->new();
