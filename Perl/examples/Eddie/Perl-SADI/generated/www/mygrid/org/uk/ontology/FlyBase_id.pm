...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#FlyBase_id');
...
www::mygrid::org::uk::ontology::FlyBase_id - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::FlyBase_id;
  my $class = www::mygrid::org::uk::ontology::FlyBase_id->new();
