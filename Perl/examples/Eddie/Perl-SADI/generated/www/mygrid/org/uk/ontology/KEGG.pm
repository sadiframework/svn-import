...
#-----------------------------------------------------------------
package www::mygrid::org::uk::ontology::KEGG;
...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#KEGG');
...
www::mygrid::org::uk::ontology::KEGG - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::KEGG;
  my $class = www::mygrid::org::uk::ontology::KEGG->new();
