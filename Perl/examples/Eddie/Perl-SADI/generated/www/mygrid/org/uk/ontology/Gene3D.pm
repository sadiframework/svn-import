...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#Gene3D');
...
www::mygrid::org::uk::ontology::Gene3D - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::Gene3D;
  my $class = www::mygrid::org::uk::ontology::Gene3D->new();
