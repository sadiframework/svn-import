...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#MeSH');
...
www::mygrid::org::uk::ontology::MeSH - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::MeSH;
  my $class = www::mygrid::org::uk::ontology::MeSH->new();
