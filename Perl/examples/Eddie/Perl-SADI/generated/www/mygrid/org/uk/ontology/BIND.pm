...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#BIND');
...
www::mygrid::org::uk::ontology::BIND - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::BIND;
  my $class = www::mygrid::org::uk::ontology::BIND->new();
