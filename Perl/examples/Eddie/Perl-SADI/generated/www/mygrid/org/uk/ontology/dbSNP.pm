...
sub init {
    ...
    $self->type('http://www.mygrid.org.uk/ontology#dbSNP');
...
www::mygrid::org::uk::ontology::dbSNP - an automatically generated owl class!

=cut

=head1 SYNOPSIS

  use www::mygrid::org::uk::ontology::dbSNP;
  my $class = www::mygrid::org::uk::ontology::dbSNP->new();
